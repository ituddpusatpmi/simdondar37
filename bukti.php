...
$pdf->SetXY(0+$X,$Y+8);
$pdf->Cell(0, 12,'_________________________________________________________________________________________',0, 1, 'C');

$pdf->SetFont('courier', 'bu', 15);
$pdf->SetXY(3,12);
$pdf->Cell(0, 14, 'BUKTI PENERIMAAN PERMINTAAN DARAH', 0,0,'C');
...
$pdf->Cell(15, 12, 'No. Reg',0,0,'L'); 
$pdf->Cell(50, 12,'   : '.$bayar1[regrs], 0,0,'L');
...
$pdf->SetXY(3,27);
$pdf->SetFont('courier', '', 13);
$pdf->Cell(15, 12, 'No. RM',0,0,'L'); 
$pdf->Cell(50, 12,'   : '.$bayar1[no_rm], 0,0,'L');
...
$pdf->Cell(50, 12,'   : '.$bayar1[ruangan], 0);                         
...
$pdf->SetXY(100+$X,$Y+27+$no);
$pdf->Cell(0, 13, $nk1.'. '.$kan1[JenisDarah], 0);
$pdf->SetXY(150+$X,$Y+27+$no);
$pdf->Cell(0, 13, ''.$kan1[Jumlah].' Kantong', 0);
}
if ($nkk>'0') {
$pdf->SetXY(100+$X,$Y+29+$no);
$pdf->Cell(0, 13, $nk1.'. '.$kan1[JenisDarah], 0);
$pdf->SetXY(150+$X,$Y+29+$no);
$pdf->Cell(0, 13, ''.$kan1[Jumlah].' Kantong', 0);
}
$nkk++;
$no=$no+3;
