...
<color="blue" class="awesomeText"><b>DETAIL PEMERIKSAAN IMLTD ID SAMPLE: <?=$nkt?></b><br>
...
<table class="list" border=1 cellpadding="2" cellspacing="2" width="100%" style="border-collapse:collapse">
    ...
    if ($no=="0"){
        ?><tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight';" onMouseOut="this.className='normal';">
            <td colspan="14" class=input align="center">TIDAK ADA DATA PEMERERIKSAAN NAT</td>
        </tr>
    <?}
    ?>
...
<a href="pmiimltd.php?module=cari_sample"class="swn_button_blue">Pencarian</a>
