...
function logout() {
    if (confirm("Anda yakin akan menutup Aplikasi SIMUDDA ini?"))
...
<div class="header100">
	...
	<? if ($_GET[module]=='home' and $_GET[level]=='laboratorium') {
		?>
		<iframe src='pmilaboratorium.php?module=rekap_transaksi_sum' name="isiadmin" width="100%" height="100%" frameborder="0">
		</iframe>
		<?
	} elseif 
