...
<form name="prolis" method=post>
    <font size="4" color=00008B>QC Produk WB ==Masukkan No.Kantong==<br> </font><br/>
    ...
    <a href="pmiqc.php?module=input_qc"class="swn_button_blue">Kembali</a>
</form>
<?
if (isset($_POST[cari])) {
    $nkt=$_POST[noktg];
    ...
    if (($stokkantong['Status']=='2') and ($stokkantong['sah']=='1') and ($stokkantong['statQC']=='0') and ($stokkantong['statKonfirmasi']=='1') and ($stokkantong['produk']=='WB')){
        $URL="pmiqc.php?module=qcwb_proses&nokantong=$nkt&mode=2";
        header("Location: $URL");
    }else{
