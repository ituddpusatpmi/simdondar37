...
$jeniskomponen2  =$datakantong['merk'];
...
$produk2=mysql_fetch_assoc(mysql_query("select * from master_kantong_qc where merk='$jeniskomponen2'"));
$antkogulan=$produk2['antkogulan'];
