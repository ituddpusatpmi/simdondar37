...
`tgledkantong`,`berat_isi`,`berat_kosong`,`berat_jenis`,`antikogulan`,`volume`,`hct`,`plasma`,`ttlhb`,`hemolisis`,
`volhem`,`kadhb`,`hemoglobin`,`aerob`,`anaerob`,`i-hbs`,`i-hcv`,
`i-hiv`,`i-syp`,`qcuser`,`qcchecker`,`qcpengesah`,`qc_status`,`hsl_periksa_fisik`,`hasil_periksahem`,`v_hemolisis`,`v_lipemik`,`v_penggumpalan`,`v_warna`,`v_tdk`)
          VALUES ('$v_rnotrans','$tglqc','$nkt','$v_jenis','$v_merk','$v_goldarah','$v_rhesus','$v_rproduk','$v_tglaftap','$v_kadaluwarsa',
'$v_tgledkantong','$v_beratisi','$v_beratkosong','$v_beratjenis','$v_antikogulan','$v_volume','$v_hct','$v_plasma','$v_ttlhb','$v_hemolisis','$v_volhem','$v_kadhb','$v_hemoglobin','$v_aerob','$v_anaerob','$v_ihbs',
'$v_ihcv','$v_ihiv','$v_isyp','$v_qcuser','$v_qcchecker',
'$v_qcpengesah','$v_rsatus_ket','$v_rfisik_ket','$v_rhematologi','$vi_hemolisis','$vi_lipemik','$vi_penggumpalan','$vi_warna','$vi_tdk')";
	    $qact=mysql_query($sql);
    ...
    if ($mode_kembali==1){
        echo "<meta http-equiv='refresh' content='2;url=pmiqc.php?module=qcwb2'>";
    } else{
        echo "<meta http-equiv='refresh' content='2;url=pmiqc.php?module=qcwb2'>";
    }
...
function hitung(){
	...
	var update2 = eval(document.form_prolis.antikogulan.value);

	if (document.form_prolis.korek[1].checked==true) {
        var total= stok - update; } 
        var total1= total / update1;
	var total2= total1 - update2;
        document.form_prolis.volume.value=total2;
...
<tr>
	...
	<td class="input"><input onchange="hitung()" name="beratisi" type="text" size="5" placeholder="Isi Angka" >gram</td>
	</tr>
<tr>
	...
	<input  onchange="hitung()" name="beratkosong" type="text" size="5" placeholder="Isi Angka" value="<?=$beratkantongkosong?>" required="" readonly="readonly">gram</td>
        </tr>
<tr>
     <td style="background-color: mistyrose" colspan="2">Berat Jenis</td> <td>
	<input type="hidden" name="korek" value="plus">
        <input type="hidden" name="korek" value="min" checked="checked">
	<input  onchange="hitung()" name="beratjenis" type="text" size="5" placeholder="Isi Angka" value="<?=$beratjenis?>" required="" readonly="readonly">gram</td>
        </tr>

<tr>
     <td style="background-color: mistyrose" colspan="2">Antikogulan</td> <td>
	<input type="hidden" name="korek" value="plus">
        <input type="hidden" name="korek" value="min" checked="checked">
	<input  onchange="hitung()" name="antikogulan" value="<?=$antkogulan?>" type="text" size="5" placeholder="Isi Angka" required="" readonly="readonly">gram</td>
        </tr>

<tr>
        <td style="" colspan="2">Hasil Perhitungan Volume</td>
        <td class="input"><input name="volume" type="text" size="2" readonly="readonly" style="background-color:#BDB76B";>ml</td>
		   ...
		   <tr><td style="" colspan="2">Hasil Perhitungan Hemolisis</td> <td><input  type="text" size="2" name="hemolisis" style="background-color:yellow"; >%
...
<table cellpadding=4 cellspacing=4 width="100%" style="border: 0px; border-color: #ffffff;">
		    ...
		    <tr><td style="" colspan="2">Hemoglobin</td> <td><input type="text" onchange="hitung()" readonly="readonly" name="hemoglobin" size="5" style="background-color:#BDB76B";>g/unit</td></tr>
...
<table cellpadding=4 cellspacing=4 width="100%" style="border: 0px; border-color: #ffffff;">
			...
			<tr><td style="background-color: mistyrose" colspan="2">Disahkan Oleh</td>
 			...
 			<tr><td style="background-color: mistyrose" colspan="2">Tanggal Pemeriksaan</td>
                            <td>
                                   <INPUT type="date"  name="tglqc" id="tanggal" value="<?=$tglqc?>">
			</td></tr>
    ...
    <?
    if ($mode_kembali==1){
        ?><a href="pmiqc.php?module=qcwb2"class="swn_button_blue">Kembali</a><?
    }else{
        ?><a href="pmiqc.php?module=qcwb2"class="swn_button_blue">Kembali</a><?
    }
    ?>
