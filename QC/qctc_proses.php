...
`i-hiv`,`i-syp`,`qcuser`,`qcchecker`,`qcpengesah`,`qc_status`,`hsl_periksa_fisik`,`hasil_periksahem`,`v_hemolisis`,`v_lipemik`,`v_penggumpalan`,`v_warna`,`v_tdk`,`leukosit`,`trombosit`,`ph`,`swirling`)
...
'$v_qcpengesah','$v_rsatus_ket','$v_rfisik_ket','$v_rhematologi','$vi_hemolisis','$vi_lipemik','$vi_penggumpalan','$vi_warna','$vi_tdk','$v_rleukosit1','$v_rtrombosit1','$v_ph','$v_swirling')";
	    $qact=mysql_query($sql);
...
<tr>
        ...
        <td class="input"><input name="volume" type="text" size="3" readonly="readonly" style="background-color:#BDB76B";> ml</td>
...
<tr>
	...
	<td class="input"><input type="text" name="ph" type="text" size="5" placeholder="Isi Angka"></td>
	</tr>
...
<table cellpadding=4 cellspacing=4 width="100%" style="border: 0px; border-color: #ffffff;">
		    ...
		    <tr><td style="" colspan="2">Leukosit</td> <td><input type="text" name="leukosit" size="5" style="background-color:yellow";> g/unit
		    ...
		    <tr><td style="" colspan="2">Trombosit</td> <td><input type="text"  name="trombosit" size="5" style="background-color:yellow";> g/unit
