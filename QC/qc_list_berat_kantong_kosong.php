...
<body>
	<font size="4" color=00008B>MASTER BERAT KANTONG</font><br><br>
	...
	$sql="SELECT `id`, `merk`, `jenis`,
	 case `jenis`
        ...
        end as jeniskantong, `vol`, `antkogulan`,
	`ket`, `berat_ku`, `berat_s1`, `berat_s2`, `berat_s3`, `berat_s4`, `berat_s5`, `berat_s6`, `berat_s7`, `lama_buka` FROM `master_kantong_qc`
	order by `merk`, `jenis`";
	...
	while($tmp=mysql_fetch_assoc($qraw)){
		...
		<tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
			...
			<td nowrap>
				<a href="pmiqc.php?module=edit_beratkantong&id=<?=$tmp['id']?>" alt="Mengubah berat kantong"  >Ubah</a>
		</tr>
	<?}
	if ($no==0){?>
        <tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
	...
	<?}?>
        ...
        <a href="pmiqc.php?module=kantong"class="swn_button_blue">Tambah</a>
