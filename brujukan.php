...
//$pdf->Cell(27, 12, 'uddp',0,0,'L');

$pdf->SetX(0.5);
//$pdf->Cell(trim($udd), '', '', '', '', '', $style, 'N');
$pdf->write1DBarcode($nk1, 'C128A', '', '', 45, 14, '', $style, 'T');
$pdf->SetX(53.5);
$pdf->write1DBarcode($nk1, 'C128A', '', '', 45, 14, '', $style, 'N');
} 
	} else {
$pdf->SetX(0.5);
$pdf->write1DBarcode($nk1, 'C128A', '', '', 45, 14, '', $style, 'T');
