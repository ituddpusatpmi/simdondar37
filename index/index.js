...
$(document).ready(function(){
  $(window).scroll(function(){
      ...
      document.getElementById('brandimage').src='index/images/Logo_PMI.png';
      document.getElementById('brandimage').style="max-width: auto; height:30px;"
	  }
	  else{
      document.getElementById("logo").style.color = "white";
      document.getElementById('brandimage').src='index/logo_pmi_kotak.png';
      document.getElementById('brandimage').style="max-width: auto; height:50px;"
	  }
  })
})
