...
$array_bulan = array(1=>'Jan','Feb','Mar', 'Apr', 'Mei', 'Jun','Jul','Ags','Sep','Okt', 'Nov','Des');
	...
	if (($_SESSION[leveluser])=='admin'){
					$id=$aRow[ $aColumns[$i]];
					$row[] =$link. "<a href=pmiadmin.php?module=balas_wa&ID=".$id." TITLE=\"Balas Pesan ini\">[Balas]</a>"."     "."<a href=pmiadmin.php?module=hapus_wa_inbox&Id=".$id." TITLE=\"Hapus Pesan ini\">[Hapus]</a>";
}
				}else{
					/* General output */
					$row[] = $aRow[ $aColumns[$i] ];
