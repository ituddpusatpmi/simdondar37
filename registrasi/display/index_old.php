...
<head>
  ...
  .bawah {
    ...
    background: -moz-linear-gradient(top,  rgb(246,246,246) 0%, rgb(225,225,225) 42%, rgb(241,241,241) 63%, rgb(255,255,255) 100%); /* FF3.6-15 */
    background: -webkit-linear-gradient(top,  rgb(246,246,246) 0%,rgb(225,225,225) 42%,rgb(241,241,241) 63%,rgb(255,255,255) 100%); /* Chrome10-25,Safari5.1-6 */
    background: linear-gradient(to bottom,  rgb(246,246,246) 0%,rgb(225,225,225) 42%,rgb(241,241,241) 63%,rgb(255,255,255) 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
  ...
  .infokiri {
    ...
    background: rgb(255,29,0); /* Old browsers */
    background: -moz-linear-gradient(left,  rgb(255,29,0) 0%, rgb(132,6,2) 100%); /* FF3.6-15 */
    background: -webkit-linear-gradient(left,  rgb(255,29,0) 0%,rgb(132,6,2) 100%); /* Chrome10-25,Safari5.1-6 */
    background: linear-gradient(to right,  rgb(255,29,0) 0%,rgb(132,6,2) 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
    filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ff1d00', endColorstr='#840602',GradientType=1 ); /* IE6-9 */
  ...
  .infokanan {
    ...
    font-family: 'digital-7';
    text-shadow: 3px 3px 5px #000000;
    background: rgb(132,6,2); /* Old browsers */
    background: -moz-linear-gradient(left,  rgb(132,6,2) 0%, rgb(255,29,0) 100%); /* FF3.6-15 */
    background: -webkit-linear-gradient(left,  rgb(132,6,2) 0%,rgb(255,29,0) 100%); /* Chrome10-25,Safari5.1-6 */
    background: linear-gradient(to right,  rgb(132,6,2) 0%,rgb(255,29,0) 100%); /* W3C, IE10+, FF16+, Chrome26+, Opera12+, Safari7+ */
    filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#840602', endColorstr='#ff1d00',GradientType=1 ); /* IE6-9 */
  }
  </style>
...
<body>
    <div class="atas"><div style="margin-top:5px;margin-left:10px; text-shadow: 5px 5px 10px #000000;font-size:<?php echo $udd_fontsize;?>px;"><?php include_once('get_udd.php');?></div></div>
      ...
      <ul class="marquee">
          ...
          <?php 
            ...
            while ($res=mysqli_fetch_assoc($berita)){
                echo '<li style="color:#000000;">'.$res['isi_agenda'].'</li>';$nocolor='2';
            }
