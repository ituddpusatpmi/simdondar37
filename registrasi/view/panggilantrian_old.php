...
<?php
  ...
  if(isset($_POST['lanjutPA'])){
    ...
    $updatepanggil = mysqli_query($con,"UPDATE antrian set panggil=0, stat=1 where nomor='$nomorPA' AND tgl=curdate()");
    ?>
...
<!--voice-->
        ...
        <audio id="suarabelsuarabelloket" src="../dist/sound/Ruangdaftar.mp3"  ></audio>
...
<div class="preloader flex-column justify-content-center align-items-center">
  ...
  <div class="row">
          ...
          <div class="col-lg-4">
          <center><strong style="font-size: 25px;">AFTAP LENGAN KIRI</strong></center>
						<ol class="breadcrumb">

              <table width=80% class="table table-bordered table-hover table-striped">
              <tr>
                <td>Jumlah Antrian : <?php echo $antri['jmlkiri'];?></td>
              <tr>
              </table>
							<table width=80% class="table table-bordered table-hover table-striped">
								<tr>
                <td bgcolor="#baedff" align="center">No. Antri : <br>
                <strong style="font-size: 50px;"><?php echo $antri['nokiri'];?></strong><br>
                <?php echo $antri['namakiri'];?>
                </td>
								</tr>
              ...
              <table width=100% class="table table-bordered table-hover table-striped">
								<tr>
                  <td align="center">
                  <button  name="kiri" class="btn btn-danger btn-sm" style=";box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 4px 8px 0 rgba(0, 0, 0, 0.19); height:50px;width:100px" onclick="mulai(); <?php $nomor=$antri['nokiri'];?>;">PANGGIL</button>
                  </td>
                  <td align="center"> 
                    <input type=submit  name="submit" value="LANJUT" class="btn btn-success btn-sm" style=";box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 4px 8px 0 rgba(0, 0, 0, 0.19); height:50px;width:100px">
                  </td>
                </tr>
              </table>
							<!-- Pilih Menu -->
          ...
          <div class="col-lg-4">
          <center><strong style="font-size: 25px;">AFTAP LENGAN KANAN</strong></center>
						<ol class="breadcrumb">

            <table width=80% class="table table-bordered table-hover table-striped">
              <tr>
                <td>Jumlah Antrian : <?php echo $antri['jmlkanan'];?></td>
              <tr>
              </table>
							<table width=100% class="table table-bordered table-hover table-striped">
								<tr>
									<td bgcolor="#ffe5e3" align="center">No. Antri : <br>
                  <strong style="font-size: 50px;"><?php echo $antri['nokanan'];?></strong><br>
                  <?php echo $antri['namakanan'];?>
                </td>
								</tr>
              ...
              <table width=100% class="table table-bordered table-hover table-striped">
								<tr>
                  <td align="center">
                  <button  name="kanan" class="btn btn-danger btn-sm" style=";box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 4px 8px 0 rgba(0, 0, 0, 0.19); height:50px;width:100px" onclick="mulai();">PANGGIL</button>
                  </td>
                  <td align="center"> 
                    <input type=submit  name="submit" value="LANJUT" class="btn btn-success btn-sm" style=";box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 4px 8px 0 rgba(0, 0, 0, 0.19); height:50px;width:100px">
                  </td>
