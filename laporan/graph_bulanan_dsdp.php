...
<body>
<?php
$title  = "GRAFIK PENYUMBANGAN DARAH BERDASARKAN JENIS DONOR TAHUN ".$tahun;
$query  = mysql_query("SELECT ELT(MONTH(Tgl), 'Januari','Februari','Maret', 'April','Mei','Juni', 'Juli', 'Agustus', 'September','Oktober','November','Desember') As Bulan,
        ...
        from htransaksi where year(Tgl)='$tahun' and (Pengambilan='0' or Pengambilan='2') group by month(Tgl)");
