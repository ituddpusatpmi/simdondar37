...
header("Content-Disposition: attachment; filename=LTTD3_BARUULANG_TGLAFTAP ".$_POST['namaperiode']." ".substr($_POST['tgl1'],0,4).".xls");
...
<table width="1200px" border="0">
	...
	<tr>
		<td colspan=11 align="left"><font size="3" color="black" font-family="Arial">I. LAPORAN UJI SARING DARAH Berdasarkan TGL AFTAP</font>
		<td colspan=12 align="right"><font size="3" color="black" font-family="Arial">LTTD III DONOR BARU & ULANG</font>
	</tr>
</table>
<?php
include('/var/www/simudda/laporan/lttd3_aftap_baruulang_proses.php');
?>
<table cellspacing="2" cellpadding="2" border="1" width="1200px">
	<tr>
		<th rowspan="4">No</th>
    ...
    <tr class=field>
		<th colspan="2">BARU</th><th colspan="2">ULANG</th><th colspan="2">BARU</th><th colspan="2">ULANG</th><th colspan="2">BARU</th>
        <th colspan="2">ULANG</th><th colspan="2">BARU</th><th colspan="2">ULANG</th>
	</tr>
    <tr class=field>
...
<br>
<table class=list cellspacing="2" cellpadding="2" border="1" width="1200px">
	<tr class=field>
		<th rowspan="4">No</th>
		<th rowspan="4">Keterangan</th>
		<th rowspan="4">Jumlah<br>Donasi</th>
...
<table class=list border="0" width="1200px">
   ...
   <td>
   <table class=list cellspacing="2" cellpadding="2" style="border-collapse:collapse" border="2" width="600px">
   <tr><td class=input align="left"><font size="2" color="black" font-family="Arial">
...
<table cellspacing="2" cellpadding="2" border="1" width="600px">
	<tr class=field><th rowspan="2">No</th><th rowspan="2">Jenis Rujukan</th><th rowspan="2">Jumlah</th><th colspan="5">Tempat Rujukan</th><th rowspan="2">Keterangan</th></tr>
