...
?>
<form name="cari" method="POST" action="laporan/laporan_donasi_bulanan_wb_aksi.php">
<table>
    <h2 style="text-align: center">LAPORAN DONASI DARAH LENGKAP (<i>WHOLE BLOOD/WB</i>)</h2>
<tr>
<td>Pilih Periode : </td>
<td>
