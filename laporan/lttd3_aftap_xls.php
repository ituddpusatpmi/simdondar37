...
header("Content-Disposition: attachment; filename=LTTD3 ".$_POST['namaperiode']." ".substr($_POST['tgl1'],0,4).".xls");
...
<?php
include('/var/www/simudda/laporan/lttd3_aftap_proses.php');
?>
