...
include('laporan/lttd3_baruulang_proses.php');
?>
<table width="1200px" border="0">
	...
	<tr>
		<td colspan=11 align="left"><font size="3" color="black" font-family="Arial">I. LAPORAN UJI SARING DARAH Bedasarkan TANGGAL PERIKSA</font>
...
<form name=xls method=post action=laporan/lttd3_baruulang_xls.php>
   ...
   <a href="pmi<?=$level_user?>.php?module=laporan&jenis=32" class='swn_button_blue'>Kembali</a>
</form>
<?
