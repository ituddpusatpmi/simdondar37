...
$rowone2=mysql_fetch_assoc(mysql_query("select COUNT(dt.nokantong) as Jumlah from dtransaksipermintaan dt, htranspermintaan ht
            where substr(dt.tgl,1,10)>='$sekarang' and substr(dt.tgl,1,10)<='$sekarang1' AND dt.NoForm=ht.NoForm
            AND ht.bagian LIKE '%Anak%' AND dt.stat2='cocok'"));
...
$rowone3=mysql_fetch_assoc(mysql_query("select COUNT(dt.NoKantong) as Jumlah
        from htranspermintaan as ht, dtransaksipermintaan dt where ht.NoForm=dt.NoForm
        AND ht.TglMinta>='$sekarang' and ht.TglMinta<='$sekarang1' AND (dt.Status='0' OR dt.Status='L') AND ht.bagian LIKE '%Anak%'"));
...
$rowtwo2=mysql_fetch_assoc(mysql_query("select COUNT(dt.nokantong) as Jumlah from dtransaksipermintaan dt, htranspermintaan ht
            where substr(dt.tgl,1,10)>='$sekarang' and substr(dt.tgl,1,10)<='$sekarang1' AND dt.NoForm=ht.NoForm
            AND ht.bagian LIKE '%Bedah%' AND dt.stat2='cocok'"));
...
$rowtwo3=mysql_fetch_assoc(mysql_query("select COUNT(dt.NoKantong) as Jumlah
        from htranspermintaan as ht, dtransaksipermintaan dt where ht.NoForm=dt.NoForm
        AND ht.TglMinta>='$sekarang' and ht.TglMinta<='$sekarang1' AND (dt.Status='0' OR dt.Status='L') AND ht.bagian LIKE '%Bedah%'"));
...
$rowthree2=mysql_fetch_assoc(mysql_query("select COUNT(dt.nokantong) as Jumlah from dtransaksipermintaan dt, htranspermintaan ht
            where substr(dt.tgl,1,10)>='$sekarang' and substr(dt.tgl,1,10)<='$sekarang1' AND dt.NoForm=ht.NoForm
            AND ht.bagian LIKE '%Dalam%' AND dt.stat2='cocok'"));
...
$rowthree3=mysql_fetch_assoc(mysql_query("select COUNT(dt.NoKantong) as Jumlah
        from htranspermintaan as ht, dtransaksipermintaan dt where ht.NoForm=dt.NoForm
        AND ht.TglMinta>='$sekarang' and ht.TglMinta<='$sekarang1' AND (dt.Status='0' OR dt.Status='L') AND ht.bagian LIKE '%Dalam%'"));
...
$rowfour2=mysql_fetch_assoc(mysql_query("select COUNT(dt.nokantong) as Jumlah from dtransaksipermintaan dt, htranspermintaan ht
            where substr(dt.tgl,1,10)>='$sekarang' and substr(dt.tgl,1,10)<='$sekarang1' AND dt.NoForm=ht.NoForm
            AND ht.bagian LIKE '%kandungan%' AND dt.stat2='cocok'"));
...
$rowfour3=mysql_fetch_assoc(mysql_query("select COUNT(dt.NoKantong) as Jumlah
        from htranspermintaan as ht, dtransaksipermintaan dt where ht.NoForm=dt.NoForm
        AND ht.TglMinta>='$sekarang' and ht.TglMinta<='$sekarang1' AND (dt.Status='0' OR dt.Status='L') AND ht.bagian LIKE '%Kandungan%' "));
...
$rowfive2=mysql_fetch_assoc(mysql_query("select COUNT(dt.nokantong) as Jumlah from dtransaksipermintaan dt, htranspermintaan ht
            where substr(dt.tgl,1,10)>='$sekarang' and substr(dt.tgl,1,10)<='$sekarang1' AND dt.NoForm=ht.NoForm
            AND (ht.bagian NOT LIKE '%Anak%' AND ht.bagian NOT LIKE '%Bedah%' AND ht.bagian NOT LIKE '%Dalam%'
            AND ht.bagian NOT LIKE '%Kandungan%') AND dt.stat2='cocok'"));
...
$rowfive3=mysql_fetch_assoc(mysql_query("select COUNT(dt.NoKantong) as Jumlah
        from htranspermintaan as ht, dtransaksipermintaan dt where ht.NoForm=dt.NoForm
        AND ht.TglMinta>='$sekarang' and ht.TglMinta<='$sekarang1' AND (dt.Status='0' OR dt.Status='L') AND (ht.bagian NOT LIKE '%Anak%'
        AND ht.bagian NOT LIKE '%Bedah%' AND ht.bagian NOT LIKE '%Dalam%' AND ht.bagian NOT LIKE '%Kandungan%')"));
...
$rowjum1=mysql_fetch_assoc(mysql_query("select COALESCE(SUM(d.Jumlah),0) as Jumlah from htranspermintaan h, dtranspermintaan d
            where substr(h.TglMinta,1,10)>='$sekarang' and substr(h.TglMinta,1,10)<='$sekarang1' AND h.NoForm=d.NoForm "));
$rowjum2=mysql_fetch_assoc(mysql_query("select COUNT(dt.nokantong) as Jumlah from dtransaksipermintaan dt, htranspermintaan ht
            where substr(dt.tgl,1,10)>='$sekarang' and substr(dt.tgl,1,10)<='$sekarang1' AND dt.NoForm=ht.NoForm "));
...
$b2=mysql_fetch_assoc(mysql_query("SELECT COUNT(DISTINCT(h.NoKantong))+(SELECT COUNT(DISTINCT(h1.NoKantong)) as Jumlahtwo
             ...
             AND substr(h1.Tgl,1,10)<='$sekarang1' AND (e.jenisPeriksa='0' OR e.jenisPeriksa='1' OR e.jenisPeriksa='2' OR e.jenisPeriksa='3') AND t1.Hasil='0' ) as Jumlah
             ...
             AND substr(h.Tgl,1,10)<='$sekarang1' AND (e.jenisPeriksa='0' OR e.jenisPeriksa='1' OR e.jenisPeriksa='2' OR e.jenisPeriksa='3') AND e.Hasil='1' "));
