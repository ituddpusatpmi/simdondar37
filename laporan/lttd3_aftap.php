...
include('laporan/lttd3_aftap_proses.php');
?>
...
<form name=xls method=post action=laporan/lttd3_aftap_xls.php>
   ...
   <a href="pmi<?=$level_user?>.php?module=laporan&jenis=31" class='swn_button_blue'>Kembali</a>
</form>
<?
