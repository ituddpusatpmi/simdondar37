...
<body>
<?php
$title  = "GRAFIK PENYUMBANGAN DARAH BERDASARKAN DONOR LAMA/BARU TAHUN ".$tahun;
...
count(case when pendonor.jumDonor<3 then 1 END) As 'Donor Lama',
count(case when pendonor.jumDonor>=3 then 1 END) As 'Donor Baru'
