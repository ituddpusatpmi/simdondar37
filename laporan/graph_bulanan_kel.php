...
<body>
<?php
$title  = "GRAFIK PENYUMBANGAN DARAH BERDASARKAN JENIS KELAMIN TAHUN ".$tahun;
...
COUNT(case when pendonor.Jk='0' THEN 1 END) As 'Laki-laki', 
COUNT(case when pendonor.Jk='1' THEN 1 END) As 'Perempuan'
...
<script type="text/javascript">
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([['Bulan', 'Laki-laki','Perempuan'],<?php echo $data;?>]);
        var options = {'title':'',
