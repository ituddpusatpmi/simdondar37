...
?>
<form name="cari" method="POST" action="laporan/laporan_th_donorbaruulang_aksi.php">
    <table>
        <h2 style="text-align: center">LAPORAN JUMLAH PENDONOR BARU ULANG (ORANG)</h2>
        <tr>
            <td>Pilih Periode : </td>
            <td>
                <input name="waktu" type=text size=2 value="<?=$tahun?>">
            </td><td>
