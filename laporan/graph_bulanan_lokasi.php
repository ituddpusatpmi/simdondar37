...
<body>
<?php
$title  = "GRAFIK PENYUMBANGAN DARAH BERDASARKAN LOKASI DONOR TAHUN ".$tahun;
...
from htransaksi where year(htransaksi.Tgl)='$tahun' and (htransaksi.Pengambilan='0' or htransaksi.Pengambilan='2') group by month(htransaksi.Tgl)");
...
<script type="text/javascript">
    ...
    function drawChart() {
        var data = google.visualization.arrayToDataTable([['Bulan', 'MU','UDD'],<?php echo $data;?>]);
        var options = {'title':'',
