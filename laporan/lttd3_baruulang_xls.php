...
header("Content-Disposition: attachment; filename=LTTD3_BARUULANG_TGLPERIKSA ".$_POST['namaperiode']." ".substr($_POST['tgl1'],0,4).".xls");
...
<table width="1200px" border="0">
	...
	<tr>
		<td colspan=11 align="left"><font size="3" color="black" font-family="Arial">I. LAPORAN UJI SARING DARAH Berdasarkan TGL PERIKSA</font>
		<td colspan=12 align="right"><font size="3" color="black" font-family="Arial">LTTD III DONOR BARU & ULANG</font>
	</tr>
</table>
<?php
include('/var/www/simudda/laporan/lttd3_baruulang_proses.php');
?>
