<?php
    ...
    //ANTRIAN PEMERIKSAAN
    $antri = mysqli_fetch_assoc(mysqli_query($dbi,"select *,count(nomor) as jml from antrian where date(tgl)=curdate() AND (lengan='0' or lengan='1') AND stat is null order by nomor asc"));
...
<div align="center" style="background-color: #ffffff;font-size:20px; font-weight:bold;color:#ff0000;text-shadow: 1px 1px 1px #000000; font-family:Helvetica, Arial, san-serif;">ANTRIAN AFTAP LENGAN KIRI</div>
  <!--a href="antriankiri.php"><button name="baru" class="btn btn-warning float-right"><i class="nav-icon ion ion-ios-reload"></i> RELOAD</button></a-->
</div>
...
<div class="row" align="center">
    ...
    <!--row1--->
            ...
            <table width=100% class="table table-bordered table-hover table-striped">
                ...
                <td align="center">
                <a href="batal.php?trans=<?php echo $antri['transaksi'];?>&asal=kiri"><button  class="btn btn-danger btn-block" style=";box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 4px 8px 0 rgba(0, 0, 0, 0.19); height:50px;width:100px" >BATAL</button></a>
                </td>
                </td>
              </tr>
            </table>
...
<td align="center">
<a href="antriankiri.php"><button  class="btn btn-dark btn-sm" style=";box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 4px 8px 0 rgba(0, 0, 0, 0.19); height:50px;width:100px" >RELOAD ANTRIAN</button>
</td>
            <?php
                //Pemeriksaan Awal
