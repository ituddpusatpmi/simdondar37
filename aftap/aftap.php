...
<?php
    ...
    if(isset($_POST['both'])) {
        $bed    = $_POST['kode'];
        $_SESSION['bed']   = $bed;
        $_SESSION['lengan']     = 'both';
            ?>
        <meta http-equiv="refresh" content="0; url=antripengambilan.php">
            <?php
        }
                if(isset($_POST['kiri'])) {
                    $bed    = $_POST['kode'];
                    $_SESSION['bed']        = $bed;
                    $_SESSION['lengan']     = 'kiri';
                        ?>
                    <meta http-equiv="refresh" content="0; url=antriankiri.php">
                        <?php
                    }
                            if(isset($_POST['kanan'])) {
                                $bed    = $_POST['kode'];
                                $_SESSION['bed']   = $bed;
                                $_SESSION['lengan']     = 'kanan';
                                    ?>
                                <meta http-equiv="refresh" content="0; url=antriankanan.php">
                                    <?php
                                }
...
<div class="row" align="center">
    ...
    <!--row1--->
        ...
        <div align="center" style="background-color: #ffffff;font-size:20px; font-weight:bold;color:#ff0000;text-shadow: 1px 1px 1px #000000; font-family:Helvetica, Arial, san-serif;">NOMOR KURSI DONOR</div>
        <div class="login-box" align="center">
            <div id="wrapper">
                <div class="card">
                    <div class="card-body login-card-body">
                        <img src="beddonor.jpeg" width="200px">
                        <form action="" method="post">
                          <div class="input-group mb-3">
                            <input type="text" name="kode" class="form-control" placeholder="masukan nomor kursi donor" autocomplete="off" autofocus required >
                            <input type="hidden" name="trans" class="form-control" value="<?php echo $notrans; ?>">
                          </div>
                          
                          <div class="row">
                            <div class="col-4">
                                <input type="submit" name="kiri" value="KIRI" class="btn btn-danger btn-block" style=";box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 4px 8px 0 rgba(0, 0, 0, 0.19);">

                            </div>
                            <div class="col-4">
                                <input type="submit" name="kanan" value="KANAN" class="btn btn-warning btn-block" style=";box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 4px 8px 0 rgba(0, 0, 0, 0.19);">
                            </div>
                            <div class="col-4">
                                <input type="submit" name="both" value="KEDUANYA" class="btn btn-success btn-block" style=";box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 4px 8px 0 rgba(0, 0, 0, 0.19);">
                            </div>
                          </div>
                        </form>
                    </div>
