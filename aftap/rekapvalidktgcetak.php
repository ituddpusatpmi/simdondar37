...
<title>Laporan Validasi Kantong</title>
<head>
...
<img src="aftap/kop_validasi.jpg" width="100%">
<table class="list" border="0" cellpadding="2" cellspacing="2" width="100%" style="border-collapse:collapse">
    <tr>
        <td style="height: 40px;font-size: 16px;font-weight: bold; text-align: center; font-family: 'trebuchet ms', Impact, Arial, Helvetica, sans-serif;">
            CHECKLIST DAN LEMBAR KERJA PENGAMBILAN DARAH DONOR<br>
            <?php echo $v_tgl1.' s/d '.$v_tgl2;?>
        </td>
    </tr>
</table>
...
<tr>
<td></td><td align="right">Ka.Sie Pengambilan Donor<td>
</tr>
<tr><p><br></tr>
<tr>
<td></td><td td align="right">Wahyu Dwi Kuncoro Amd.Kep</td>
</tr>
</table>


<? echo "<meta http-equiv='refresh' content='2;url=pmiaftap.php?module=rekap_validktg'";?>
</body>
