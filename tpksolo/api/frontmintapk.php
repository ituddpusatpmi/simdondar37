...
<body>
  ...
  curl_setopt_array($curl, array(
    CURLOPT_URL => "localhost/tpksolo/?page=apimintapk",
  ...
  <div class="row" align="center">
    <div class="col-lg-12">
      <h4><font color="black"><b>DATA ANTRIAN PERMINTAAN PLASMA KONVALESEN </font></h4><br>
    </div>
  </div>
...
<?php
  echo '
           ...
           <p>
            <h6><b><font color="red"> TERDAPAT '.$count.' ANTRIAN PERMINTAAN</font></b></h6> <a href=?page=frontmintapkgol><button type="submit" name="cari" class="btn btn-danger btn-block">LIHAT PER GOLONGAN DARAH</button></a>
