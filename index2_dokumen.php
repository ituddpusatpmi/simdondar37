			<font size="1"><a href="../dokumen/akses-user/dokumen-user.php" target="isiadmin" class="fisheyeItem" title="Document"><img src="dokumen/images/cari.png"/>E-DOCUMENT</a></font>
...
-->
			...
			<font size="1"><a href="pmidokumen.php?module=ganti_passwd&act=edituser&id=<?=$_SESSION['namauser']?>" target="isiadmin" class="fisheyeItem"><img src="images/change_password.png" />Edit Profil</a></font>
			
<? if ($_SESSION[multilevel]!='') { ?>
			<font size="1"><a href="pmidokumen.php?module=ganti_menu" target="isiadmin" class="fisheyeItem"><img src="images/multi.png" />Ganti Level</a></font>
<? } ?>
