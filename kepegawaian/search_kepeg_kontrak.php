	...
	<head>
		...
		$(function() {
			$(document).ready(function() {
				...
				"aoColumns": [
//('Kode','NoKTP','Nama','Alamat','Status','TempatLhr','TglLhr','umur','Jk','ijasah','statuspeg','telp2',
//'tmtkontrak','tmt80','masakerja');
					/* Kode */  null,
					/* NoKTP */ null,
					/* Nama */ null,
					/* Alamat */ null,
				...
				"sPaginationType": "full_numbers",
					...
					"sAjaxSource": "kepegawaian/search_kepeg_dt_kontrak.php",
					"oLanguage": {
...
<body id="dt_example" class="ex_highlight_row">
	...
	<div id="containerdt">
		<? if ($_SESSION[leveluser]=='kepegawaian') { ?>
			<h1 class="table">Data Karyawan Kontrak<?=$saya?>|| 
			<input type="button" value="Input Data Karyawan Kontrak" onClick="document.location.href='pmikepegawaian.php?module=registrasi_kontrak';">
			 ||<?=$pesan?></h1>
		<? } else { ?>
			<h1 class="table">Data Pegawai Kontrak
		...
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
			<thead>
				...
				<tr>
					...
					<th width="5%">HP</th>
					<th width="4%">TMT<br>Kontrak</th>
					<th width="4%">TMT<br>80%</th>
