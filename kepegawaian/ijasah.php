...
<table border=0 width=50% align=left>
  ...
  <form name="checkkantong" method="POST">
    ...
    <tr><td><input type=text name=nokantong1 required id="nik" placeholder='ketik nama karyawan, klik nama yg sesuai' size='35' style="color:#008800"><!--h4>klik pada nama yang sesuai dan klik ><h4--></td></tr>
...
$tgl	= date("d");
$kdtp	= "IJA".$tgl.$bl.$th."-";
$idp	= mysql_query("select notrans from ijasahpeg where notrans like '$kdtp%' order by notrans DESC");
$idp1	= mysql_fetch_assoc($idp);
...
if (isset($_POST['submit'])){
	...
	$ijasahlama	= $_POST['ijasahlama'];
	$ijasahbaru	= $_POST['ijasahbaru'];
	...
	$tambah=mysql_query("insert into ijasahpeg 
		(notrans,nik,tglajukan,Status,tglsk,nosk,tanggal_entry,
		 tanggal_update,ijasahlama,ijasahbaru,jabatan,golongan,pencatat,up,masakerja,jurusan,kampus)
	value ('$id_transaksi_baru','$nik','$tglawal','2','$tglakhir','$_POST[nosk]','$today1','$today1','$_POST[ijasahlama]','$ijasahbaru','$_POST[jabatan]','$_POST[golongan]','$namauser','1','$masakerja','$jurusan','$kampus')");
	...
	switch ($lv0){
		case "kepegawaian":
			?><META http-equiv="refresh" content="1; url=pmikepegawaian.php?module=ubah_ijasah"><?

		break;
		case "admin":
			?><META http-equiv="refresh" content="1; url=pmiadmin.php?module=ubah_ijasah"><?
		break;
		default:
...
<h1 style="color:#008800;">FORM INPUT PERUBAHAN DATA IJASAH KARYAWAN</h1>
...
<table  width=100%  cellspacing="1" cellpadding="2" style="background-color:#008800;">

<tr border=1 cellpadding="5" cellspacing="1" style="background-color:#008800; font-size:12px; color:#FFFFFF; font-family:Verdana;" >
	<!--tr-->
    <?php
	...
	<tr>
		...
		<tr>
		<td>Ijazah Lama</td>
		<td class="input"><input type=hidden name=ijasahlama value="<?=$check1[ijasah]?>">
			<?=$check1[ijasah]?>
		</td> </tr>
		<tr>
	<!--td>Bagian Lama</td>
...
<td><table>
	<tr><td colspan='2'>DATA MUTASI:</td></tr>
				...
				<tr>
					<td>Bidang Ilmu</td>
					<td class="input">
						 <input name="jurusan" type="text" size="10" placeholder="Jurusan">
					</td>
			   </tr>
				<tr>
					<td>Universitas</td>
					<td class="input">
						 <input name="kampus" type="text" size="15" placeholder="Nama Universitas">
					</td>
			   </tr>
