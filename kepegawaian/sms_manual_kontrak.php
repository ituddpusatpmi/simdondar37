...
<script type="text/javascript">
  jQuery(document).ready(function(){
   // $('#dokter').autocomplete({source:'modul/suggest_dokter.php', minLength:2}),
    ...
    $('#nik').autocomplete({source:'kepegawaian/suggest_pegawai2.php', minLength:2});});
</script>
<?php 
include('clogin.php');
...
if (isset($_POST[submit])) {
	 ...
	 if (($lv0=='kepegawaian') or ($lv0=='mobile')) {
			$nama=mysql_fetch_assoc(mysql_query("select Nama from pegawai_kontrak where telp2='$nomortelp'"));
			$nama1='Yth.'.$nama[Nama].', ';
...
if (isset($_GET[nomortelp])) {
	 ...
	 ?>
	 <h1 class="table">KIRIM SMS MANUAL KE KARYAWAN KONTRAK</h1>
