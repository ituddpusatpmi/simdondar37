...
if ($_SESSION[leveluser]=='admin') { $row[]="Confirm <a href=pmiadmin.php?module=cabut_cekal&Kode=".$kode." TITLE=\"CABUT CEKAL\"><img src=\"images/hapus.png\" width=15 height=15/></a>"; } else 
if ($_SESSION[leveluser]=='konseling') { $row[]="*Confirm <a href=pmikonseling.php?module=form_konseling&Kode=".$kode." TITLE=\"KONSELING\">*Konseling</a> <a href=pmikonseling.php?module=history_konseling&Kode=".$kode." TITLE=\"HISTORY KONSELING\">*History</a>"; } else { $row[]="Confirm"; }
					}
				}else if($i==15){
					if($aRow[ $aColumns[$i]]=='0'){
						$row[]="-";
