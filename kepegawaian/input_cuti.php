...
?>
<h1> Form input cuti karyawan</h1>
<form nama=pasien method=post>
<table class="list" border=0 cellspacing=0 cellpadding=0>
   <tr class="field">
<td class="input" align=left>
Masukkan NIK </td><td><input name="Kode" id="Kode" type="text" size="30" />
</td>
</tr>
</table>
...
if (isset($_POST['submit'])){
	...
	$tambah=mysql_query("insert into cutipeg (notrans,nik,jenis,tglawal,tglakhir,pencatat,tanggal_entry,up,tglcuti)
	value ('$id_transaksi_baru','$nik','$_POST[jenis]','$tglawal','$tglakhir','$namauser','$today1','0','$tglcuti')");
...
<table class="form" cellspacing="0" cellpadding="2">
	<tr>
    <?php
	$check=mysql_query("select * from pegawai where Kode='$_POST[Kode]'");
...
<tr>
	...
	<tr>
		<td>Tgl Habis Cuti Tahunan</td>
		<td class="input">
			<input type=hidden name=tglcuti value="<?=$check1[tglcuti]?>">
			<?=$check1[tglcuti]?>
		</td>
	</tr>
	<tr>
		<td>Sisa Cuti tahunan</td>
		<td class="input"><?=$check1[sisacuti]?> Hari
		</td>
	</tr>
	<tr>
		<td></td>
