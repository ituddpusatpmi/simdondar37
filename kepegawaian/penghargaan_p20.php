...
if (isset($_POST['submit'])){
	...
	value ('$id_transaksi_baru','$nik','$tglawal','$_POST[status]','$tglakhir','$_POST[nosk]','$today1','$today1','$_POST[jabatan]','$namauser','2','$ket','$masakerja')");
		
			
	if ($tambah) {
		echo "Data Telah berhasil dimasukkan<br>";
			$up0=mysql_query(" update pegawai set p20='1' where Kode='$nik'");		
...
<h1 class="table">FORM INPUT DATA PENGHARGAAN KARYAWAN MASA BHAKTI 20-29 TAHUN</h1>
...
<td><table>
	<tr><td colspan='2'>DATA PENGHARGAAN 20 TAHUN :</td></tr>
				   <tr> 
