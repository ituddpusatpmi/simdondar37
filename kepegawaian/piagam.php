...
if (isset($_POST['submit'])){
	...
	$tambah=mysql_query("insert into kppeg 
			(notrans,nik,tglajukan,Status,tglsk,nosk,gollama,golbaru,tanggal_entry,
			 tanggal_update,ijasah,jabatan,pencatat,up)
	value ('$id_transaksi_baru','$nik','$tglawal','$_POST[status]','$tglakhir','$_POST[nosk]','$_POST[golonganlama]','$_POST[golonganbaru]','$today1','$today1','$_POST[ijasah]','$_POST[jabatan]','$namauser','1')");
