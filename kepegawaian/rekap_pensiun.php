...
<?$trans0=mysql_query("select * from pegawai where CAST(tglpensiun as date)>='$today' and CAST(tglpensiun as date)<='$today1' order by kgb1 ASC");?>
<h2 class="table">Jumlah Karyawan yang sudah waktunya Pensiun dari Tgl <?='&nbsp'.'&nbsp'.'&nbsp'?>:<?='&nbsp'.'&nbsp'.'&nbsp'?><?=$pertgl?> - <?=$perbln?> - <?=$perthn?> <?='&nbsp'.'&nbsp'.'&nbsp'?>s/d<?='&nbsp'.'&nbsp'.'&nbsp'?> <?=$pertgl1?> - <?=$perbln1?> - <?=$perthn1?><?='&nbsp'.'&nbsp'.'&nbsp'?>Berjumlah<?='&nbsp'.'&nbsp'.'&nbsp'?>:<?='&nbsp'.'&nbsp'.'&nbsp'?><?=mysql_num_rows($trans0)?>  Data</h2>
...
<br>
<form name=xls method=post action=kepegawaian/rekap_pensiun_xls.php>
...
<input type=submit name=submit2 value='Print Rekap Data Pensiun (.XLS)'>
</form>
</table>
