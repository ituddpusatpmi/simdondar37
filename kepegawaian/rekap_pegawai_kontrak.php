...
<?
//$transaksipermintaan=mysql_query("select * from pegawai_kontrak where Kode like '%$nik%' and Jk like '%$kelamin%' and status like '%$status%' and ijasah like '%$ijasah%' and statuspeg like '%$status1%' and golongan like '%$pangkat%' and kelompok like '%$bagian%' and bagian like '%$bagian1%'  and jabatan like '%$jabatan%' order by Kode ASC  ");
$transaksipermintaan=mysql_query("select * from pegawai_kontrak where Kode like '%$nik%' and Jk like '%$kelamin%'  and status like '%$status%' and ijasah like '%$ijasah%' and statuspeg like '%$status1%' and golongan like '%$pangkat%' and bagian1 like '%$bagian%' and bagian like '%$bagian1%'  and jabatan like '%$jabatan%' order by Kode ASC  ");
$countp=mysql_num_rows($transaksipermintaan);
echo"<br><br>";
echo"Total Data Karyawan kontrak yang dipilih sebanyak ";
echo"<b>";
echo $countp;
echo"</b>";
echo " Data";
...
<tr style="background-color:#FF9960; font-size:12px; color:#000000; font-family:Verdana;" 
  onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
	<td align="left"><?=$no?></td>
	<td align="left"><?="<a href=pmi".$_SESSION[leveluser].".php?module=sejarahpegkontrak&kode=".$datatransaksipermintaan['Kode']." TITLE=\"DETIL DATA KARYAWAN\">
...
<form name=xls method=post action=kepegawaian/rekap_pegawai_kontrak_xls.php>
