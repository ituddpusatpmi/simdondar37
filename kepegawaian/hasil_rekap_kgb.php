...
<?
$transaksipermintaan=mysql_query("select * from kgbpeg where CAST(tglajukan as date) >= '$today' CAST(tglajukan as date) <= '$today1' and and ijasah like '%$ijasah%' 
...
<tr style="background-color:#FF6600; font-size:12px; color:#FFFFFF; font-family:Verdana;" 
  onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">                  
	...
	<td colspan='12' align="center">PENDIDIKAN & PEKERJAAN</td>
		...
		<tr style="background-color:#FF6600; font-size:11px; color:#FFFFFF; font-family:Verdana;" 
  onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'" >
...
?>
<tr style="background-color:#FF9900; font-size:12px; color:#000000; font-family:Verdana;" 
  onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
	<td align="left"><?=$no?></td>
	<td align="left"><?=$datatransaksipermintaan['tglajukan']?></td>
