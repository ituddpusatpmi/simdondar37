...
<table border=0 width=50% align=left>
  ...
  <form name="checkkantong" method="POST">
	...
	<tr><td><input type=text name=nokantong1 required id="nik" placeholder='ketik nama karyawan Yg dinilai' size='35' style="color:#FF6600"></td>
	<td><input type=text name=nokantong2 required id="nik1" placeholder='ketik nama Pejabat Penilai' size='35' style="color:#FF6600"></td>
	<td><input type=text name=nokantong3 required id="nik2" placeholder='ketik nama Atasan Pejabat Penilai' size='35' style="color:#FF6600"></td>
...
$tgl	= date("d");
$kdtp	= "DPP".$tgl.$bl.$th."-";
$idp	= mysql_query("select notrans from dpppeg where notrans like '$kdtp%' order by notrans DESC");
$idp1	= mysql_fetch_assoc($idp);
...
$tgl9        = $_POST['tgl9'];     
	...
	$tambah=mysql_query("insert into dpppeg
(notrans,nikpeg,nikpenilai,nikatasan,golpeg,golpenilai,golatasan,jabpeg,jabpenilai,jabatasan,dirpeg,dirpenilai,diratasan,tanggungjawab,ketaatan,
kejujuran,kerjasama,prakarsa,kepemimpinan,keberatan,tgl1,tanggapan,tgl2,keputusan,tgl3,
keterangan,tgl4,tglterima,tgldibuat,tglterimaatasan,tglawal,tglakhir,tanggal_entry,tanggal_update,pencatat)
	...
	'$diratasan','$angka1','$angka2','$angka3','$angka4','$angka5','$angka6','$keberatan','$tgl1',
	...
	if ($tambah) {
		...
		mysql_query("UPDATE dpppeg set jumlahstaff=(tanggungjawab + ketaatan + kejujuran + kerjasama + prakarsa) where (kepemimpinan='' or kepemimpinan='0')");
		mysql_query("UPDATE dpppeg set rataratastaff=(jumlahstaff/5) where (kepemimpinan='' or kepemimpinan='0')");
		mysql_query("UPDATE dpppeg set jumlahstaff=(tanggungjawab + ketaatan + kejujuran + kerjasama + prakarsa + kepemimpinan ) where kepemimpinan >'0'");
		mysql_query("UPDATE dpppeg set rataratastaff=(jumlahstaff/6) where kepemimpinan >'0'");
/*	
		if ($jumnilai=='1') { mysql_query(")");
						   }
		else { mysql_query("UPDATE dpppeg set jumlahstaff=(tanggungjawab + ketaatan + kejujuran + kerjasama + prakarsa + kepemimpinan)");
							mysql_query("UPDATE dpppeg set rataratastaff=(jumlahstaff/6)");}
		
/*
		mysql_query("UPDATE dpppeg set rataratastaff=(jumlahstaff / 5 )");
		mysql_query("UPDATE dpppeg set rataratapimpinan=(jumlahpimpinan / 6 )");
		mysql_query("UPDATE dpppeg set jumlahpimpinan=kepemimpinan ,rataratapimpinan=kepemimpinan where kepemimpinan='' ");
		mysql_query("UPDATE dpppeg set jumlahstaff='' ,rataratastaff='' where kepemimpinan > 0 ");	
...
*/		
	...
	switch ($lv0){
		case "kepegawaian":
			?><META http-equiv="refresh" content="1; url=pmikepegawaian.php?module=dp2"><?

		break;
		case "admin":
			?><META http-equiv="refresh" content="1; url=pmiadmin.php?module=dp2"><?
		break;
		default:
...
?>
<h1 style="color:#FF6600;">FORM INPUT DP2 KARYAWAN <?=$tempat1[nama]?></h1>
...
<table cellspacing="1" cellpadding="2" style="background-color:#FF6600;">

<tr border=1 cellpadding="5" cellspacing="1" style="background-color:#FF6600; font-size:12px; color:#FFFFFF; font-family:Verdana;" >
	<!--tr-->
    <?php
...
<tr>
<td><table cellspacing="1" cellpadding="2" style="background-color:#FF6600;">

<tr border=1 cellpadding="5" cellspacing="1" style="background-color:#FF6600; font-size:12px; color:#FFFFFF; font-family:Verdana;" >
<td>
	<table border=1 cellpadding="5" cellspacing="1">

<tr><td colspan='4' style="font-weight: bold;">Waktu penilaian dari <input type="text" name="tgl8" id="datepicker7" placeholder="yyyy-mm-dd" size=11> sampai <input type="text" name="tgl9" id="datepicker8" placeholder="yyyy-mm-dd" size=11></td>
			</tr>

		<td colspan='4' style="font-weight: bold;">4. HASIL PENILAIAN</td></tr>
				   <tr> 
					<td rowspan='2'>Unsur Penilaian</td>
...
<script>
function addNumbers(elem1, elem2, elem3, elem4, elem5) {
  ...
  var g = (Number(a) + Number(b) + Number(c) + Number(d) + Number(e))/5;
 document.getElementById("testResult").innerHTML =f;
 document.getElementById("testResult1").innerHTML =g;
 ///document.getElementByName("jumlahstaff").innerHTML =f;
 //document.getElementByName("rataratastaff").innerHTML =g;
}

function addNumbers1(elem1, elem2, elem3, elem4, elem5, elem6) {
  var a = document.getElementById(elem1).value;
  var b = document.getElementById(elem2).value;
  var c = document.getElementById(elem3).value;
  var d = document.getElementById(elem4).value;
  ...
  var h = (Number(a) + Number(b) + Number(c) + Number(d) + Number(e)+ Number(f))/6;
 document.getElementById("testResult2").innerHTML =g;
 document.getElementById("testResult3").innerHTML =h;
}
</script>
				<tr>
					<td>Tanggung Jawab</td>
					<td class="input">
					<input name="angka1" id="varA" type="textbox" size="5" placeholder="Angka" value="<?php if($cek_tmpudd!=0){echo "$data_combo[angka1]";}?>">
					</td>
					<td class="input">
					<input name="sebutan1" type="textbox" size="20" placeholder="Sebutan" value="<?php if($cek_tmpudd!=0){echo "$data_combo[angka1]";}?>">
					</td>
					<td class="input">
				...
				<tr>
					<td>Ketaatan</td>
					<td class="input">
					<input name="angka2" id="varB" type="textbox" size="5" placeholder="Angka" value="<?php if($cek_tmpudd!=0){echo "$data_combo[angka2]";}?>">
					</td>
					<td class="input">
					<input name="sebutan2" type="textbox" size="20" placeholder="Sebutan" value="<?php if($cek_tmpudd!=0){echo "$data_combo[angka2]";}?>">
					</td>
					<td class="input">
				...
				<tr>
					<td>Kejujuran</td>
					<td class="input">
					<input name="angka3" id="varC" type="textbox" size="5" placeholder="Angka" value="<?php if($cek_tmpudd!=0){echo "$data_combo[angka3]";}?>">
					</td>
					<td class="input">
					<input name="sebutan3" type="textbox" size="20" placeholder="Sebutan" value="<?php if($cek_tmpudd!=0){echo "$data_combo[angka3]";}?>">
					</td>
					<td class="input">
				...
				<tr>
					<td>Kerjasama</td>
					<td class="input">
					<input name="angka4" id="varD" type="textbox" size="5" placeholder="Angka" value="<?php if($cek_tmpudd!=0){echo "$data_combo[angka4]";}?>">
					</td>
					<td class="input">
					<input name="sebutan4" type="textbox" size="20" placeholder="Sebutan" value="<?php if($cek_tmpudd!=0){echo "$data_combo[angka4]";}?>">
					</td>
					<td class="input">
				...
				<tr>
					<td>Prakarsa</td>
					<td class="input">
					<input name="angka5" id="varE" type="textbox" size="5" placeholder="Angka" value="<?php if($cek_tmpudd!=0){echo "$data_combo[angka5]";}?>">
					</td>
					<td class="input">
					<input name="sebutan5" type="textbox" size="20" placeholder="Sebutan" value="<?php if($cek_tmpudd!=0){echo "$data_combo[angka5]";}?>">
					</td>
					<td class="input">
						 <select name="kategori5">
							  <option value="0">Sangat Baik</option>
							  <option value="1" selected>Baik</option>
							  <option value="2">Cukup</option>
							  <option value="3">Kurang</option>
				...
				<tr>
					<td>Kepemimpinan</td>
					<td class="input">
					<input name="angka6" id="varF" type="textbox" size="5" placeholder="Angka"  >
					</td>
					<td class="input">
					<?$nilai=$angka6;?>
					<input name="sebutan6" type="textbox" size="20" placeholder="Sebutan">
					</td>
					<td class="input">
						 <select name="kategori6">
							  <option value="0">Sangat Baik</option>
							  <option value="1" selected>Baik</option>
							  <option value="2">Cukup</option>
							  <option value="3">Kurang</option>
				...
				<td>
					...
					<td>
					<input type="button"  value="Hitung Nilai staf"     onclick="addNumbers('varA', 'varB', 'varC', 'varD', 'varE')"></input></td>
					<td>
					<input type="button"  value="Hitung Nilai pemimpin" onclick="addNumbers1('varA', 'varB', 'varC', 'varD', 'varE', 'varF')"></input>
					</td>
</tr>
<tr>
		
<td>Jumlah</td>
<td style="font-weight: bold;" size="5" id="testResult"></td>
<!--td class="input"  type="text" name="jumlahstaff" style="font-weight: bold;" size="5" ></td-->
<td style="font-weight: bold;" size="5" id="testResult2"></td>
</tr>
<tr>
<td>Nilai Rata-rata</td>
<td class="input" type="text" name="rataratastaff" style="font-weight: bold;" size="5" id="testResult1"></td>
<td class="input" type="text" name="ratarataatasan" style="font-weight: bold;" size="5" id="testResult3"></td>
</tr>
</table>


<td border=1 cellpadding="5" cellspacing="1" style="background-color:#FF6600; font-size:12px; color:#FFFFFF; font-family:Verdana;">
	<table border=1 cellpadding="5" cellspacing="1">
	<tr > 
