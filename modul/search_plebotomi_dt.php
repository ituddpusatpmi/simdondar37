...
$array_bulan = array(1=>'Jan','Feb','Mar', 'Apr', 'Mei', 'Jun','Jul','Ags','Sep','Okt', 'Nov','Des');
	...
	while ( $aRow = mysql_fetch_array( $rResult ) )
	{
		...
		case "kasir2":
				$lokal=strpos(substr($kode,0,4),$utd[id]);
				if ($antri[kode]!=$kode ) {
				$link=$link."<a href=pmikasir2.php?module=transaksi_plebotomi&kode=".$kode." TITLE=\"Transaksi Plebotomi\"><img src=\"images/bloodbag.png\" width=20 height=15/></a> ";
				}
				if ($lokal!==false) $link=$link. "<a href=pmikasir2.php?module=eregistrasi_pasien_plebotomi&kode=".$kode." TITLE=\"Edit data pasien\"><img src=\"images/ubah.png\" width=15 height=15/></a>";
