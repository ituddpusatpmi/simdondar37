...
header("Content-Disposition: attachment; filename=rekap_reaktif_rapid.xls");
...
<tr> <td colspan=12>Daftar Pemeriksaan IMLTD Kantong Reaktif Rapid dari tanggal : <?=$today?> sampai dengan  <?=$today1?> </td></tr>
<?
$hasil=mysql_query("select dr.noKantong as nk,dr.tgl_tes as tgl,sk.tgl_Aftap as ta,sk.gol_darah as gd,sk.RhesusDrh as rh,sk.statKonfirmasi as kon,sk.mu as md from drapidtest as dr,stokkantong as sk where dr.hasil='0' and dr.tgl_tes>='$today' and dr.tgl_tes<='$today1' and sk.noKantong=dr.noKantong group by dr.nokantong order by tgl_Aftap ASC");
$hbs=mysql_fetch_assoc(mysql_query("select count(jenisperiksa) as hbs from drapidtest where jenisperiksa='0' and hasil='0' and tgl_tes>='$today' and tgl_tes<='$today1' "));
$hcv=mysql_fetch_assoc(mysql_query("select count(jenisperiksa) as hcv from drapidtest where jenisperiksa='1' and hasil='0' and tgl_tes>='$today' and tgl_tes<='$today1' "));
$hiv=mysql_fetch_assoc(mysql_query("select count(jenisperiksa) as hiv from drapidtest where jenisperiksa='2' and hasil='0' and tgl_tes>='$today' and tgl_tes<='$today1' "));
$syp=mysql_fetch_assoc(mysql_query("select count(jenisperiksa) as syp from drapidtest where jenisperiksa='3' and hasil='0' and tgl_tes>='$today' and tgl_tes<='$today1' "));
