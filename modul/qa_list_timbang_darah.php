...
<body>
	...
	<form name="cari" method="POST" action="<?echo $PHPSELF?>">
		<table class="list" cellpadding=1 cellspacing="0" border="0">
			<tr class="field">
				<td align="left" nowrap>Tanggal </td>
				<td><input name="waktu" id="datepicker"  value="<?=$tglawal?>" type=text size="10" style="font-family:monospace"></td>
				<td align="right" nowrap>s/d </td>
				<td><input name="waktu1" id="datepicker1" value="<?=$hariini?>" type=text size="10" style="font-family:monospace"></td>
				<td>Nama Petugas<input name="petugas" id="petugas" value="<?=$petugas?>" type=text size="10" style="font-family:monospace"></td>
				...
				<td><input type=submit name=submit class="swn_button_blue" value="Ok">
	...
	$sql="SELECT t.`id`, t.`waktu`, t.`user`, u.`nama_lengkap`, t.`bagian`, t.`nokantong`, t.`berat_ukur`,
		  ...
		  WHERE  t.`bagian`='PROLIS' AND DATE(t.waktu)>='$tglawal AND date(t.waktu)<=$hariini' and t.`konfirm` like '%$status%' and u.`nama_lengkap` like '%$petugas%' ";
