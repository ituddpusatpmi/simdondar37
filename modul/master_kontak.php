		...
		$(function() {
			$(document).ready(function() {
				...
				"sDom": '<"H"lrf>t<"F"ip>', //T=button, f=search, r=records, H=background header, l=paging
					"sAjaxSource": "modul/master_kontak_dt.php",
					"oLanguage": {
...
<body id="dt_example" class="ex_highlight_row">
	...
	<div id="containerdt">
		<? if ($_SESSION[leveluser]=='logistik') { 
			?>
			<h1 class="table">DATA KONTAK (SUPPLIER / CUSTOMER / BAGIAN DI UDD)</h1>
			<button  value="tambah_kontak" class="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" role="button" aria-disabled="false"
				onClick="document.location.href='pmilogistik.php?module=entry_kontak';">
				<span class="ui-button-text">Tambah master kontak</span>
			</button>
			<?
		} ?>
		...
		<table cellpadding="0" cellspacing="0" border="0" class="display" id="example">
			...
			<tfoot>
				<tr>
					...
					<th><input type="text" name="search_Jenis" value="Jenis Kontak" class="search_init" /></th>
