...
$sehatup1=mysql_query("update stokkantong set Status='2',sah='1',stattempat='1',statkonfirmasi='1' where noKantong='$_POST[kode]'");
...
else{ echo "Kantong: $_POST[kode]  Telah diubah menjadi darah SEHAT";}
}
?>
