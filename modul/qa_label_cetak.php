...
if (strlen($hasil1[rproduk])>5){
	$pdf->SetXY(1,20);$pdf->SetFont('helvetica', 'b', 18);
	$pdf->Cell(0, 0,$hasil1[rproduk], 0, 5, 'L');
}else{
	$pdf->SetXY(1,20);$pdf->SetFont('helvetica', 'b', 22);
	$pdf->Cell(0, 0,$hasil1[rproduk], 0, 5, 'L');	
}
$pdf->SetXY(1,28);$pdf->SetFont('helvetica', 'b', 16);
$pdf->Cell(0, 0, $hasil1[volume].' ml', 0, 5, 'L');
$pdf->SetXY(1,32);$pdf->SetFont('helvetica', 'b', 40);
$pdf->Cell(0, 0,$hasil1[rgolda], 0, 5, 'L');

	
//IMLTD
$pdf->SetXY(45,20);$pdf->SetFont('helvetica','', 9);
$pdf->Cell(0, 0, 'Pemeriksaan Screening', 0,1);
$pdf->SetXY(45,23);
$pdf->Cell(0, 0, 'Non Reaktif terhadap:', 0,1);
$pdf->SetXY(45,26);
$pdf->Cell(0, 0, 'Anti HIV, Anti HCV, HBsAg & Syphilis', 0,1);
$pdf->SetLineWidth(0.1);$pdf->Line(45,31,99,31);
