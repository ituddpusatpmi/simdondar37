...
?>
	...
	<table bgcolor="#000012" cellspacing="1" cellpadding="3">
		<tr bgcolor="#FF1000">
			...
			<th>
				<form name=xls method=post action=modul/rekap_sejarah_donor_xls.php>
...
*/
		...
		?>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td align="center">
					<form name="kirim" method="post" action="formulir_donor_PDF3.php?kp=<? echo $dtrans['Kodependonor'] ?>&trans=<? echo $dtrans['NoTrans'] ?>" target="_blank">
						<input name="submit" type="submit" value="Lihat Form Donor">
					</form>
				</td>
