...
header("Content-Disposition: attachment; filename=Rekap_pemusnahan_darah.xls");
...
?>
<h5 colspan='9' class="table">Rekap Pemusnahan Darah Dari Tanggal :   <?=$pertgl?> - <?=$perbln?> - <?=$perthn?> sampai <?=$pertgl1?> - <?=$perbln1?> - <?=$perthn1?>
<br></h5>
<?
