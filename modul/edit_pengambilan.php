...
?><script language="javascript">
		alert("Perubahan pengambilan darah telah disimpan.");
	</script><?
					}
						?>
			...
			if ($transaksi['NoKantong'] = $nokantongA) {
				...
				switch ($transaksi['caraAmbil']) {
					case '0':
						...
						break;
					case '1':
						$caraambil1 = "Tromboferesis";
						break;
					case '2':
						$caraambil1 = "Leukoferesis";
						break;
					case '3':
						$caraambil1 = "Plasmaferesis";
						break;
					case '4':
						$caraambil1 = "Eritroferesis";
						break;
					case '5':
						$caraambil1 = "Plebotomi";
						break;
				}
				switch ($transaksi['tempat']) {
					case '0':
						...
						break;
					case '1':
						$tempat = "Mobile Unit belum ditransfer";
						break;
					case '2':
						$tempat = "Mobil Unit";
						break;
					case '3':
						$tempat = "Mobil Unit dalam gedung";
						break;
				}
	?>
				...
				?><script language="javascript">
						alert("Nomor kantong yang anda masukkan tidak ada dalam transaksi pengambilan darah!!!???");
					</script><? }
								} else {
										?><script language="javascript">
					alert("Nomor kantong yang anda masukkan bukan status 1 (BARU ISI) atau 5 (GAGAL AFTAP) atau tidak ada, tidak bisa dilakukan perubahan pengambilan darah");
				</script><?
								}
							}
							if (isset($nodonor)) {
