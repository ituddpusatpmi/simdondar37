...
$col5=mysql_query("SELECT * FROM `dtransaksipermintaan` where wil_rs is NULL");if ($col5){mysql_query("update dtransaksipermintaan as d,rmhsakit as r set d.wil_rs=r.wilayah where d.rs=r.Kode and d.wil_rs is NULL");}
