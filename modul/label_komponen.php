...
?>
<tr><td>
	<input name=cetak type=button value="Cetak" onclick="$.fn.colorbox({href:'label_komponen.php?noKantong=<?=$kantong1[noKantong]?>', iframe:true, innerWidth:350, innerHeight:350},function(){ $().bind('cbox_closed', function(){window.location ='pmikomponen.php?module=shasil_labl'})});">
	</td><td></td></tr>
<? } ?>
</table>
</body>
