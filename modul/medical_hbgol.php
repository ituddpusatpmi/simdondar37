                            ...
                            <div class="col-xs-6">
                                <div class="table-responsive">
                                    <table class="table borderless table-striped table-hover" id="shadow1">
                                        ...
                                        <tr><td>Golongan Darah dan Rhesus</td>
                                            <td>
                                            ...
                                            <tr>
                                                <td>3. HB Meter</td>
                                                <td class="input">
                                                    <input type="text" name="hb" size="6" onKeyUp="cek(this.value)" value="<?php echo $ex_sampleinfo[4];?>" required> g/dL
                                                </td>
                                            </tr>
                                            <tr><td><b>Petugas Pemeriksaan HB</b></td>
                                            <td>
                                            ...
                                            <tr>
                                                ...
                                                <td><div class="onoffswitch">
                                                        ...
                                                        <input type="checkbox" name="lanjutaftap" class="onoffswitch-checkbox" id="lanjutaftap" tabindex="1" value="1">
