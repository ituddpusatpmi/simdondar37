    ...
    for($j=0;$j<4;$j++){
		...
		if ($rg!='') {
			...
			for($i=0;$i<$_POST[jum_kantong];$i++){
				...
				if (($metode=='rapid') and ($metode=='nat')) $hs=$od;
				$od=str_replace(',','.',$od);
		    ...
		    if (($nrapid1)=='2') {
				...
				$nnatgz=mysql_num_rows(mysql_query("select * from hasilnat where noKantong='$nkt' and Hasil='2'"));
...
*/
					...
					$nrusak++;
						if ($jum_komponen>0) { $tambah3s=mysql_query("UPDATE stokkantong set Status='4',tglpengolahan=tgl_Aftap, tglperiksa='$today', sah='1',hasil='4',StatTempat='1'  where NoKantong like '$no_kantong0%'");}
							else { $tambah3s=mysql_query("UPDATE stokkantong set Status='4',tglpengolahan=tgl_Aftap,tglperiksa='$today',sah='1',StatTempat='1', hasil='4' where NoKantong='$nkt'"); }
/*
						switch ($jum_komponen){
							case 1:
...
*/
	...
	$histori=mysql_query("insert into histori (`username`,`waktu`,`action`,`bagian`,`nokantong`,`statkan`) values ('$namauser','$today','Pemeriksaan IMLTD NAT','Laboratorium IMLTD','$nkt','6')");
}
//------------------------------ END Submit ----------------------------//
?>
...
<div class="alert" id="alert">
	...
	<div id="kantong_reaktif" title="Kantong reaktif...!">
		<p>Gunakan menu update nat, untuk merubah hasil lab. Silahkan masukkan kantong yang lain</p>
	</div>
