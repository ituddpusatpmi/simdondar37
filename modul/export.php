...
header("Content-Disposition: attachment; filename=hasil-qc.xls");
header("Pragma: no-cache");
header("Expires: 0");
//include 'peoses_hasilqc.php';
?>
<style type="text/css">
.tabel {
font-size: 11px;
...
<td align="center">Lekosit<br><0.08 x 10<sup>9</sup>/L</br></td>
<td align="center">&#8721Trombosit<br>< 38.89 X 10<sup>10</sup>/L</br></td>
<td align="center">SDM<br>< 4.67 X 10<sup>9</sup>/L</br></td>
<td align="center">Faktor VIII<br>> 0.54 IU/mL</br></td>
...
$sqlffp3=mysql_query("SELECT * FROM qc WHERE bulanqc=$bulanffp3 AND tahunqc=$tahunffp3 AND produk='FFP' AND lekosit > 0.08") or die(mysql_error());
$lekositffp=mysql_num_rows($sqlffp3);

$bulanffp4=$_POST['bulan'];
$tahunffp4=$_POST['tahun'];
$sqlffp4=mysql_query("SELECT * FROM qc WHERE bulanqc=$bulanffp4 AND tahunqc=$tahunffp4 AND produk='FFP' AND trombosit > 38.89") or die(mysql_error());
...
$sqlffp6=mysql_query("SELECT * FROM qc WHERE bulanqc=$bulanffp6 AND tahunqc=$tahunffp6 AND produk='FFP' AND vaktorviii < 0.54") or die(mysql_error());
...
<td align="center">Ph<br>>6.2</br></td>
<td align="center">&#8721Trombosit Per Unit<br>>4.2 X 10<sup>10</sup></br></td>
<td align="center">Aerob</td>
<td align="center">Anaerob</td>
</tr>
<?
...
$sqltc4=mysql_query("SELECT * FROM qc WHERE bulanqc=$bulantc4 AND tahunqc=$tahuntc4 AND produk='TC' AND jmltrombosit < 4.2") or die(mysql_error());
$jmltrom=mysql_num_rows($sqltc4);

$bulantc5=$_POST['bulan'];
$tahuntc5=$_POST['tahun'];
$sqltc5=mysql_query("SELECT * FROM qc WHERE bulanqc=$bulantc5 AND tahunqc=$tahuntc5 AND produk='TC' AND ph < 6.2 ") or die(mysql_error());
...
<td align="center">Volume<br>218 &plusmn 35 mL</br></td>
<td align="center">Hematokrit<br>&#8804 80%</br></td>
<td align="center">Aerob</td>
<td align="center">Anaerob</td>
</tr>
<?
...
$sqlprc2=mysql_query("SELECT * FROM qc WHERE bulanqc=$bulanprc2 AND tahunqc=$tahunprc2 AND produk='PRC' AND volume > 353") or die(mysql_error());
$vollebih=mysql_num_rows($sqlprc2);

$bulanprc3=$_POST['bulan'];
$tahunprc3=$_POST['tahun'];
$sqlprc3=mysql_query("SELECT * FROM qc WHERE bulanqc=$bulanprc3 AND tahunqc=$tahunprc3 AND produk='PRC' AND volume < 183") or die(mysql_error());
$volkurang=mysql_num_rows($sqlprc3);

$bulanprc4=$_POST['bulan'];
$tahunprc4=$_POST['tahun'];
$sqlprc4=mysql_query("SELECT * FROM qc WHERE bulanqc=$bulanprc4 AND tahunqc=$tahunprc4 AND produk='PRC' AND hematokrit >= 80") or die(mysql_error());
...
<td align="center">Hemoglobin<br>> 35 g/unit</br></td>
<td align="center">Aerob</td>
<td align="center">Anaerob</td>
</tr>
<?
...
$sqlwb4=mysql_query("SELECT * FROM qc WHERE bulanqc=$bulanwb4 AND tahunqc=$tahunwb4 AND produk='WB' AND hemoglobin < 35") or die(mysql_error());
