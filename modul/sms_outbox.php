		...
		$(function() {
			$(document).ready(function() {
				...
				"sPaginationType": "full_numbers",
					...
					"sAjaxSource": "modul/sms_outbox_dt.php",
					"oLanguage": {
...
if (isset($_POST[submit])) {
    ...
    if($empty){
	echo '<META http-equiv="refresh" content="0; url=pmiadmin.php?module=outbox">';
    }else{
        echo mysql_error();
    }
}
...
<body id="dt_example" class="ex_highlight_row">
	<div>
        ...
        <form name="empty" method="post" action="pmiadmin.php?module=kosongkan_outbox">
