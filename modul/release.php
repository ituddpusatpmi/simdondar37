...
header("Content-Disposition: attachment; filename=darah_release.xls");
...
if (mysql_num_rows($t)!=0) $t=mysql_query("select * from stokkantong where Status='2' and statKonfirmasi='1' and sah='1' and kadaluwarsa > current_date and hasil_release='1' order by gol_darah,produk,noKantong");
