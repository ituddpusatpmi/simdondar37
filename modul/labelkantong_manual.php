...
$pdf->SetTitle('ID Cand');
$pdf->SetSubject('Barcode');
$pdf->SetKeywords('Simbada, PDF, barcode, id-card, pmi, jember');
...
*/
$pdf->SetX(2);
$pdf->write1DBarcode($_GET['nokan'], 'C128', '', '', 48, 20, '', $style, 'T');
$pdf->SetX(52);
$pdf->write1DBarcode($_GET['nokan'], 'C128', '', '', 48, 20, '', $style, 'N');
/*
} 
	} else {
$pdf->SetX(4);
