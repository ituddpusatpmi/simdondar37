...
<h1 class="table">Rekap Terima Darah dari UDD lain Tangal :   <?=$pertgl?> - <?=$perbln?> - <?=$perthn?> sampai <?=$pertgl1?> - <?=$perbln1?> - <?=$perthn1?>
</h1>
<div>
...
$no=1;
$q_dtransaksipermintaan=mysql_query("select noKantong,jenis,gol_darah,produk,RhesusDrh,tgl_Aftap,kadaluwarsa,tglperiksa,stat2,tgl_keluar,tglTerima,AsalUTD from stokkantong where CAST(tglTerima as date)>='$today' and CAST(tglTerima as date)<='$today1' and Nokantong like '%A' and AsalUTD is not NULL order by tglTerima ASC");
