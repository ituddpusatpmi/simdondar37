...
if(isset($_POST['Button_rapid']))  { //Metode Rapid======
	...
	<META http-equiv="refresh" content="0; url=pmiimltd.php?module=import_etimax3000konfirmasi"><?
} //End of Submit Rapid==================================
else
{ if(isset($_POST['Button_elisa']))  { //Metode ELISA====
	...
	echo "<SCRIPT>alert('Manual input $parameter metode ELISA  sudah disimpan.');</SCRIPT>";?>
	<META http-equiv="refresh" content="0; url=pmiimltd.php?module=import_etimax3000konfirmasi"><?
	}
}
...
?>
<head>
<title>Input Manual hasil IMLTD Diasorin Eti-max 3000</title>
</head>
<body>
<?php
$parameter 	= $_GET['parameter'];
...
if ($metode=="elisa"){
	...
	<input type="submit" name="Button_elisa" value="Simpan hasil" class="swn_button">
	<a href="pmiimltd.php?module=import_etimax3000konfirmasi"class="swn_button">Kembali ke hasil import</a>
	...
	<input type="submit" name="Button_rapid" value="Simpan hasil" class="swn_button">
	<a href="pmiimltd.php?module=import_etimax3000konfirmasi"class="swn_button">Kembali ke hasil import</a>
	<a href="pmiimltd.php?module=import_etimax3000"class="swn_button">Kembali ke awal</a>
</form><?
//END OF RAPID
