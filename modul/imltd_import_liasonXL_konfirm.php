    ...
    if ($lanjut == 0){
        ...
        for ($i=0;$i<count($_POST[sample]);$i++) {
            ...
            if ($aksi_konfirm!=="3"){
                ...
                /*$q_konfirm="INSERT INTO pmi.`imltd_cobas_konfirm`(`no_trans`, `instr`,  `trans_time`, `user`,
                `id_tes`,
                ...
                VALUES ('$notrans', '$instrument', '$trans_time', '$user_instrument',
                '$sample',
                ...
                if ($aksi_konfirm=="1"){
                    echo "-sehat-";
                    //UPDATE KANTONG A-F
                    $cek="UPDATE pmi.stokkantong set Status='2',hasil='2',sah='1',StatTempat='1', tglperiksa='$today1' where NoKantong='$nkantong_a'";
                    $upd_ktga=mysql_query("UPDATE pmi.stokkantong set Status='2',hasil='2',sah='1',StatTempat='1', tglperiksa='$today1' where NoKantong='$nkantong_a'");
                    $upd_ktgb=mysql_query("UPDATE pmi.stokkantong set Status='2',hasil='2',sah='1',StatTempat='1', tglperiksa='$today1' where NoKantong='$nkantong_b'");
                    $upd_ktgc=mysql_query("UPDATE pmi.stokkantong set Status='2',hasil='2',sah='1',StatTempat='1', tglperiksa='$today1' where NoKantong='$nkantong_c'");
                    $upd_ktgd=mysql_query("UPDATE pmi.stokkantong set Status='2',hasil='2',sah='1',StatTempat='1', tglperiksa='$today1' where NoKantong='$nkantong_d'");
                    $upd_ktge=mysql_query("UPDATE pmi.stokkantong set Status='2',hasil='2',sah='1',StatTempat='1', tglperiksa='$today1' where NoKantong='$nkantong_e'");
                    $upd_ktgf=mysql_query("UPDATE pmi.stokkantong set Status='2',hasil='2',sah='1',StatTempat='1', tglperiksa='$today1' where NoKantong='$nkantong_f'");
                    $upd_ktgg=mysql_query("UPDATE pmi.stokkantong set Status='2',hasil='2',sah='1',StatTempat='1', tglperiksa='$today1' where NoKantong='$nkantong_g'");
                ...
                //------------------------------------------------------------------------------------------------------
                $sq_setstatus="UPDATE pmi.`liason2021` SET `confirm`='1'
                ...
                if ($aksi_konfirm=="2"){
                    ...
                    $tambah3s=mysql_query("UPDATE pmi.stokkantong set Status='7',hasil='4',sah='1',StatTempat='1', tglperiksa='$today1' where NoKantong like '$kantong_0%'");
        ...
        //echo "<meta http-equiv='refresh' content='0;url=roche/imltd_rpt_konfirm1?notrans=$notrans'>";
    echo "<meta http-equiv='refresh' content='0;url=pmiimltd.php?module=import_liasonxl_raw'>";
...
$Sq=mysql_query("SELECT `id`, `instrument_name`, `run_time`, `sample_id`, `parameter_name`, `parameter_no`,
                ...
                `on_insert`, `comment`, `confirm`, `confirm_time`, `user_confirm` FROM `liason2021`
                WHERE `confirm`='0' AND `id_transaksi`='$g_inst' AND DATE(`run_time`)='$g_tgl'
                AND `operator`='$g_user'
                Group by `sample_id`", $con);
$row = mysql_fetch_assoc($Sq);
?>
<a name="atas" id="atas"></a>
<table border=0 cellpadding="5" cellspacing="5" width="100%">
   <tr>
        <td align="left" style="background-color: #ffffff"><font size=5 color="blue"><b>KONFIRMASI HASIL PEMERIKSAAN LIASON</b></font></td>
...
<form name="manual_input" align="left" method="post" action="<?echo $PHPSELF?>">
    ...
    <tr class="field">
        ...
        <select name="reagen1" id="reagen1" onChange="show1(1)">
                <option value="-">-</option>
                <?
                $jreagen1=mysql_query("select * from reagen where Nama like '%Murex%Hbsag%' and aktif='1' and jumTest>0",$con);
        ...
        <select name="reagen2" id="reagen2" onChange="show2(2)">
                <option value="-">-</option>
                <?
                $jreagen1=mysql_query("select * from reagen where Nama like '%Murex%hcv%' and aktif='1' and jumTest>0",$con);
                while ($jreagen11=mysql_fetch_assoc($jreagen1)) { ?>
                    <option value="<?=$jreagen11[Nama]?>*<?=$jreagen11[noLot]?>*<?=$jreagen11[kode]?>*<?=$jreagen11[jumTest]?>*<?=$jreagen11[tglKad]?>">
                                   <?=$jreagen11[Nama]?>-<?=$jreagen11[noLot]?>-<?=$jreagen11[jumTest]?> T
                    </option><?
        ...
        <select name="reagen3" id="reagen3" onChange="show3(3)">
                <option value="-">-</option>
                <?
                $jreagen1=mysql_query("select * from reagen where Nama like '%Murex%HIV%' and aktif='1' and jumTest>0", $con);
                while ($jreagen11=mysql_fetch_assoc($jreagen1)) { ?>
                    <option value="<?=$jreagen11[Nama]?>*<?=$jreagen11[noLot]?>*<?=$jreagen11[kode]?>*<?=$jreagen11[jumTest]?>*<?=$jreagen11[tglKad]?>">
                                   <?=$jreagen11[Nama]?>-<?=$jreagen11[noLot]?>-<?=$jreagen11[jumTest]?> T
                    </option><?
        ...
        <select name="reagen4" id="reagen4" onChange="show4(4)">
                <option value="-">-</option>
                <?
                $jreagen1=mysql_query("select * from reagen where Nama like '%Murex%Syphilis%' and aktif='1' and jumTest>0",$con);
                while ($jreagen11=mysql_fetch_assoc($jreagen1)) { ?>
                    <option value="<?=$jreagen11[Nama]?>*<?=$jreagen11[noLot]?>*<?=$jreagen11[kode]?>*<?=$jreagen11[jumTest]?>*<?=$jreagen11[tglKad]?>">
                                    <?=$jreagen11[Nama]?>-<?=$jreagen11[noLot]?>-<?=$jreagen11[jumTest]?> T
                    </option><?
            ...
            <tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight';" onMouseOut="this.className='normal';">
                ...
                <td align='left'>
                    ...
                    <select name="aksi[]">
                        ...
                        <? if (($status_ktg=="1") and ($nr_all=="0") and ($all_param=="1")){
    ...
    <? mysql_select_db("$db_name",$con); ?>
    <tr class="field">
        <td colspan="2" align="left">Operator Liason</td>
        <td colspan="7" align="left">
            <select name="operator" > <?
                $user1="select * from user  where (level like '%laboratorium%') or (level like '%pimpinan%') or (level like '%konseling%') or (level like '%imltd%') order by nama_lengkap";
                $do1=mysql_query($user1,$con);
    ...
    <tr class="field">
        ...
        <td colspan="7" align="left">
            <select name="disahkan_oleh" > <?
                $user="select * from user  where (level like '%laboratorium%') or (level like '%imltd%') order by nama_lengkap";
                $do=mysql_query($user,$con);
    ...
    <a href="pmiimltd.php?module=import_liasonxl_raw"class="swn_button_blue">Kembali ke list data</a>
    <a href="pmiimltd.php?module=import_liasonxl"class="swn_button_blue">Kembali ke Awal</a>
    <?
    if ($no!==0){?>
