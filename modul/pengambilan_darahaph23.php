...
if (isset($_POST['simpan'])){
	...
	$kembali0 	= mktime(0,0,0,date("m"),date("d")+14,date("Y"));
    ...
    if ($caraambil=='1'){$prd = 'TC Apheresis';} else if ($caraambil=='4'){$prd = 'PRC Apheresis';} else {$prd = 'LP Apheresis';}
    ...
    if ($keberhasilan != "0") { //simpan gagal
      ...
      $stok1        = mysqli_fetch_array($kantong);
      $numkantong   = mysqli_num_rows($kantong);
      $kadaluwarsa  = date('Y-m-d H:i:s', $tc_apr);
                    ...
                    <div class="panel with-nav-tabs panel-primary" id="shadow1">
                        ...
                        <div class="panel-heading" >
                            <div class="row">
                                <div class="col-lg-12" align="center">
                                    <div class="panel-title"><h4><strong>PENYADAPAN DARAH PENDONOR APHERESIS</strong></h4></div>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row" >
                                ...
                                <div class="form-group">
                                        <label class="control-label col-lg-4">Metode Aftap</label>
                                        <div class="col-lg-8">
                                            <select class="form-control" name="caraambil" required>
                                                <option class="form-control" value="">-- Pilih Metode --</option>
                                                <option class="form-control" value="1">Tromboferesis</option>
                                                <option class="form-control" value="2">Leukaferesis</option>
                                                <option class="form-control" value="3">Plasmaferesis</option>
                                                <option class="form-control" value="4">Eritoferesis</option>
                                            </select>
                                        </div>
                                </div>
