...
?>
<font size="5" color=blue>DAFTAR REKAP PERMINTAAN DARAH TPK SUDAH  TERPENUHI</font><br>
<form method=post>
...
$allcount=mysql_query("select * from htranspermintaan where CAST(htranspermintaan.tgl_register as date) >='2021-01-01' and CAST(htranspermintaan.tgl_register as date)<='$today1' ");
    ...
    ON dtranspermintaan.NoForm = htranspermintaan.noform
                         where CAST(htranspermintaan.tgl_register as date) >='2021-01-01' and CAST(htranspermintaan.tgl_register as date)<='$today1'
