<!--
03-05-11 devit -> Cek sudah di tes berapa kali?
-->
	...
	//------------ END Generate no transaksi ---------------
		...
		//values ('$nkt','$njt1','$nht','$today')");
			...
			$tambah=mysql_query("insert into drapidtest (NoTrans,noKantong,Kontrol,jenisPeriksa,Hasil,nolot,tgl_tes,dicatatoleh,dicekOleh,DisahkanOleh,Metode) 
											values ('$notest','$nkt','$kontrol','$njt1','$nht','$reag0_ex[0]','$today','$namauser','','$_POST[sah]','Rapid')");
			...
			//	echo "rapid".$nrapid1."==".$nrapid3[hasil]."and".$nelisa3[hasil]."<br>";
				...
				if ($nrapid==0 and $nelisa==0) {
				    ...
				    $tambah2=mysql_query("UPDATE stokkantong
												SET Status='2',produk='WB',tglperiksa='$today'
												where NoKantong='$nkt'");
					$tambah3=mysql_query("UPDATE pendonor
												SET Cekal='0'
