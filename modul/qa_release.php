...
<form name="form_prolis" align="left" method="post" action="<?echo $PHPSELF?>">
    ...
    <div id="visual" class="tabcontent">
        ...
        <table cellpadding=3 cellspacing=3 width="100%" style="border: 0px; border-color: #ffffff;">
            <tr>
                <td valign="top">
                    ...
                    <?if ($var_volume_kantong=='0'){
                        ...
                        ?><label class="control control-checkbox">Volume produk sesuai spesifikas
			...
			<?php
			if ($jeniskomponen=="WB"){ ?>
				<tr><td style="background-color: mistyrose" colspan="2">Volume Antikoagulan</td><td><?=$antikoagulant." ml"?></td></tr>
			<?php }
			?>			
                        ...
                        <tr><td style="background-color: mistyrose">Berat</td><td><input name="berat" type="text" size="7" style="font-family:monospace;" value=<?=$berattimbang?>>gram</td></tr>
                        <tr><td style="background-color: mistyrose" colspan="2">Volume standar</td><td><?=$vol_min.' - '.$vol_max;?> ml</td></tr>
                        <tr><td style="background-color: mistyrose" colspan="2">Volume komponen darah </td><td><input type="text" name="vol_akhir" size="7" style="font-family:monospace;" value=<?=$volumekomponendarah?>> pembulatan :  <?=round($volumekomponendarah,0)?>
