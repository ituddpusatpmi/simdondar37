...
<body>
  ...
  <!--div class="row" align="center">
    <div class="col-lg-12">
      <h4><font color="black"><b>DATA ANTRIAN PERMINTAAN PERMINTAAN DARAH</font></h4><br><?php echo $Kodep;?>
    </div>
  </div-->
...
<?php
    if (isset($_POST['submit'])) {
        ...
        if ($new == "1"){
        ...
        } else if (($jmLK >= $jmAD) || ($telp2O =="") || ($telp20 =="-")){
            ...
            $respon = json_decode($response, true);
                ...
                //echo $up;
                $qUP = mysqli_query($dbi,$up);
                }
            
        ?>
        <META http-equiv="refresh" content="0; url=pmiaftap.php?module=trcnas&Kode=<?=$iddonor?>">
    <?php
