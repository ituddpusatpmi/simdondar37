<?php
    ...
    $instan0=mysqli_query($dbi,"select * from detailinstansi where aktif='1'");
    $instan01=mysqli_fetch_assoc($instan0);
    $td0=php_uname('n');
    $td0=strtoupper($td0);
    $td0=substr($td0,0,1);
    if ($td0=='M') {
        $ninstan = mysqli_num_rows($instan0);
...
<div class="card-header">
  <h4 class="text-center">CARI DATA PENDONOR NASIONAL</h4>
...
<div class="row" align="center">
    ...
    <!--row2--->
        ...
        <div class="form-group">
            ...
            <!--button name="lokal" type="submit" class="btn btn-success float-right"><i class="fa fa-search"></i>  Cari Data Server Lokal</button-->
        </div>
