...
if (isset($_POST[submit])) {
	...
	//$nkt1=substr($nkt,0,-1);
			...
			if ($tambah) { echo ("Data telah dihapus dari batabase !!! <meta HTTP-EQUIV=\"REFRESH\" CONTENT=\"1; URL=$PHP_SELF\">"); 
...
<? $data=mysql_query("select * from stokkantong where keterangan like '1' and noKantong like '%A' and Status='0' order by jenis ASC"); 
$jml=mysql_num_rows($data);
echo "<b> Jumlah Spuit Yang Belum Terpakai : $jml pcs</b>";
?>
