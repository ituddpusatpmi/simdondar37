...
if (isset($_POST['simpan'])) {
    ...
    if (mysqli_num_rows($chkic) == '0') {
        ...
        // echo $q_antrian;
        if ($iu_ic) {
            $msg .= '<br>Update Inform Concent';
        } else {
            $msg .= '<br>ERROR update Inform Concent';
        }
    }
 ...
 -->
                        ...
                        <div id="tab_ic" class="tab-pane fade in active">
                            ...
                            <div class="col-xs-6">
                                <div class="table-responsive" id="shadow1">
                                    <table class="table borderless table-striped table-condensed">
                                        ...
                                        <tr>
                                            <td colspan=3><b>Dalam waktu 1 minggu terakhir</b></td>
                                        <tr>
                                        <tr>
                                            <td>5</td>
                                        ...
                                        <tr>
                                            <td colspan=3><b>Dalam waktu 6 minggu terakhir</b></td>
                                        <tr>
                                        <tr>
                                            <td>6</td>
                                        ...
                                        <tr>
                                            <td colspan=3><b>Dalam waktu 8 minggu terakhir</b></td>
                                        <tr>
                                        <tr>
                                            <td>7</td>
                                        ...
                                        <tr>
                                            <td colspan=3><b>Dalam waktu 16 minggu terakhir</b></td>
                                        <tr>
                                        <tr>
                                            <td>10</td>
                                        ...
                                        <tr>
                                            <td colspan=3><b>Dalam waktu 6 bulan terakhir</b></td>
                                        <tr>
                                        <tr>
                                            <td>11</td>
                                        ...
                                        <tr>
                                            <td colspan=3><b>Dalam waktu 1 tahun terakhir</b></td>
                                        <tr>
                                        <tr>
                                            <td>12</td>
                            ...
                            <div class="col-xs-6">
                                ...
                                <tr>
                                    <td colspan=3><b>Dalam waktu 3 tahun terakhir</b></td>
                                <tr>
                                <tr>
                                    <td>27</td>
                                ...
                                <tr>
                                    <td colspan=3><b>Tahun 1980 hingga sekarang</b></td>
                                <tr>
                                <tr>
                                    <td>29</td>
                                ...
                                <tr>
                                    <td colspan=3><b>Tahun 1980 hingga 1996</b></td>
                                <tr>
                                <tr>
                                    <td>31</td>
                                ...
                                <tr>
                                    <td colspan=3><b>Apakah Anda Pernah :</b></td>
                                <tr>
                                <tr>
                                    <td>32</td>
