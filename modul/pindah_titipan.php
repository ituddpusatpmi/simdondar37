<body OnLoad="document.pindahtitipan.NoKantong.focus();">

<?php
require_once('config/db_connect.php');
session_start();
$namaudd=$_SESSION[namaudd];
$ptg=mysql_query("SELECT `ket` FROM kembalititipan");if(!$ptg){mysql_query("ALTER TABLE `kembalititipan` ADD `ket` INT( 2 ) NULL COMMENT '0=Batal ambil 1=incomp 2=kembali bdrs 3=salah buang' ");}
...
if ($_POST[NoKantong]) {
$hasil=mysql_query("select noKantong from stokkantong where noKantong='$_POST[NoKantong]' and Status= '3' ");
...
$kembali1=mysql_query("update kembalititipan set tgl_kembali='$today', user='$namauser',ket='0' where noKantong='$_POST[NoKantong]'");
if ($nhasil==1) {
$keluarkan=mysql_query("update stokkantong set Status='2',sah='1',stat2='0',tgl_keluar=NULL where noKantong='$_POST[NoKantong]'");
...
echo "HANYA DARAH TITIPAN YANG BISA DIPROSES DISINI";
...
?>
<form align="left" name='pindah_titipan' method="post" action="<?echo $PHPSELF?>">
