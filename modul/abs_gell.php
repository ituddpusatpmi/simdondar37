...
?>
	...
	<form name="kantong" onsubmit="return ok()" method="POST" action="">
		<table cellpadding=1 cellspacing="0"class="bayangan">
			...
			<tr style="background-color:mistyrose; font-size:12px; color:#000000;">
				<td class="input">Anti-IgG+C3d :<input type="text"  name="lot_gell" required placeholder="No Lot" style="width:100px;">
				    <input type="text"  name="ed_gell" size='9' required placeholder="yyyy-mm-dd" style="width:100px;"></td>
				<td class="input">Cell I :<input type="text"  name="lot_cell1" size='9' required placeholder="No Lot" style="width:100px;">
				    <input type="text"  name="ed_cell1" size='9' required placeholder="yyyy-mm-dd" style="width:100px;"></td>
				<td class="input">Cell II :<input type="text"  name="lot_cell2" size='9' required placeholder="No Lot" style="width:100px;">
				    <input type="text"  name="ed_cell2" size='9' required placeholder="yyyy-mm-dd" style="width:100px;"></td>
			</tr>
		...
		<div style="font-family:Arial;font-size:20px;">No Kantong : <input class="bayangan" style="height:35px;padding-left:10px;font-size:16px;font-weight:bold;"type="text"  name="nokantong" id="nokantong" style="width:4cm;" placeholder="Nomor Kantong" onkeydown="chang(event,this);" onchange="cari_kantong('tababs');"></div>
		<br>
		...
		<a href="?module=abs_mrekap" class="swn_button_blue">Rekap ABS</a>
</form>
