...
<!--form rekap-->
<?
$hasil=mysql_query("select dr.noKantong as nk,dr.tgl_tes as tgl,dr.jenisperiksa as jp,sk.tgl_Aftap as ta,sk.gol_darah as gd,sk.RhesusDrh as rh,sk.statKonfirmasi as kon from drapidtest as dr,stokkantong as sk where dr.hasil='0' and dr.tgl_tes>='$_POST[waktu]' and dr.tgl_tes<='$_POST[waktu1]' and sk.noKantong=dr.noKantong group by dr.nokantong order by tgl_Aftap ASC");
