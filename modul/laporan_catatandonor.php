...
if (isset($_POST[submit])) {
	...
	switch ($piagam) {
		case "1":
			$piagam1 = "Piagam DDS 10x";
			break;
		case "2":
			$piagam1 = "Piagam DDS 15x";
			break;
		case "3":
			$piagam1 = "Piagam DDS 25x";
			break;
		case "4":
			$piagam1 = "Piagam DDS 50x";
			break;
		case "5":
			$piagam1 = "Piagam DDS 75x";
			break;
		case "6":
			$piagam1 = "SatyaPiagam DDS 100x";
			break;
		case "7":
			$piagam1 = "Penerimaan Souvenir Donor";
			break;
		case "8":
			$piagam1 = "Pembenahan Data Donor";
			break;
	}
		...
		while ($data1 = mysql_fetch_assoc($data)) {
			...
			switch ($data1[catatan]) {
				...
				case "5":
					...
					break;
				case "6":
					$ket = "SatyaPiagam DDS 100x";
					break;
				case "7":
					$ket = "Penerimaan Souvenir Donor";
					break;
				case "8":
					$ket = "Pembenahan Data Donor";
					break;
			}
		?>
			<tr class="record">
