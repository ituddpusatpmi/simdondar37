...
if ($_POST[NoKantong]) {
$hasil=mysql_query("select noKantong from stokkantong where noKantong='$_POST[NoKantong]' and status='6' ");
...
$kembali1=mysql_query("update kembalititipan set tgl_kembali='$today', user='$namauser', ket='3' where noKantong='$_POST[NoKantong]'");
if ($nhasil==1) {
...
$keluarkan1=mysql_query("delete from ar_stokkantong where NoKantong='$_POST[NoKantong]'");
