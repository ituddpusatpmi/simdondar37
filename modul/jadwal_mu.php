...
<table width="750px">
  <tr>
    <td align=right>No. Dokumen : ____________________
    <br>No. Form : ________________________</td>
    <td align=center></td>
    </tr>
</table>
<table width="750px">
<tr>
<td align=center><h2><strong><u>JADWAL KEGIATAN MOBILE UNIT</u></h2></strong></td></tr></table>
</tr>
</table>
<font size="3">
<table width="750px">
...
<table border=1 cellpadding=5 cellspacing=1 style="border-collapse:collapse" width="750px">
	...
	<th colspan=3>KESANGGUPAN</th>
	<th rowspan=2>KETERANGAN</th>
	<!--th >Edit</th-->
	</tr>
	<tr >
	<th width="25px">YA</th>
	<th width="25px">TDK</th>
	<th width="100px">PENGGANTI</th>
	</tr>
	<?
...
<table width="750px">
<tr>
<td  width="187"></td><td width="160"></td><td width="187"></td><td width="207" align="center"><?=$utd[nama]?>
<br>Petugas Penjadwalan
<br>Kasie. P2D2S
<br>
<br>
<br>____________________________</td>
<!--br><?=$namalkp[nama_lengkap]?></td-->
</tr>
