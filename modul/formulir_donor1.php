...
$ckt=mysql_fetch_assoc(mysql_query("select Kode,Kode_lama,Nama,Alamat,kelurahan,kecamatan,wilayah,telp2,TglLhr,umur,TempatLhr,GolDarah,Rhesus,jk,pekerjaan,jumDonor,tglkembali,Status,p10,p25,p50,p75,p100 from pendonor where Kode='$_POST[Kode]' and cekal='0'"));
...
$tambah=mysql_query("insert into htransaksi 
			...
			JenisDonor,id_permintaan,Status,Nopol,apheresis,umur,kota,ketBatal) 
	value ('$_POST[notrans]','$ckt[Kode]','$ckt[Kode_lama]','-','0','$today1','$_POST[instansi]','$_POST[kendaraan]',
		'0','-','0','-','0','$ckt[umur]','$kota[id]','9')");
...
$pdf->SetXY(2+$X,$Y+157);
$pdf->SetFont('courier', '', 11);
$pdf->Cell(0, 13,'15. Bagi wanita, tiak sedang Haid/hamil/menyusui',0);
