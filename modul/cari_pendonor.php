...
<input type="button" value="Cari Donor Nasional" onClick="document.location.href='pmimobile.php?module=luarkota'">
...
?>
<!-- Antri Donor -->
<!--a href="pmi<?echo $_SESSION[leveluser] ?>.php?module=transaksi_donor&Kode=<? echo $datadonor['Kode'] ?>&apheresis=0" target="isiadmin" class="fisheyeItem"><img src="../images/bloodbag.png" width=25 height=15 /></a-->
<img src="../images/bloodbag.png" width=25 height=15 />
...
<!-- Cetak Kartu -->
    <a href="idcard_barcode.php?idpendonor=<? echo $datadonor['Kode'] ?>"><img src="../images/barcode.png" width=25 height=15 /></a>
<a href="/jqupc/index.php?ext=jpg&idpendonor=<? echo $datadonor['Kode'] ?>"><img src="../images/idcard.png" width=25 height=15></a>
...
<!--Gift donor p2d2s 250121 BadBoy-->
<? if ($_SESSION[leveluser]=='p2d2s'){?>
<a href="pmi<?echo $_SESSION[leveluser] ?>.php?module=logpendonor&Kode=<? echo $datadonor['Kode'] ?>&nama=<? echo $datadonor['Nama']?>"><img src="../images/piagam0.png" width=20 height=20></a>
<?}?>
