...
<tr><td>Kode Pendonor </td><td>:</td><td><input type=text name='kode' size='20' placeholder="ID KARTU DONOR" onchange='disabletext(this.value);'></td><td>Tempat Lahir</td><td>:</td><td><input type=text name='tempatlahir' size='20' placeholder="Tempat Lahir"></td></tr>
...
<tr><td>Wilayah</td><td>:</td><td><input type=text name='wilayah' size='20' placeholder="Wilayah"></td>
</tr>
<tr>
<td>
...
if ($_POST[rhesus]!='') $srcrhesus=$_POST[rhesus];
if ($_POST[telp]!='') $srctelp=$_POST[telp];
if ($_POST[apheresis]!='') $aph=$_POST[apheresis];
//----------------------------
	?>
<body id="dt_example" class="ex_highlight_row">
<form  method=post>
...
<tr><td>Kecamatan</td><td>:</td><td><input type=text name='kecamatan' size='20' placeholder="Kecamatan"></td><td>No Telp/Hp</td><td>:</td><td><input type=text name='telp' size='13' placeholder="Nomor Handphone"></td></tr>
<tr><td>Wilayah</td><td>:</td><td><input type=text name='wilayah' size='20' placeholder="Wilayah"></td><td>Apheresis</td><td>:</td><td><input type=text name='apheresis' size='2' placeholder="apheresis"></td></tr>
<tr>
<td>
