...
$kt=$_POST[ket][$i];
        ...
        $mobile=mysql_query("insert into dbrgmobil (NoTrans,kode,jum) values ('$nt','$kd','$jm')");
	$update=mysql_query("update hstok set StokTotal='$st' where Kode='$kd'"); 
	if ($tambah) echo ("Data telah ditambahkan !!
	...
	if ($lv[level]=='mobile') $level="M";
        $tambah1=mysql_query("insert into hpermintaan (NoTrans,tgl,nama,level,
jenis,status) values ('$nt','$today','$namauser','$level','$stok[status]','0')");
}
}
$kodet = "P";
$kodet4 = $today=date("Y");
...
<table>
<tr><td valign="top">
<h1 class="table">Form Permintaan Barang Mobile</h1>
...
function dbar(browser){
                ...
                $.ajax({
                        ...
                        success: function(json) {
                                ...
                                barang2 = json.barang.nama;
                        }
                });
		document.minta.stoktotal.value=barang1;
		document.minta.namabarang.value=barang2;
        }
	</script>
	<script>
	function hitung(){
	...
	<tr>
	<td>No Polisi</td>
	<td class="input"><input name="nopol" type="text" size="20"></td>
        </tr>
	<tr>
	<td>Keterangan</td>
	...
	<td class="input"><input name="kode" id="kode" type="text" size="15"><a href="modul/daftar_barang.php?&width=400&height=350" class="thickbox"><img src="images/button_search.png" border="0" /></a></td>
        ...
        <tr>
	<td>Nama Barang</td>
	<td class="input"><input name="namabarang" type="text" size="20"></td>
	</tr>
        <tr>
	<td>Stok Barang</td>
	...
	<tr>
	<td>Jumlah Minta</td>
	<td class="input"><input onChange="hitung()" name="juminta" type="text" size="5"></td>
        </tr>
</table>
</td><td width="30"></td>
<td valign=top>
