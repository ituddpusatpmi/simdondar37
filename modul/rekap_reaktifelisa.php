...
$hasil=mysql_query("select noKantong as nk from hasilelisa where hasil='1' and substring(tglPeriksa,1,7) like '$today'");
...
<tr> <td colspan=2>Daftar Kantong Reaktif : <?=$bln22?> - <?=$perthn?></td></tr>
			<tr class="record">
...
<?
			...
			<tr class="record">
				...
				<td>
					<?=$baris[nk]?>
  <a href="modul/detail_reaktif.php?nokan=<?=$baris[nk]?>&width=430&height=250" class="thickbox"><img src="images/button_search.png" border="0" /></a>
</td>
<td>
