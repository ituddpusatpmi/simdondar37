...
$query = "SELECT * FROM kegiatandiklat where cast(TglPenjadwalan as date)>='$today'";
...
while ($row = @mysql_fetch_assoc($result)){
	...
	$utd=mysql_fetch_assoc(mysql_query("select nama from detaildiklat where KodeDetail='$row[kodeinstansi]'"));
