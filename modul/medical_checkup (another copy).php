...
if ($_POST['periksa']=="1" ) { if ($_POST[berat_badan]!="" and $_POST[tensi_sistol]!="" and $_POST[tensi_diastol]!=""){
	...
	$tambah_sql="UPDATE htransaksi
					SET namadokter='$id_dokter',petugasHB='$id_hb',petugasTensi='$id_tensi',beratbadan='$berat_badan',
						...
						hct='$HCT',status_test='1',Status='1',mu='$mu',gol_darah='$gol_darah',rhesus='$rhesus'
...
?>
	...
	<tr>
		...
		<td class="input">Tensi
			<input name="tensi_sistol" type="text"  size="3" value="120" onChange="sistol(this.value)">/
			<input name="tensi_diastol" type="text" size="3" value="70" onChange="diastol(this.value)">
...
<tr>
		<td>Berat</td>
		<td class="input"><input name="berat_badan" type="text" size="3"  onChange="berat(this.value)">kg</td>
	</tr>
        <tr>
		<td>Check</td>
		<td class="input">Tensi
			<input name="tensi_sistol" type="text"  size="3"  onChange="sistol(this.value)">/
			<input name="tensi_diastol" type="text" size="3"  onChange="diastol(this.value)">
			<br>Suhu &nbsp;<input name="temperatur" type="text"  size="3">
			<br>Nadi &nbsp;<input name="nadi" type="text"  size="3">
		<td>
	</tr>
	<tr>
		<td>CuSO<sub>4</sub></td>
