        ...
        if ($rg!='') {
            ...
            for($i=0;$i<$_POST[jum_kantong];$i++){
                ...
                if ($co>0) $ratio=$od/$co;
                    if ($od!='') {
                        if ($metode=='elisa') {
                                         $cek_transaksi=mysql_query("SELECT umur, donorbaru, JenisDonor FROM htransaksi WHERE NoKantong='$nkt'");
                            ...
                            $tambah_sql="insert into hasilelisa (
                                    ...
                                    values ('$nkt','$ratio','$co','$hs','$notest','$njt1','$today1',
                                        '$namauser','$_POST[sah1]','$_POST[sah]','$nolot','elisa','0','$umur', '$jenisdonor', '$donorbaru')";
                            $tambah=mysql_query($tambah_sql);
                            //echo "<br> $tambah_sql <br>";

                        
                        } elseif (($metode=='clia') || ($metode=='chlia')) {
                                         $cek_transaksi=mysql_query("SELECT umur, donorbaru, JenisDonor FROM htransaksi WHERE NoKantong='$nkt'");
                                         $q_trx      =mysql_fetch_assoc($cek_transaksi);
                                         $umur       =$q_trx['umur'];
                                         $jenisdonor =$q_trx['JenisDonor'];
                            ...
                            $tambah_sql="insert into hasilelisa (
                                        ...
                                        dicatatOleh,dicekOleh,DisahkanOleh,noLot,Metode,ulang,umur, jns_donor, baru_ulang)
                                    values ('$nkt','$ratio','$co','$hs','$notest','$njt1','$today1',
                                        '$namauser','$_POST[sah1]','$_POST[sah]','$nolot','chlia','0','$umur', '$jenisdonor', '$donorbaru')";
                            $tambah=mysql_query($tambah_sql);
                            //echo "<br> $tambah_sql <br>";
        ...
        <tr>
            <td >
                <select name="reagen0" id="reagen0" onChange="show0(0)" STYLE="width: 190px">
                    ...
                    <?
                    $jreagen1=mysql_query("select * from reagen where Nama like '%HBsAg%' and aktif='1' and jumTest>0 and metode like '%li%'");
        ...
        <tr>
            <td>
                <select name="reagen1" id="reagen1" onChange="show0(1)" STYLE="width: 190px">
                    ...
                    $jreagen2=mysql_query("select * from reagen where Nama like '%Hcv%' and aktif='1' and jumTest>0 and metode like '%li%' ");
        ...
        <tr>
            <td>
                <select name="reagen2" id="reagen2" onChange="show0(2)" STYLE="width: 190px">
                    ...
                    $jreagen3=mysql_query("select * from reagen where Nama like '%Hiv%' and aktif='1' and jumTest>0 and metode like '%li%'");
        ...
        <tr>
            <td>
                <select name="reagen3" id="reagen3" onChange="show0(3)" STYLE="width: 190px">
                    ...
                    $jreagen4=mysql_query("select * from reagen where Nama like '%Syp%' and aktif='1' and jumTest>0 and metode like '%li%'");
