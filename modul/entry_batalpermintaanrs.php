...
if (isset($_POST[submit])) {
    ...
    $petugas=$_POST[user];
        ...
        $dpasien=mysql_query("delete from `daftarpasien` WHERE `noform` = '$notrans'");
    ...
    //=====================================================================================================
            ...
            <META http-equiv="refresh" content="1; url=pmikasir2.php?module=rsonline">
            <?} else {?>
    ...
    $query = "SELECT\n".
    "pmi.htranspermintaanRS.noformRS,\n".
    "pmi.htranspermintaanRS.tglminta,\n".
    "pmi.pasien.nama,\n".
    "pmi.pasien.umur,\n".
    "pmi.rmhsakit.NamaRs\n".
    "FROM\n".
    "pmi.htranspermintaanRS\n".
    "JOIN pmi.pasien\n".
    "ON pmi.htranspermintaanRS.no_rm = pmi.pasien.no_rm \n".
    "JOIN pmi.rmhsakit\n".
    "ON pmi.htranspermintaanRS.rs = pmi.rmhsakit.Kode\n".
    "WHERE\n".
    "pmi.htranspermintaanRS.noformRS='$notrans'";
    //echo $query;
    $cari = mysql_fetch_assoc(mysql_query($query));
?>
...
<td>
    ...
    <tr>     <td>Nomor Transaksi</td>
        <td class="input"><?=$cari[noformRS]?>
        <input type="hidden" name="kode" value="<?=$cari[noformRS]?>"><?=$cari[noform]?></td>
            </td>
    </tr>
