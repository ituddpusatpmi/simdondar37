				...
				if ($co>0) $ratio=$od/$co;
					if ($od!='') {
						if ($metode=='elisa') {
							...
							//=======Audit Trial====================================================================================
							$log_mdl ='IMLTD';
							$log_aksi='IMLTD Elisa: '.$nkt.' hasil: '.$hs.' Param: '.$njt1.' No Trans.:'.$notest;
...
/*
							...
							//=======Audit Trial====================================================================================
							$log_mdl ='IMLTD';
							$log_aksi='IMLTD Rapid: '.$nkt.' hasil: '.$hs.' Param: '.$njt1.' No Trans.:'.$notest;
							include('user_log.php');
							//======================================================================================================
						}
					}
		    ...
		    if (($nrapid1+$nelisa1)=='4') {
				...
				if ($nrapid==0 and $nelisa==0) {
					...
					if ($nelisagz==0) {
						...
						if ($jum_komponen>0) { 
							$nokantg=substr($nkt,0,-1); $tambah3s=mysql_query("UPDATE stokkantong set Status='2',hasil='2',sah='1',StatTempat='1',tglpengolahan=tgl_Aftap, tglperiksa='$today1' where NoKantong like '$nokantg%'"); 
							//=======Audit Trial====================================================================================
							$log_mdl ='IMLTD';
							$log_aksi='Status kantong: '.$nokantg.'(A..) - sehat';
							include('user_log.php');
							//======================================================================================================
						} else { 
							$tambah3s=mysql_query("UPDATE stokkantong set Status='2',hasil='2',sah='1',StatTempat='1', tglpengolahan=tgl_Aftap,tglperiksa='$today1' where NoKantong='$nkt'"); 
							//=======Audit Trial====================================================================================
							$log_mdl ='IMLTD';
							$log_aksi='Status kantong: '.$nkt.' - sehat';
							include('user_log.php');
							//======================================================================================================
						}
...
*/
					...
					//=======Audit Trial====================================================================================
					$log_mdl ='IMLTD';
					$log_aksi='Cekal Donor: '.$idpendonor;
					include('user_log.php');
					//======================================================================================================
					$ccekal=mysql_query("insert into cekal ('$idpendonor','$today','$_SESSION[namauser]','1')");
					$nrusak++;
					if ($jum_komponen>0) { 
						$tambah3s=mysql_query("UPDATE stokkantong set Status='6',hasil='4',sah='1',StatTempat='1',tglpengolahan=tgl_Aftap, tglperiksa='$today1' where NoKantong like '$no_kantong0%'");
						//=======Audit Trial====================================================================================
						$log_mdl ='IMLTD';
						$log_aksi='Musnahkan kantong: '.$no_kantong0.'(A..) - Reaktif';
						include('user_log.php');
						//======================================================================================================
						...
						$tambah3s=mysql_query("UPDATE stokkantong set Status='6',hasil='4',sah='1',StatTempat='1',tglpengolahan=tgl_Aftap,tglperiksa='$today1' where NoKantong='$nkt'"); 
						//datakantong masuk pembuangan
						//=======Audit Trial====================================================================================
						$log_mdl ='IMLTD';
						$log_aksi='Musnahkan kantong: '.$nkt.' - Reaktif';
						include('user_log.php');
						//======================================================================================================
						$keluarkan=mysql_query("insert into ar_stokkantong (
								noKantong,jenis,Status,tglTerima,volume,merk,kantongAsal,
