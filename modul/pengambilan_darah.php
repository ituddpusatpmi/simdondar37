...
<script type="text/javascript" src="js/aftap.js"></script>
    ...
    window.onload = function(){ document.getElementById('volume_darah').focus(); }
     </script>
    <style type="text/css">
        /*demo styles*/
...
if ($_POST['submit']!=""){
    ...
    $GolDarah    = $_POST['goldarah'];         $ambil3=$_POST['ambil'];
    $Rhesus        = $_POST['Rhesus'];        $selesai3=$_POST['selesai'];
    $petugas    = $_POST['petugas'];        $tglp1= $today1.' '.$ambil;
    ...
    //if ($lama_pengambilan=="") { echo "<script>alert('Lama Pengambilan tidak boleh kosong')</script>";}
    if ($stok1['Status']=="0"){
        ...
        $tambah=mysql_query("UPDATE htransaksi
                    SET diambil='$volume_darah',reaksi='$reaksi',
                        ...
                        caraambil='$caraambil',status_test='2',Status='2',mu='$mu',gol_darah='$pendonor1[GolDarah]',jam_ambil='$ambil', jam_selesai='$selesai',rhesus='$pendonor1[Rhesus]',jk='$pendonor1[Jk]',pekerjaan='$pendonor1[Pekerjaan]',umur='$pendonor1[umur]',donorke='$pendonor1[jumDonor]+1'
                    WHERE (Status='1' and NoTrans='$notrans')");
            if($caraambil!=5){
                $kembali1=mysql_query("UPDATE pendonor
                        SET tglkembali='$kembali',jumDonor='$pendonor1[jumDonor]'+1,mu='$mu',up=b'1',up_data='2',tglkembali_apheresis='$kembali'
...
//
                ...
                $tambah2=mysql_query("UPDATE stokkantong
                    SET Status='1',tgl_Aftap='$tglp1',gol_darah='$GolDarah',RhesusDrh='$Rhesus',produk='WB',sah='0',
                    kodePendonor='$kodependonor',statKonfirmasi='0',kadaluwarsa=(tgl_aftap + interval 35 day),mu='$mu',
                    lama_pengambilan='$lama_pengambilan' WHERE noKantong='$id_kantong'");
                ...
                $tambah5=mysql_query("UPDATE stokkantong set lama_pengambilan='$lama_pengambilan' WHERE noKantong like '$ono_kantong0%'");
                switch ($gol_darah){
                    case 'A':
    ...
    //LOG 2024-12-27
       ...
       $log_aksi='Pengambilan darah: '.$notrans.' Pendonor: '.$kodependonor.' Kantong: '.$id_kantong.' status: '.$keberhasilan;
       $log = mysql_query("INSERT INTO `user_log` (`time_aksi`,`komputer`, `user`, `modul`, `aksi_user`,`tempat`, `keterangan`) VALUES
          ('$tglp1','$_SESSION[client_ip]', '$_SESSION[namauser]', '$log_mdl', '$log_aksi','$tempat', '')");
       //=====================================================================================================
            ...
            <td>
                <table class="form" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td class="input">
                            <input size="5" name="volume_darah" id="volume_darah" required>CC
...
<!--                        <td class="input">-->
<!--                            <input size="5" name="jam_ambil" placeholder="09:00"> Menit --->
<!--                            Selesai Pengambilan <input size="5" name="jam_selesai" placeholder="10:00" onchange="hitungjam()"> Menit-->
<!--                            </input>-->
<!--                        </td>-->
<!--                    </tr>-->
<!--                    <tr>-->
<!--                        <td>Lama Pengambilan</td>-->
<!--                        <td class="input">-->
<!--                            <input size="2" name="lama_pengambilan">Menit-->
<!--                            </input>-->
<!--                        </td>-->
<!--                    </tr>-->
                    <tr>
