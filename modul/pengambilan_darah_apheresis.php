...
if (isset($_POST['simpan'])){
    ...
    if ($keberhasilan != "0") { //simpan gagal
      ...
      if ($numkantong > 0) { //simpan berhasil
        ...
        $pdquery    = mysqli_query($dbi, $kembali1);
        $ono_kantong0 = substr($id_kantong, 0, -1);
        $tambah2    = "UPDATE stokkantong SET Status='2',tgl_Aftap='$tglp1',noSelang='$no_selang',gol_darah='$GolDarah',RhesusDrh='$Rhesus',produk='WB',sah='0',kodePendonor='$kodependonor',statKonfirmasi='0',kadaluwarsa=(tgl_aftap + interval 35 day),mu='$mu',lama_pengambilan='$lama_pengambilan' WHERE noKantong='$id_kantong'";
        //echo $tambah2."<br>";
        $skquery    = mysqli_query($dbi, $tambah2);
        ...
        $tambah5    = "UPDATE stokkantong set lama_pengambilan='$lama_pengambilan', `Status`='2', `tgl_Aftap`='$tglp1',gol_darah='$GolDarah',RhesusDrh='$Rhesus'  WHERE noKantong like '$ono_kantong0%'";
        $sk2query    = mysqli_query($dbi, $tambah5);
