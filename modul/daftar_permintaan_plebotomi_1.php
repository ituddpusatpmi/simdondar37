...
<input type=submit value=Submit>||<input type="button" value="Rekap Pasien Plebotomi" onClick="document.location.href='pmikasir.php?module=laporan_pasien_plebotomi';"></h1><br>
</form>
<?
$td0=php_uname('n');
$td0=strtoupper($td0);
...
while ($data = mysql_fetch_assoc($hasil))
{
    ...
    switch ($_SESSION[leveluser]){
        ...
        case "admin":
            ...
            break;
	case "kasir":
            echo "<a href=pmikasir.php?module=pengambilan_plebotomi&notransaksi=".$data['notransaksi'].">".$hasil1['nama']."</a>";
            break;
        default:
            echo "Anda tidak memiliki hak akses";
    }
