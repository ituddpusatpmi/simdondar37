...
$masterkantong0="select * from master_kantong where merk='$merk' and jenis='$datakantong[jenis]'";
...
<table cellpadding="3" cellspacing="3" width="100%" border="0px">
    <tr>
        ...
        <table width="100%" cellpadding="3" cellspacing="5">
            ...
            <tr><td style="background-color: mistyrose">Tgl Pengambilan</td>    <td><?=$tglaftap?></td><input type="hidden" name="tgl_aftap" value="<?=$tglaftap?>"> </tr>
	    <tr><td style="background-color: mistyrose">Lama Pengambilan</td>   <td><?=$lamaaftap?> Menit</td></tr>				
            ...
            <tr><td style="background-color: mistyrose">Golongan Darah</td>     <td><?=$golongandarah_donasi?>(<?=$rhesus_donasi?>)</td></tr>
            <tr><td style="background-color: mistyrose">HB & BB</td>            <td><?='Hb: '.$hb.' g/dl ('.$hb1.'),  BB: '.$bb.' kg'?></td></tr>
