...
$umurpas=mysql_query("SELECT `umur` FROM `pasien`");if (!$umurpas){mysql_query("ALTER table `pasien` ADD `umur` int( 3 ) NULL DEFAULT '0'");
...
$nonota=mysql_query("SELECT `nonota` FROM `pembayaran` ");if (!$nonota){mysql_query("ALTER table `pembayaran` 
