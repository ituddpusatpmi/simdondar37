		    ...
		    if (($nrapid1+$nelisa1)=='4') {
				...
				if ($nrapid==0 and $nelisa==0) {
					...
					// end ucapan
						...
						if ($jum_komponen>0) { $tambah3s=mysql_query("UPDATE stokkantong set Status='2',hasil='2',sah='1',StatTempat='1',tglpengolahan=tgl_Aftap, tglperiksa='$today' where NoKantong like '$no_kantong0%'"); }
							else { $tambah3s=mysql_query("UPDATE stokkantong set Status='2',hasil='2',sah='1',StatTempat='1', tglpengolahan=tgl_Aftap,tglperiksa='$today' where NoKantong='$nkt'"); }
...
*/
					...
					$ccekal=mysql_query("insert into cekal ('$idpendonor','$today','$_SESSION[namauser]','1')");
								$nrusak++;
						if ($jum_komponen>0) { $tambah3s=mysql_query("UPDATE stokkantong set Status='4',hasil='4',sah='1',StatTempat='1',tglpengolahan=tgl_Aftap, tglperiksa='$today' where NoKantong like '$no_kantong0%'");}
							else { $tambah3s=mysql_query("UPDATE stokkantong set Status='4',hasil='4',sah='1',StatTempat='1',tglpengolahan=tgl_Aftap,tglperiksa='$today' where NoKantong like '$no_kantong0%'"); }
    /*
				$single=mysql_query("UPDATE stokkantong SET produk='WB'
											where jenis='1'");
/*
