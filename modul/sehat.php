...
header("Content-Disposition: attachment; filename=darah_sehat.xls");
...
FROM stokkantong as s where s.Status='2' order by gol_darah,produk,noKantong");
if (mysql_num_rows($t)!=0) $t=mysql_query("select * from stokkantong where Status='2' and statKonfirmasi='1' and sah='1' and kadaluwarsa > current_date order by gol_darah,produk,noKantong");
