...
?>
<h1>REKAP PINDAHAN KANTONG KE AFTAP</h1>
...
<!--        <option value="BS">Biasa</option>-->
        ...
        <option value="TB">TOP & BOTTOM (Biasa)</option>
        <option value="TB">TOP & BOTTOM (Filter)</option>
...
<th colspan=2><b>Rekap Jumlah Pindahan Kantong kebagian Aftap</b></th>
<tr class="field">
...
<?
$data=mysql_query("select * from stokkantong where cast(tglmutasi as date)>='$today' and cast(tglmutasi as date)<='$today1' and noKantong like '%A' and noKantong like '%$nokan%' and jenis like '%$jenis%' and merk like '%$merk%' "); ?>
...
<br>
<form name=xls method=post action=modul/rekap_pindahan_kantong_xls.php>
