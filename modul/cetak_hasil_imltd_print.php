...
<?php
  ...
  if ($r_syp[Hasil]=='1') $syp2='Non Reaktif';
    if ($e_hbsag[Hasil]=='') $hbsag1='-';
    if ($e_hcv[Hasil]=='') $hcv1='-';
    if ($e_hiv[Hasil]=='') $hiv1='-';
    if ($e_syp[Hasil]=='') $syp1='-';
    if ($r_hbsag[Hasil]=='') $hbsag2='-';
    if ($r_hcv[Hasil]=='') $hcv2='-';
    if ($r_hiv[Hasil]=='') $hiv2='-';
    if ($r_syp[Hasil]=='') $syp2='-';
?>
...
<form name="transaksi"  method="post" action="<?=$PHPSELF?>">
  <table class="record" border="0" cellspacing="1" cellpadding="2" width=750 style="border-collapse:collapse">
	...
	<?if ($hiv2==' '){?>
	    <?=$e_hiv[tglPeriksa]?><?;}else{?><?=$e_hbsag[tglPeriksa]?><?;}
	  ?></td>
    </tr>
    <tr>
  ...
  <table class="record" border="1" cellspacing="0" cellpadding="5" width=750 style="border-collapse:collapse">
	...
	<td align=center><b>Keterangan</td>
      ...
      <tr>
	<td align=center rowspan=2>1.</td><td rowspan=2>HBsAg</td><td>- Clia</td><td align=right><?=$e_hbsag[OD]?></td><td align=center><?=$hbsag1?></td>
	<td></td>
      </tr>
      <tr>
	<td>- Rapid</td><td align=right><?=$r_hbsag[OD]?></td><td align=center><?=$hbsag2?></td><td></td>
      ...
      <tr>
	<td align=center rowspan=2>2.</td><td rowspan=2>Anti - HCV</td><td>- Clia</td><td align=right><?=$e_hcv[OD]?></td><td align=center><?=$hcv1?></td>
	<td></td>
      </tr>
      <tr>
	...
	<td></td>
      ...
      <tr>
	<td align=center rowspan=2>3.</td><td rowspan=2>Anti - HIV</td><td>- Clia</td><td align=right><?=$e_hiv[OD]?></td><td align=center><?=$hiv1?></td>
	<td></td>
      </tr>
      <tr>
	<td>- Rapid</td><td align=right><?=$r_hiv[OD]?></td><td align=center><?=$hiv2?></td><td></td>
      ...
      <tr>
	<td align=center rowspan=2>4.</td><td rowspan=2>Syphilis/TPHA</td><td>- Clia</td><td align=right><?=$e_syp[OD]?></td><td align=center><?=$syp1?></td>
	<td></td>
      </tr>
      <tr>
