...
<br><br>
<a href="rekap_musnah_pendukung.php"><button class="button1">Daftar Pemusnahan Dokumen</button></a>
<a href="input_pendukung.php"><button class="button1">Tambah Dokumen</button></a>
<br><br>
  ...
  <tbody id="myTable">
	...
	?>
	    ...
	    <td><div align="center"><?php echo $pengerjaan3; ?></div></td> 
            <td><a href="keluar_pendukung.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/clip.png" width="30" height="30"></img>
	    </a></td>
            <td><a href="detail_pendukung.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/revisi.png" width="30" height="30"></img></a></td>
	    <td><a href="musnah_pendukung.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/musnah.png" width="30" height="30"></img></a></td>
        </tr>
  <?php
		}
		?>
