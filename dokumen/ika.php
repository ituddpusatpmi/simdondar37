...
<br><br>
<a href="rekap_musnah_ika.php"><button class="button1">Daftar Pemusnahan Dokumen</button></a>
<br><br>
<p align="center"><b> Dokumen Instruksi Kerja Alat (L3)</b></p>
<table>
  <thead>
    <tr>
      	<th rowspan="2">No</th>
  ...
  <tbody id="myTable">
    <?php
	$donor = "select * from ika where aktif='0' order by kontrol2";
	...
	//akhir penanda dokumen
	    ...
	    <td><div align="center"><?php echo $pengerjaan3; ?></div></td> 
            <td><a href="keluar_ika.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/clip.png" width="30" height="30"></img>
	    </a></td>
            <td><a href="detail_ika.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/revisi.png" width="30" height="30"></img></a></td>
	    <td><a href="musnah_ika.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/musnah.png" width="30" height="30"></img></a></td>
        </tr>
  <?php
		}
		?>
