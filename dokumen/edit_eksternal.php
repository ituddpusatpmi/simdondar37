...
'$pengesah_riwayat','$pengesah_riwayat2','$nama1_riwayat','$ImageName')";
	...
	$sql = "update eksternal set bidang='$bidang',nama1='$nama1',nama2='$nama2',tingkat='$tingkat',kontrol='$kontrol1',kontrol2='$kontrol2',kontrol3='$kontrol3',periode='$periode',no_versi='$no_versi',tgl_setuju='$tgl_setuju',tgl_pelaksanaan='$tgl_pelaksanaan',tgl_peninjauan='$tgl_peninjauan',pembuat='$pembuat',pemeriksa='$pemeriksa',
...
if($result)
{
echo "update eksternal berhasil ...<br/> ";
}
else
{
echo "Gagal ... ";
...
if($result2)
{
echo "input riwayat perubahan eksternal berhasil ...<br/> ";
}
else
{
echo "Gagal ... ";
...
if($result3)
{
echo "penyesuaian riwayat perubahan eksternal berhasil ...<br/> ";
