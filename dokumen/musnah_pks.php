...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>FORM PEMUSNAHAN DOKUMEN SPO<br /><?php echo $data['nama1']; ?></u></font></p>
<?php
	$sql="select pks.terkait as nama, pks.kontrol as kontrol, pks.kontrol2 as kontrol2, pks.kontrol3 as kontrol3  from pks,pks where pks.nama1=pks.terkait and pks.nomor='$detail'";
	$proses=mysql_query($sql);
	$data=mysql_fetch_array($proses);
?>
...
<?php
	...
	$data=mysql_fetch_array($proses);
?>
  <form method="post" action="musnah_data_pks.php" enctype="multipart/form-data">
