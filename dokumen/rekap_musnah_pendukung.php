...
<br><br>
<a href="pendukung.php"><button class="button1">Kembali Ke Menu Utama</button></a>
<br><br>
<p align="center"><b> Daftar Dokumen Pendukung Yang Telah Dimusnahkan</b></p>
<table>
  <thead>
    <tr>
      	<th rowspan="2">No</th>
    	...
    	<th rowspan="2" style="width:10px">Periode Review (bln)</th>
	...
	<th rowspan="2">Tanggal Pemusnahan</th>
	<th rowspan="2">Keterangan Pemusnahan</th>
  ...
  <tbody id="myTable">
    <?php
	$donor = "select * from pendukung where aktif='1' order by kontrol2";
	...
	?>
	    ...
	    <td><div align="center"><?php echo format_indo($data['tgl_pemusnahan']); ?></div></td>
