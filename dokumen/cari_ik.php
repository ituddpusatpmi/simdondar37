...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>INSTRUKSI KERJA METODE</u></font></p>
<table align="center" bgcolor="#FFFFFF">
<tr>
	<td><a href="input_ik.php"><input type="button" value="Tambah IKM" /></a></td>
    <form method="post" action="cari_ik.php">
...
<tr>
	...
	<table align="center" border="1" cellpadding="1" cellspacing="1">
        ...
        <?php
	$donor = "select * from ik where bidang like '%$cari%' or nama1 like '%$cari%' or nama2 like '%$cari%' or tingkat like '%$cari%' or kontrol like '%$cari%' or kontrol2 like '%$cari%' or kontrol3 like '%$cari%' or tgl_setuju like '%$cari%' or tgl_pelaksanaan like '%$cari%' or tgl_peninjauan like '%$cari%' order by kontrol2";
	...
	$nourut++;
        ...
        <tr>
            ...
            <td><a href="detail_ik.php?detail=<?php echo $data['nomor']; ?>"><img src="images/ubah.png"></img></a>&nbsp;&nbsp;<a href="hapus_ik.php?hapus=<?php echo $data['nomor']; ?>"><img src="images/hapus.png"></img></a></td>
        </tr>
        <?php
		}
		?>
