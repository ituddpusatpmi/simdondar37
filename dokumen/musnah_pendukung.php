...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>FORM PEMUSNAHAN DOKUMEN PENDUKUNG<br /><?php echo $data['nama1']; ?></u></font></p>
<?php
...
<?php
	...
	$data=mysql_fetch_array($proses);
?>
  <form method="post" action="musnah_data_pendukung.php" enctype="multipart/form-data">
  ...
  <tr>
	...
	<tr>
	 ...
	 <tr>
          ...
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
            <input type="text" name="ket1" size="50" required="" />
          </strong></div></td>
          </tr>

	
        <tr>
          <td><div align="right"><strong>Tanggal Pemusnahan</strong></div></td>
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
            <input type="text" name="tgl_musnah1" required="" placeholder="Tahun-Bulan-Tanggal"  />
          </strong></div></td>
          </tr>
        <tr>
          <td><div align="right"><strong>Petugas Yang Memusnahkan</strong></div></td>
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
