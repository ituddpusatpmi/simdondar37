...
$riwayat="insert into riwayat		(bidang,nama1,nama2,tingkat,kontrol,periode,no_versi,tgl_setuju,tgl_pelaksanaan,tgl_peninjauan,pembuat,pemeriksa,pengesah,pengesah2,terkait,fileku) values('$bidang_riwayat','$nama1_riwayat','$nama2_riwayat','$tingkat_riwayat','$kontrol_riwayat','$periode_riwayat','$versi_riwayat','$setuju_riwayat','$pelaksanaan_riwayat','$peninjauan_riwayat','$pembuat_riwayat','$pemeriksa_riwayat',
...
$riwayat2="update riwayat set terkait='$nama1' where terkait='$nama_ubah'";
		...
		$sql = "update kebijakan set bidang='$bidang',nama1='$nama1',nama2='$nama2',tingkat='$tingkat',kontrol='$kontrol',periode='$periode',no_versi='$no_versi',tgl_setuju='$tgl_setuju',tgl_pelaksanaan='$tgl_pelaksanaan',tgl_peninjauan='$tgl_peninjauan',pembuat='$pembuat',pemeriksa='$pemeriksa',
...
echo "Dokumen Kebijakan berhasil di edit";
}
else{
echo "ERROR";
}
...
<?php
  if(isset($_POST["upload"]))
  {
      ...
      if (!empty($fileupload)){
        ...
        echo "<script>alert('Berhasil diupload'); location='kebijakan.php'</script>";
      }
  }
?>
