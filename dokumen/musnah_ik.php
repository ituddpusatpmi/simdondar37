...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>FORM PEMUSNAHAN DOKUMEN IK<br /><?php echo $data['nama1']; ?></u></font></p>
<?php
...
<?php
	...
	$data=mysql_fetch_array($proses);
?>
  <form method="post" action="musnah_data_ik.php" enctype="multipart/form-data">
