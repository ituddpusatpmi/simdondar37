  ...
  <tbody id="myTable">
	...
	?>
	    ...
	    <td><div align="center"><?php echo $pengerjaan3; ?></div></td>  
            <td><a href="keluar_formulir.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/clip.png" width="30" height="30"></img>
	    </a></td>
            <td><a href="detail_formulir.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/revisi.png" width="30" height="30"></img></a></td>
	    <td><a href="musnah_formulir.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/musnah.png" width="30" height="30"></img></a></td>
        </tr>
  <?php
		}
		?>
