...
<br><br>
<a href="kebijakan.php"><button class="button1">Kembali Ke Menu Utama</button></a>
<br><br>
<p align="center"><b> Daftar Dokumen Kebijakan Yang Telah Dimusnahkan</b></p>
<table>
  <thead>
    <tr>
      	<th rowspan="2">No</th>
  ...
  <tbody id="myTable">
    <?php
	$donor = "select * from kebijakan where aktif='1' order by kontrol";
	...
	?>
        <tr>
            ...
            <td><div align="center"><?php echo $data['kontrol']; ?></div></td>
