...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>FORM PENGELUARAN DOKUMEN EKSTERNAL<br /><?php echo $data['nama1']; ?></u></font></p>
<?php
...
<?php
	...
	$data=mysql_fetch_array($proses);
?>
  <form method="post" action="keluar_data_eksternal.php" enctype="multipart/form-data">
...
<br />
<p align="center"><b> Riwayat Pengeluaran Dokumen Eksternal</b></p>
<table align="center">
<tr>
