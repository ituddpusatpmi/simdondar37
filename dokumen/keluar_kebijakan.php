...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>FORM PENGELUARAN DOKUMEN KEBIJAKAN<br /><?php echo $data['nama1']; ?></u></font></p>
<?php
	$sql="select kebijakan.terkait as nama, pks.kontrol as kontrol, pks.kontrol as kontrol, pks.kontrol3 as kontrol3  from pks,kebijakan where pks.nama1=kebijakan.terkait and kebijakan.nomor='$detail'";
	$proses=mysql_query($sql);
	$data=mysql_fetch_array($proses);
?>
<p align="center"><?php echo $data['nama']; ?><?php echo $data['kontrol']; ?><?php echo $data['kontrol']; ?><?php echo $data['kontrol3']; ?></p>
<?php
	$sql="select * from kebijakan where kontrol='$detail'";
	$proses=mysql_query($sql);
	$data=mysql_fetch_array($proses);
?>
  <form method="post" action="keluar_data_kebijakan.php" enctype="multipart/form-data">
...
<input type="text" name="kontrol2_riwayat" value="<?php echo $data['kontrol']; ?>" style="display:none" />
    ...
    <td valign="top">
      <table align="center">
        ...
        <tr>
          ...
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
            <input type="text" style="background:yellow;" readonly="readonly" name="kontrol2" size="20" value="<?php echo $data['kontrol']; ?>" />	
          </div></td>
          </tr>
...
<br />
<p align="center"><b> Riwayat Pengeluaran Dokumen kebijakan</b></p>
<table align="center">
<tr>
