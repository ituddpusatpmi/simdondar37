...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>INSTRUKSI KERJA ALAT</u></font></p>
<table align="center" bgcolor="#FFFFFF">
<tr>
	<td><a href="input_ika.php"><input type="button" value="Tambah IKA" /></a></td>
    <form method="post" action="cari_ika.php">
...
<tr>
	...
	<table align="center" border="1" cellpadding="1" cellspacing="1">
        ...
        <?php
	$donor = "select * from ika where bidang like '%$cari%' or nama1 like '%$cari%' or nama2 like '%$cari%' or tingkat like '%$cari%' or kontrol like '%$cari%' or kontrol2 like '%$cari%' or kontrol3 like '%$cari%' or tgl_setuju like '%$cari%' or tgl_pelaksanaan like '%$cari%' or tgl_peninjauan like '%$cari%' order by kontrol2";
	...
	$nourut++;
        ...
        <tr>
            ...
            <td><a href="detail_ika.php?detail=<?php echo $data['nomor']; ?>"><img src="images/ubah.png"></img></a>&nbsp;&nbsp;<a href="hapus_ika.php?hapus=<?php echo $data['nomor']; ?>"><img src="images/hapus.png"></img></a></td>
        </tr>
        <?php
		}
		?>
