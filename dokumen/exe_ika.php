<?php
	...
	$tgl2 = date('Y-m-d', strtotime('-60 days', strtotime($tgl1)));
		...
		$sql = "insert into ika(terkait,bidang,nama1,nama2,tingkat,kontrol,kontrol2,kontrol3,periode,no_versi,tgl_setuju,tgl_pelaksanaan,tgl_peninjauan,pembuat,pemeriksa,pengesah,
pengesah2,tgl_notif,fileku) values ('$terkait','$bidang','$nama1','$nama2','$tingkat','$kontrol1',
...
if($result){
include "ika.php";
echo "Data IKA berhasil di input";
}
else{
echo "ERROR";
}
