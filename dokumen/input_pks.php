...
function selectSupplier(Kode){
 ...
 <script>
    function toggleTipeDokumen(type) {
        const kontrols = {
            udd: ["kontrol1", "kontrol2", "kontrol3", "kontrol4"],
            selain_udd: ["kontrol5", "kontrol6", "kontrol7", "kontrol8", "kontrol9"],
            ptpmi: ["ptpmi1", "ptpmi2", "ptpmi3", "ptpmi4"]
        };

        // Nonaktifkan semua kontrol
        Object.values(kontrols).flat().forEach(id => {
            document.getElementById(id).disabled = true;
        });

        // Aktifkan kontrol sesuai tipe
        if (kontrols[type]) {
            kontrols[type].forEach(id => {
    ...
    function handleTipeDokumen() {
        const selectedType = document.querySelector('input[name="tipe_dokumen"]:checked').value;
        toggleTipeDokumen(selectedType);
    }
    </script>
...
<body>
<br /><br />
<p align="center" class="COOPER"><font size="5"><u>INPUT SPO BARU</u></font></p>
<form action="exe_pks.php" method="post" enctype="multipart/form-data">
     ...
     <tr>
                            ...
                            <td colspan="2">
                                <div align="left">
                                    ...
                                    <input type="radio" id="ptpmi" name="tipe_dokumen" value="ptpmi"
                                        onChange="handleTipeDokumen()" required>
                                    <label for="ptpmi">PT. PMI</label>
                                </div>
                            </td>
                        </tr>
    <tr>
					    ...
					    <option>UM</option>
                                        ...
                                        <input type="text" id="kontrol3" name="kontrol3" value="-L2-"
                                            readonly="readonly" size="5" disabled />
                                        <input type="text" id="kontrol4" name="kontrol4" size="10" disabled />

                                    </strong></div>
                            </td>
                            <td rowspan="3"><strong><a href="cari_data_pks.php?&width=400&height=350"
                        ...
                        <tr>
                            <td>
                                <div align="left"><strong>
                                        <input type="text" id="ptpmi1" name="ptpmi1" value="PSU"
                                            readonly="readonly" size="7" disabled />
                                        <select name="ptpmi2" id="ptpmi2" disabled>
                                            <option></option>
                                            <option>PR</option>
                                            <option>PML</option>
                                        </select>
                                        <input type="text" id="ptpmi3" name="ptpmi3" value="-L2-"
                                            readonly="readonly" size="5" disabled />
                                        <input type="text" id="ptpmi4" name="ptpmi4" size="10" disabled />
                                    </strong></div>
                            </td>
                        </tr>
    <tr>
...
<?php
	$sql="select * from pks order by kontrol2";
	$proses=mysql_query($sql);
	$data=mysql_fetch_array($proses);
?>
    <tr>
