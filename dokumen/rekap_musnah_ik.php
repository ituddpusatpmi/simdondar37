...
<br><br>
<a href="ik.php"><button class="button1">Kembali Ke Menu Utama</button></a>
<br><br>
<p align="center"><b> Daftar Dokumen IK Yang Telah Dimusnahkan</b></p>
<table>
  <thead>
    <tr>
      	<th rowspan="2">No</th>
  ...
  <tbody id="myTable">
    <?php
	$donor = "select * from ik where aktif='1' order by kontrol2";
