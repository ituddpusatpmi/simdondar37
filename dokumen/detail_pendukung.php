<?php
	...
	$sql="select * from pendukung where kontrol2='$detail'";
...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>DOKUMEN PENDUKUNG<br /><?php echo $data['nama1']; ?></u></font></p>
<?php
	$sql="select pendukung.terkait as nama, pks.kontrol as kontrol, pks.kontrol2 as kontrol2, pks.kontrol3 as kontrol3  from pks,pendukung where pks.nama1=pendukung.terkait and pendukung.nomor='$detail'";
	$proses=mysql_query($sql);
	$data=mysql_fetch_array($proses);
?>
...
<?php
	...
	$data=mysql_fetch_array($proses);
?>
  <form method="post" action="edit_pendukung.php" enctype="multipart/form-data">
...
<input type="text" name="pelaksanaan_riwayat" value="<?php echo $data['tgl_pelaksanaan']; ?>" style="display:none" />
<input type="text" name="peninjauan_riwayat" value="<?php echo $data['tgl_peninjauan']; ?>" style="display:none" />
...
<input type="text" name="pengesah_riwayat2" value="<?php echo $data['pengesah2']; ?>" style="display:none" />
  ...
  <tr>
    <td valign="top">
      <table align="center">
        ...
        <tr>
          ...
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
            <input type="text" name="nama1" size="50" value="<?php echo $data['nama1']; ?>" />
          </strong></div></td>
          </tr>
        <tr>
          ...
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
            <input type="text" name="nama2" size="50" value="<?php echo $data['nama2']; ?>" />
          </strong></div></td>
          </tr>
        <tr>
        ...
        <tr>
          ...
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
            <input type="text" name="periode" size="5" value="<?php echo $data['periode']; ?>" />
          </strong></div></td>
          </tr>
        <tr>
          ...
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
            <input type="text" name="no_versi" size="10" value="<?php echo $data['no_versi']; ?>" />
          </strong></div></td>
          </tr>
        <tr>
          ...
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
            <input type="text" name="tgl_setuju" id="" value="<?php echo $data['tgl_setuju']; ?>" />
          </strong></div></td>
          </tr>
        <tr>
          ...
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
            <input type="text" name="tgl_pelaksanaan" id="" value="<?php echo $data['tgl_pelaksanaan']; ?>" />
          </strong></div></td>
          </tr>
        <tr>
          ...
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
            <input type="text" name="tgl_peninjauan" id="" value="<?php echo $data['tgl_peninjauan']; ?>" />
          </strong></div></td>
          </tr>
        <tr>
    ...
    <tr>
		...
		<input type="file" name="fileupload" name="upload" id="fileupload" class="form-control" />
        </strong></div></td>
    </tr>
	<!--akhir upload-->
        ...
        <tr>
          <td colspan="3" align="right"><input class="button1" type="submit" name="upload" value="Update" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
          </tr>
        </table>
      </td>
  </tr>
...
<br />
<p align="center"><b> Riwayat Perubahan Dokumen Pendukung</b></p>
<table align="center">
<tr>
