...
<br><br>
<a href="rekap_musnah_ik.php"><button class="button1">Daftar Pemusnahan Dokumen</button></a>
<br><br>
<p align="center"><b> Dokumen Instruksi Kerja (L3)</b></p>
<table>
  <thead>
    <tr>
      	<th rowspan="2">No</th>
  ...
  <tbody id="myTable">
    <?php
	$donor = "select * from ik where aktif='0' order by kontrol2";
	...
	?>
	    ...
	    <td><div align="center"><?php echo $pengerjaan3; ?></div></td> 
            <td><a href="keluar_ik.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/clip.png" width="30" height="30"></img>
	    </a></td>
            <td><a href="detail_ik.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/revisi.png" width="30" height="30"></img></a></td>
	    <td><a href="musnah_ik.php?detail=<?php echo $data['kontrol2']; ?>"><img src="images/musnah.png" width="30" height="30"></img></a></td>
        </tr>
  <?php
		}
		?>
