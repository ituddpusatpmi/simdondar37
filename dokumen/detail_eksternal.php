<?php
	...
	$sql="select * from eksternal where kontrol2='$detail'";
...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>DOKUMEN EKSTERNAL<br /><?php echo $data['nama1']; ?></u></font></p>
<?php
	$sql="select eksternal.terkait as nama, pks.kontrol as kontrol, pks.kontrol2 as kontrol2, pks.kontrol3 as kontrol3  from pks,eksternal where pks.nama1=eksternal.terkait and eksternal.nomor='$detail'";
	$proses=mysql_query($sql);
	$data=mysql_fetch_array($proses);
?>
...
<?php
	...
	$data=mysql_fetch_array($proses);
?>
  <form method="post" action="edit_eksternal.php" enctype="multipart/form-data">
  ...
  <tr>
    <td valign="top">
      <table align="center">
        ...
        <tr>
          <td><div align="right"><strong>Tanggal Disetujui</strong></div></td>
          <td><strong>:</strong></td>
          <td><div align="left"><strong>
...
<br />
<p align="center"><b> Riwayat Perubahan Dokumen Eksternal</b></p>
<table align="center">
<tr>
