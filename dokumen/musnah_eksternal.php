...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>FORM PEMUSNAHAN DOKUMEN EKSTERNAL<br /><?php echo $data['nama1']; ?></u></font></p>
<?php
...
<?php
	...
	$data=mysql_fetch_array($proses);
?>
  <form method="post" action="musnah_data_eksternal.php" enctype="multipart/form-data">
