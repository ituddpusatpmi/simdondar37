...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>INSTRUKSI KERJA<br /><?php echo $data['nama1']; ?></u></font></p>
<?php
...
<?php
	...
	$data=mysql_fetch_array($proses);
?>
  <form method="post" action="edit_ik.php" enctype="multipart/form-data">
...
<br />
<p align="center"><b> Riwayat Perubahan Instruksi Kerja</b></p>
<table align="center">
<tr>
