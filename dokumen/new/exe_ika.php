<?php
	...
	$pengesah = $_POST['pengesah'];
		...
		$sql = "insert into ika(bidang,nama1,nama2,tingkat,kontrol,periode,no_versi,tgl_setuju,tgl_pelaksanaan,tgl_peninjauan,pembuat,pemeriksa,pengesah) values ('$bidang','$nama1','$nama2','$tingkat',concat('$kontrol1','$kontrol4','$kontrol2','$kontrol3'),'$periode','$no_versi','$tgl_setuju','$tgl_pelaksanaan','$tgl_peninjauan','$pembuat','$pemeriksa','$pengesah')";
