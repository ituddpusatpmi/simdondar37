...
<body>
<br /><br />
<p align="center" class="COOPER"><font size="5"><u>INPUT PKS BARU</u></font></p>
...
<tr>
    ...
    <tr>
        ...
        <td><strong>:</strong></td>
        <?php
			$sql="select count(*)+1 as jumlah from pks";
			$proses=mysql_query($sql);
			$data=mysql_fetch_array($proses);
		?>
        <td><strong>
          <input type="text" name="kontrol1" value="PKS-L2/" size="5" />
		  <input type="text" name="kontrol4" size="10" />
																		...
																		<input type="text" name="kontrol3" value="-UTDPKU" size="5" />
        </strong></td>
    </tr>
    <tr>
