...
<body>
<br /><br />
<p align="center" class="COOPER"><font size="5"><u>INPUT IKA BARU</u></font></p>
...
<tr>
    ...
    <tr>
        ...
        <td><strong>:</strong></td>
        <?php
			$sql="select count(*)+1 as jumlah from ika";
			$proses=mysql_query($sql);
			$data=mysql_fetch_array($proses);
		?>
        <td><strong>
          <input type="text" name="kontrol1" value="IKA-L2/" size="5" />
		  <input type="text" name="kontrol4" size="10" /><select name="kontrol2">
		  																<option></option>
																		<option>/PEL</option>
																		<option>/PROD</option>
																		<option>/DIST</option>
