...
'$pengesah_riwayat','$pengesah_riwayat2','$nama1_riwayat','$ImageName')";
	...
	$riwayat2="update riwayat set terkait='$nama1' where terkait='$nama_ubah'";
		...
		$sql = "update ika set bidang='$bidang',nama1='$nama1',nama2='$nama2',tingkat='$tingkat',kontrol='$kontrol1',kontrol2='$kontrol2',kontrol3='$kontrol3',periode='$periode',no_versi='$no_versi',tgl_setuju='$tgl_setuju',tgl_pelaksanaan='$tgl_pelaksanaan',tgl_peninjauan='$tgl_peninjauan',pembuat='$pembuat',pemeriksa='$pemeriksa',
...
if($result2)
{
echo "input riwayat perubahan IKA berhasil ...<br/> ";
}
else
{
echo "Gagal ... ";
...
if($result3)
{
echo "penyesuaian riwayat perubahan IKA berhasil ...<br/> ";
include "ika.php";
}
else
{
...
<?php
  if(isset($_POST["upload"]))
  {
      ...
      if (!empty($fileupload)){
        ...
        echo "<script>alert('Berhasil diupload'); location='ika.php'</script>";
      }
  }
?>
