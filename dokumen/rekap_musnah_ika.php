...
<br><br>
<a href="ika.php"><button class="button1">Kembali Ke Menu Utama</button></a>
<br><br>
<p align="center"><b> Daftar Dokumen IKA Yang Telah Dimusnahkan</b></p>
<table>
  <thead>
    <tr>
      	<th rowspan="2">No</th>
  ...
  <tbody id="myTable">
    <?php
	$donor = "select * from ika where aktif='1' order by kontrol2";
