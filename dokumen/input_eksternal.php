...
<body>
    ...
    <p align="center" class="COOPER">
        <font size="5"><u>INPUT DOKUMEN EKSTERNAL BARU</u></font>
    </p>
    <form action="exe_eksternal.php" method="post" enctype="multipart/form-data">
        <table align="center" border="1" cellpadding="10" cellspacing="1" bgcolor="#FFFFFF">
            <tr>
              ...
              <option>4</option>-->
                        ...
                        <tr>
                            ...
                            <td>
                                <div align="left"><strong>
                                        ...
                                        <input type="text" id="kontrol3" name="kontrol3" value="-L5-"
                                            readonly="readonly" size="5" disabled />
                                        <input type="text" id="kontrol4" name="kontrol4" size="10" disabled />

                                    </strong></div>
                            </td>
                            <td rowspan="2"><strong><a href="cari_data_external.php?&width=400&height=350"
                        ...
                        <?php
                        $sql = 'select * from pendukung order by kontrol2';
                        $proses = mysql_query($sql);
                        $data = mysql_fetch_array($proses);
                        ?>
                        <tr>
