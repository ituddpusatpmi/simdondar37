...
if ($tipe_dokumen === 'udd') {
    $sql = "insert into eksternal(terkait,bidang,nama1,nama2,tingkat,kontrol,kontrol2,kontrol3,periode,no_versi,tgl_setuju,tgl_pelaksanaan,tgl_peninjauan,pembuat,pemeriksa,
pengesah,pengesah2,tgl_notif,fileku) values ('$terkait','$bidang','$nama1','$nama2','$tingkat','$kontrol1', concat ('$kontrol1','$kontrol2','$kontrol3','$kontrol4'), concat('$kontrol2','$kontrol5','$kontrol3'), '$periode','$no_versi','$tgl_setuju','$tgl_pelaksanaan','$tgl_peninjauan','$pembuat','$pemeriksa','$pengesah','$pengesah2','$tgl2','$ImageName')";

    $master_nomor = mysql_query(
        "insert into master_nomor_eksternal(bidang,nama1,kontrol2) values ('$bidang','$nama1',concat ('$kontrol1','$kontrol2','$kontrol3','$kontrol4'))"
    );
} else {
    $sql = "insert into eksternal(terkait,bidang,nama1,nama2,tingkat,kontrol,kontrol2,kontrol3,periode,no_versi,tgl_setuju,tgl_pelaksanaan,tgl_peninjauan,pembuat,pemeriksa,
	pengesah,pengesah2,tgl_notif,fileku) 
	...
	'$periode','$no_versi','$tgl_setuju','$tgl_pelaksanaan','$tgl_peninjauan','$pembuat','$pemeriksa','$pengesah','$pengesah2',
	'$tgl2','$ImageName')";

    $master_nomor = mysql_query(
        "insert into master_nomor_eksternal(bidang,nama1,kontrol2) values ('$bidang','$nama1',concat ('$kontrol5','$kontrol6','$cek_klausul', '$kontrol8', '-','$kontrol9'))"
    );
}
...
if ($result) {
    ...
    echo 'Dokumen Eksternal berhasil di input';
} else {
    echo 'ERROR';
}
?>
