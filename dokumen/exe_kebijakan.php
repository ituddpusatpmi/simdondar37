...
if ($tipe_dokumen === 'udd') {
    $sql = "insert into kebijakan(bidang,nama1,nama2,tingkat,kontrol,periode,no_versi,tgl_setuju,tgl_pelaksanaan,tgl_peninjauan,pembuat,pemeriksa,pengesah,pengesah2,tgl_notif,fileku) values ('$bidang','$nama1','$nama2','$tingkat',concat('$kontrol1','$kontrol2','$kontrol3','$kontrol4'),'$periode','$no_versi','$tgl_setuju','$tgl_pelaksanaan','$tgl_peninjauan','$pembuat','$pemeriksa','$pengesah','$pengesah2','$tgl2','$ImageName')";
} else {
    $sql = "insert into kebijakan(bidang,nama1,nama2,tingkat,kontrol,periode,no_versi,tgl_setuju,tgl_pelaksanaan,tgl_peninjauan,pembuat,pemeriksa,pengesah,pengesah2,tgl_notif,fileku) values ('$bidang','$nama1','$nama2','$tingkat',$nokontrol, '$periode', '$no_versi', '$tgl_setuju', '$tgl_pelaksanaan', '$tgl_peninjauan', '$pembuat', '$pemeriksa','$pengesah','$pengesah2','$tgl2','$ImageName')";
}
...
if ($result) {
    ...
    echo 'Dokumen Kebijakan berhasil di input';
} else {
    echo 'ERROR';
}
?>
