...
<br><br>
<a href="input_kebijakan.php"><button class="button">Tambah Dokumen</button></a>
<a href="rekap_musnah_kebijakan.php"><button class="button1">Daftar Pemusnahan Dokumen</button></a>
<br><br>
...
<table>
  ...
  <tr>
	    ...
	    <td><div align="center"><?php echo $pengerjaan3; ?></div></td> 
            <td><a href="keluar_kebijakan.php?detail=<?php echo $data['kontrol']; ?>"><img src="images/clip.png" width="30" height="30"></img>
	    </a></td>
            <td><a href="detail_kebijakan.php?detail=<?php echo $data['kontrol']; ?>"><img src="images/revisi.png" width="30" height="30"></img></a></td>
	    <td><a href="musnah_kebijakan.php?detail=<?php echo $data['kontrol']; ?>"><img src="images/musnah.png" width="30" height="30"></img></a>
	    </td>
  </tr>
  <?php
		}
