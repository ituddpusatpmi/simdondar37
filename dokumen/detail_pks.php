...
<body>
<br />
<p align="center" class="COOPER"><font size="5"><u>STANDAR PROSEDUR OPERASIONAL<br /><?php echo $data['nama1']; ?></u></font></p>

<form method="post" action="edit_pks.php" enctype="multipart/form-data">
    ...
    <td valign="top">
      <table align="center">
        ...
        <tr>
          ...
          <td><strong>:</strong></td>
          <td><div align="left"><strong><input type="text" name="nama_ubah" size="50" value="<?php echo $data['nama1']; ?>"  style="display:none"/>
        ...
        <tr>
        <?php
    	$sql="select * from pks where kontrol2='$detail'";
	$proses=mysql_query($sql);
	$data=mysql_fetch_array($proses);
	?>
...
<br />
<p align="center"><b> Riwayat Perubahan SPO</b></p>
<table align="center">
<tr>
