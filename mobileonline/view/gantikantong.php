...
<?php
    ...
    if (isset($_POST['simpan'])) {
        ...
        $sehatup1   = mysqli_query($con, "update stokkantong set kodependonor='$_POST[id]'  where noKantong='$_POST[nokantong]' ");
        $sehatup2   = mysqli_query($con, "update htransaksi set kodependonor='$_POST[id]'  where NoKantong='$_POST[nokantong]' ");
        $sehatup3   = mysqli_query($con, "update stokkantong set kodependonor='$_POST[id1]'  where noKantong='$_POST[nokantong1]' ");
        $sehatup4   = mysqli_query($con, "update htransaksi set kodependonor='$_POST[id1]'  where NoKantong='$_POST[nokantong1]' ");
        ...
        <META http-equiv="refresh" content="2; url=?page=dash"><?php
...
<div class="card-header">
  <h4 class="text-center" style="font-size:24px; font-weight:bold;color:#ff0000;text-shadow: 1px 1px 1px #000000; font-family:Helvetica, Arial, san-serif;">PERGANTIAN KANTONG<br><?php echo $ins['nama'];?></h4>
...
<!--content-->
        ...
        <form name="sehat" method="POST" action="" onkeydown="return event.key != 'Enter';">
        <table>
        <tr><td>Nomor Kantong 1</td><td>:</td><td> <input type="text" name="nokantong" autocomplete="off" size=15>
        </td></tr>
        <tr><td>Kode Pendonor 1</td><td>:</td><td>  <input type="text" name="id" autocomplete="off" size=20>
        </td></tr>
        <tr><td>Nomor Kantong 2</td><td>:</td><td> <input type="text" name="nokantong1" autocomplete="off" size=15>
        </td></tr>
        <tr><td>Kode Pendonor 2</td><td>:</td><td>  <input type="text" name="id1" autocomplete="off" size=20>
