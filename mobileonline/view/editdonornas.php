<?php
    ...
    //$data = mysqli_fetch_assoc(mysqli_query($con, $jd));
        ...
        if ($data['rhesus']=='Neg'){$rhesus='-';}else{$rhesus='+';}
    ...
    if(isset($_POST['proses'])){
        ...
        //CARI PENDONOR DI LOKAL & UPDATE OR INSERT
        $jd="select * from pendonor where `Kode`='$kodep'";
        echo $jd;
        $dcari = mysqli_num_rows(mysqli_query($con, $jd));
        if ($dcari == "1"){
        //if ($data['prhesus']=='Neg'){$rhesus='-';}else{$rhesus='+';}
            $sql_upd="UPDATE `pendonor` SET
                ...
                $tglkembali = $data['ptglkembali'];
                $jmldonor = $data['pjmldonor'];
                
                $sql_upd = "insert into pendonor
                ...
                '$rhesus','1','$kel','$kec','$wil','$jmldonor','-',
                '$telp','$umur','$tglkembali',
            ...
            //echo $msg."<br>";
        //insert htransaksi
        if (date('Y-m-d') >= $data['ptglkembali']){
...
<!--content-->
    ...
    <div class="table-responsive">
        <table width=100%>
            ...
            <tr><td>No. KTP</td>         <td class="warning"><input type="text" name="ktp" class="form-control" value=<?php echo $data['pnoktp'];?>>
                    <input type="hidden" name="gol" value=<?php echo $data['pgoldarah'];?>>
                    <input type="hidden" name="rh" value=<?php echo $rhesus;?>>
                    <input type="hidden" name="jmldnr" value=<?php echo $data['pjmldonor'];?>>
                    <input type="hidden" name="umur" value=<?php echo $data['pumur'];?>>
                    
            </td></tr>
            <tr><td>Nama Pendonor</td>  <td class="warning text-danger"><strong><input type="text" name="namap" class="form-control" value="<?php echo $data['pnama'];?>"></strong></td></tr>
            ...
            <tr><td>Alamat</td>         <td class="warning"><input type="text" name="alamat" class="form-control" value="<?php echo $data['palamat'];?>"></td></tr>
            <tr><td>Keluarahan</td>     <td class="warning"><input type="text" name="kel" class="form-control" value="<?php echo $data['pkelurahan'];?>"></td></tr>
            <tr><td>Kecamatan</td>      <td class="warning"><input type="text" name="kec" class="form-control" value="<?php echo $data['pkecamatan'];?>"></td></tr>
            <tr><td>Wilayah</td>        <td class="warning"><input type="text" name="wil" class="form-control" value="<?php echo $data['pwilayah'];?>"></td></tr>
    ...
    <div class="table-responsive">
      <table width=100%>
        <tr><td>No. Handphone</td>           <td class="warning"><input type="text" name="telp" class="form-control" value="<?php echo $data['ptelp2'];?>"></td></tr>
        <tr><td>Tempat Lahir</td>      <td class="warning"><input type="text" name="tmp_lhr" class="form-control" value="<?php echo $data['ptempatlahir'];?>"></td></tr>
        <tr><td>Tanggal Lahir</td>      <td class="warning"><input type="text" name="tgl_lhr" id="datepicker" style="width:4cm;height:0.75cm" class="form-control" value="<?php echo $data['ptgllahir'];?>"></td></tr>
