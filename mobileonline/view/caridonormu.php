...
?>
    ...
    <body class="padding">
        ...
        <div class="card-header">
            ...
            <a href="?page=donorbaru"><button name="baru" class="btn btn-warning"><i class="nav-icon ion ion-android-person-add"></i> Donor Baru</button></a>
                ...
                <form method="POST" onkeydown="return event.key != 'Enter';" onsubmit="return validasiregistrasi()">
                    <div class="row" align="center">
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="NoKTP" name="NoKTP" placeholder="No. KTP/Identitas">
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="tgl" name="tgl" placeholder="dd" size='2' maxlength="2">
                                    <input type="text" class="form-control" id="bln" name="bln" placeholder="mm" size='2' maxlength="2">
                                    <input type="text" class="form-control" id="thn" name="thn" placeholder="yyyy" size='4' maxlength="4">
                                </div>
                            </div>
                           <div class="form-group">
                                <div class="input-group">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="udd" id="instansi" value="<?php echo $utd['id']; ?>" placeholder="Kab / Kota" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="input-group">
                        ...
                        <div class="form-group">
                            ...
                            <button id="cariPendonor" name="lokal" type="submit" class="btn btn-success"><i class="fa fa-search"></i> Cari Data </button>
                        </div>
                    </div>
                </form>
                <!--p class="box"-->
                            ...
                            ?>
                                <tr <?php echo $style; ?> onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
                                    <td align="center">
                                        ...
                                        <a href="?page=edits&id=<?php echo $data['Kode'] ?>"><img src="../images/ubah.png" width=25 height=15 /></a>
                                        <a href="?page=histori&q=<?php echo $data['Kode'] ?>" target="isiadmin" class="fisheyeItem"><?php echo $data['Kode']; ?></a>
                                    </td>
                                                ...
                                                <?php if ($data['data'][$a]['pjk'] == "1") {
                                                    ...
                                                    <img src="../images/bloodbag.png" width=25 height=15 /> <?php }
                                                                                                        echo  '<a href="?page=editn&id=' . htmlspecialchars(serialize($data['data'][$a])) . '"><img src="../images/ubah.png" width=25 height=15 /></a>';
                                                                                                            ?>
                                                <br>
                                                <a href="pmi<?php echo $_SESSION['leveluser'] ?>.php?module=history_luar&q=<?php echo $data['data'][$a]['pkode'] ?>" target="isiadmin" class="fisheyeItem"><?php echo $data['data'][$a]['pkode']; ?></a>
                                            </td>
