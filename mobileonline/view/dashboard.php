...
<div class="card-body" >
  ...
  <div class="box" align="center">
    ...
    <div class="row">
        ...
        <div class="col-lg-2">
            <div class="zoom"><a href="?page=searchmcu"><img src="../images/medical_checkup.png"></a></div>
        </div>
        <div class="col-lg-2">
            <div class="zoom"><a href="?page=searchaftap"><img src="../images/aftap_pengambilandarah1.png"></a></div>
        </div>
        <div class="col-lg-2">
            <div class="zoom"><a href="?page=gantikantong"><img src="../images/pergantian_kantong.png"></a></div>
        </div>
        <div class="col-lg-2">
            <div class="zoom"><a href="?page=check"><img src="../images/cek_sampeldds.png"></a></div>
        </div>
        <div class="col-lg-2">
            <div class="zoom"><a href="?page=rekap"><img src="../images/rekap_transaksi0.png"></a></div>
        </div>
