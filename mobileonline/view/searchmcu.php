...
<?php
    ...
    $query = ("SELECT * FROM htransaksi where Status='0' and instansi = '$namains' and (date(Tgl)BETWEEN curdate()-INTERVAL 1 DAY AND curdate())"); //0=baru, 1=med cheked, 2=aftap
              ...
              while ($data = mysqli_fetch_array($hasil)){
                $a++;
                  ...
                  echo "
                      ...
                      <td nowrap>";
                      switch($jenis_pemngambilan){
                          case '0' :echo "<a href=?page=mcu&id=".$data['KodePendonor']."&NoTrans=".$data['NoTrans']." title='Klik untuk melanjutkan ke Medical Check Up DONOR BIASA'>".$hasil1['Nama']."</a>";break;
                          case '1' :echo "<a href=?page=checkup_aph&kode=".$hasil1['Kode']."&tpk=0&trx=".$data['NoTrans']." title='Klik untuk melanjutkan ke Medical Check Up donor APHERESIS'>".$hasil1['Nama']."</a>";break;
                          case '2' :echo "<a href=?page=checkup_aph&kode=".$hasil1['Kode']."&tpk=1&trx=".$data['NoTrans']." title='Klik untuk melanjutkan ke Medical Check Up donor APHERESIS PLASMA KONVALESEN'>".$hasil1['Nama']."</a>";break;
                      }
                  echo "</td>
                      <td nowrap>".$hasil1['Kode']."</td>
                      <td nowrap>".$hasil1['TglLhr']."</td>
                      <td nowrap>".$data['gol_darah'].$data['rhesus']."</td>
                      <td nowrap>".$dsdp."</td>
                      <td nowrap>".$brlm."</td>";
                  ...
                  <td nowrap>";
                      switch($jenis_pemngambilan){
                          case '0' :echo "<a href=formulir_donor_PDF2.php?kp=".$data['KodePendonor']." title='Klik untuk cetak formulir'><input type='button' value='Formulir'></a>";break;
                          case '1' :echo "<a href=formulir_donor_PDF2.php?kp=".$data['KodePendonor']." title='Klik untuk cetak formulir'><input type='button' value='Formulir'></a>";break;
                          case '2' :echo "<a href=formulir_donor_PDF2.php?kp=".$data['KodePendonor']." title='Klik untuk cetak formulir'><input type='button' value='Formulir'></a>";break;
                      }
                  echo "</td></tr>";
