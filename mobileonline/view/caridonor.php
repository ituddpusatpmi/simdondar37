...
<div class="form-group">
    ...
    <button name="lokal" type="submit" class="btn btn-success"><i class="fa fa-search"></i>  Cari Data Server Lokal</button>
</div>
</div>
</form>
<!--p class="box"-->
      ...
      if ($num > 0){
        ...
        <tr <?php echo $style;?> onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
              <td align="center">
                ...
                <a href="?page=histori&q=<?php echo $data['Kode']?>" target="isiadmin" class="fisheyeItem"><?php echo $data['Kode'];?></a></td>
