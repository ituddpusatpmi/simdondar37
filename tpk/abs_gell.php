...
?>
	...
	<form name="kantong" onsubmit="return ok()" method="POST" action="<?=$PHPSELF?>">
		...
		<div style="font-family:Arial;font-size:20px;">Kode Sampel : <input class="bayangan" style="height:35px;padding-left:10px;font-size:16px;font-weight:bold;"type="text"  name="nokantong" id="nokantong" style="width:4cm;" placeholder="TPK200711001" onkeydown="chang(event,this);" onchange="cari_kantong('tababs');"></div>
		<br>
		...
		<a href="pmi<?php echo $lv0;?>.php?module=abs_mgellrekap" class="swn_button_blue">Rekap ABS</a>
</form>
