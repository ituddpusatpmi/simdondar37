...
if (isset($_POST['simpan'])) { 
    ...
    if (mysqli_num_rows($chkic)=='0'){
        $t_ic=mysqli_query($dbi,"INSERT INTO `htransaksi_ic`(`notrans`, `pendonor`, `satu`, `dua`, `tiga`, `empat`, `lima`, `enam`, `tujuh`, `delapan`, `sembilan`, `sepuluh`, `sebls`, `duabls`, `tigabls`, `empatbls`, `limabls`, `enambls`, `tujuhbls`, `delapanbls`, `sembilanbls`, `duapuluh`, `duasatu`, `duadua`, `duatiga`, `duaempat`, `dualima`, `duaenam`, `duatujuh`, `duadelapan`, `duasembilan`, `tigapuluh`, `tigasatu`, `tigadua`, `tigatiga`, `tigaempat`, `tigalima`, `tigaenam`, `tigatujuh`, `tigadelapan`, `tigasembilan`, `empatpuluh`, `empatsatu`, `empatdua`, `empattiga`) 
                                VALUES ('$v_notransaksi','$v_kodedonor','$v_no1','$v_no2','$v_no3','$v_no4','$v_no5','$v_no6','$v_no7','$v_no8','$v_no9','$v_no10','$v_no11','$v_no12','$v_no13','$v_no14','$v_no15','$v_no16','$v_no17','$v_no18','$v_no19','$v_no20','$v_no21','$v_no22','$v_no23','$v_no24','$v_no25','$v_no26','$v_no27','$v_no28','$v_no29','$v_no30','$v_no31','$v_no32','$v_no33','$v_no34','$v_no35','$v_no36','$v_no37','$v_no38','$v_no39','$v_no40','$v_no41','$v_no42','$v_no43')");
        if($t_ic){
    ...
    if ($v_lolos=="0"){
            echo '<META http-equiv="refresh" content="2; url=pmi'.$lv5.'.php?module=pengambilan_apheresis&NoTrans='.$v_notransaksi.'">';
    } else {
            echo '<META http-equiv="refresh" content="2; url=pmi'.$lv5.'.php?module=check">';
                   }
}
                                ...
                                <div class="table-responsive">
                                    <table class="table borderless table-striped table-hover" id="shadow1">
                                        <tr>
                                            ...
                                            <td><input name="reqberat_badan" id="berat_badan" type="text" style="width:15mm;" onChange="berat(this.value)" maxlength="3"> kg</td>
                                        </tr>
                                        <tr>
                                            <td>Tinggi Badan</td>
                                            <td><input name="tinggi_badan" type="text" style="width:15mm;" maxlength="3"> cm</td>
                                        </tr>
                                        <tr>
                                            <td>Tensi<sup style="color:red;"><strong>*</strong></sup></td>
                                            <td><input name="reqtensi_sistol" id="tensi_sistol" type="text"  style="width:15mm;"  onChange="sistol(this.value)" maxlength="3"> / 
                                                <input name="reqtensi_diastol" id="tensi_diastol" type="text" style="width:15mm;"  onChange="diastol(this.value)" maxlength="3"> mmHg
                                            </td>
                                        </tr>
                                        <tr><td>Suhu<sup style="color:red;"><strong>*</strong></sup></td>
                                            <td><input name="reqtemperatur" id="temperature" type="text" style="width:15mm;" maxlength="5" onChange="suhutubuh(this.value)">&nbsp;<sup>o</sup>C</td>    
                                        </tr>
                                        <tr><td>Nadi<sup style="color:red;"><strong>*</strong></sup></td>
                                            <td><input name="reqnadi" type="text" style="width:15mm;" maxlength="3"> BPM</td></tr>
                                        <tr><td>Saturasi Oksigen</td>
                                            <td><input name="oksigen" type="text" style="width:15mm;" maxlength="3"> %</td></tr>
                            ...
                            <div class="col-xs-6">
                                <div class="table-responsive" id="shadow1">
                                    <table class="table borderless table-striped table-condensed">
                                        ...
                                        <tr><td>10</td><td>Apakah anda pernah kontak dengan orang yang pernah menerima vaksinasi smallpox?</td>
                                        <td><div class="onoffswitch">
                            ...
                            <div class="col-xs-6">
                                <div class="table-responsive" id="shadow1">
                                    <table class="table table-striped table-hover">
                                        ...
                                        <tr>
                                            <td>Hematokrit<sup style="color:red;"><strong>*</strong></sup></td><td style="white-space:nowrap;"><input style='width:15mm' name="reqhematokrit" id="hematokrit" type="text" maxlength="3" value="<?php echo $ex_sampleinfo[4];?>"> %</td>
                                            <td>Hemoglobin<sup style="color:red;"><strong>*</strong></sup></td><td style="white-space:nowrap;"><input style='width:15mm' name="reqhemoglobin" id="hemoglobin" type="text" maxlength="5" value="<?php echo $ex_sampleinfo[5];?>"> g/dL</td>
                                        </tr>
                                        <tr>
                            ...
                            <div class="col-xs-12">
                                <div class="table-responsive" id="shadow1">
                                    <table class="table table-striped table-hover table-bordered table-condensed" style="height:100%;">
                                        <tr>
                                            <td colspan="7" class="bg-danger" style="font-size:16px;font-weight:bold;">Catatan Donasi sebelumnya</td>
                                        </tr>
                                        ...
                                        <?php
                                        $no=1;
                                        $histori=mysqli_query($dbi,"SELECT Kodependonor, date_format(Tgl, '%Y-%m-%d') AS Tgl1,Tgl,case when Pengambilan='1' then 'Batal' when Pengambilan='0' then 'Berhasil' when Pengambilan='2' Then 'Gagal' END As Pengambilan,beratBadan,nadi,suhu, caraAmbil,tensi,JenisDonor,tempat,Instansi,UPPER(NoKantong) as NoKantong,petugasHB,petugasTensi,user,petugas,donorke 
                                                                FROM htransaksi where (KodePendonor='$kode_donor' and Pengambilan<>'-' and date(Tgl)<>CURRENT_DATE) ORDER BY Tgl DESC"); 
                ...
                <div class="panel-footer">
                    <div class="row">
                        ...
                        <div class="col-6 pull-right" style="margin-right:20px;">
                            ...
                            <a href="<?=$lv0?>.php?module=check" class="btn btn-danger bayangan" style="color: black;">Kembali</a>
                        </div>
                    </div>
                </div>
            </div>
