                                ...
                                <div class="table-responsive" id="shadow1">
                                    <table class="table table-striped table-hover">
                                        <tr>
                                            ...
                                            <td  colspan="3">
                                                <input name="reqid_sample" id="id_sample"  type="text" onkeyup="showHint(this.value)" maxlength="16">
                                                <input name="reqid_samplevalid" id="id_samplevalid"  type="text">
                                                <input name="reqid_imltd" id="id_imltd"  type="text">
                                                <input name="reqid_nat" id="id_nat"  type="text">
                                            </td>
                                        </tr>
                                        <?php 
                                        if($qtrans['donor_tpk']=='1'){
