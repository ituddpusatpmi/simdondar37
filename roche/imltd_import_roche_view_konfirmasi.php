...
{
    $.fn
       .colorbox({href:'roche/imltd_rpt_konfirm1.php?notrans='+nomortransaksi,
...
<table border=0 cellpadding="5" cellspacing="5" width="100%">
   <tr>
		<td align="left" style="background-color: #ffffff"><font size=5 color="blue"><b>DATA KONFIRMASI HASIL PEMERIKSAAN COBAS 6000</b></font></td>
...
<table class="list" border=1 cellpadding="5" cellspacing="1" width="100%" style="border-collapse:collapse">
    ...
    <a href="roche/imltd_rpt_konfirm1.php?notrans=<?=$notrans?>"class="swn_button_blue">Cetak</a>
	<a href="pmiimltd.php?module=rochelistkonfirmasi1" class="swn_button_blue">Kembali ke list data</a>
