...
<body>
	...
	?>
	<font size="4" color=00008B>DATA KONFIRMASI PEMERIKSAAN ALINITY I ABBOTT</b></font><br><br>
	...
	while($tmp=mysql_fetch_assoc($qraw)){
		...
		<tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
			...
			<td>
				<a href="pmiimltd.php?module=alinityviewkonfirmasi&notrans=<?=$tmp['no_trans']?> ">Lihat</a>
		</tr>
	<?}
	if ($no==0){?>
        <tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
			<td colspan=8 align="center">Tidak ada data konfirmasi pemeriksaan IMLTD ALINITY I ABBOT</i></td>
	<?}?>
	</table><br>
