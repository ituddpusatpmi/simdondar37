...
<body>
	...
	?>
	<font size="4" color=00008B>DATA PENGGUNAAN REAGEN ALINITY I ABBOTT</b></font><br><br>
    ...
    $sqlsmp="SELECT date(`run_time`) as tgl,
            ...
            from lis_pmi.alinity_i WHERE date(`run_time`)>='$tglawal' AND date(`run_time`)<='$hariini'
	...
	if ($no==0){?>
        <tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
			<td colspan=14 align="center">Tidak ada data Reagen  ALINITY I <i>ABBOTT</i></td>
	<?}?>
	</table><br>
