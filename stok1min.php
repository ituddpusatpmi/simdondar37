...
?>
<font size="2" color="red" face="Trebuchet MS"><b>STOK DARAH</b><BR></font>
<font size="1" color="black" face="Trebuchet MS"><b>Tgl.: <?=$tanggal1?> <?=$jam?> WITA</b></font>
<div id="content1">
    <table border=0 cellpadding=2 cellspacing=1 width=100%>
      <tr bgcolor=#ED6161>
	  <td align=center><font size="2" color="#ffffff" face="Trebuchet MS"><b>JENIS</b></font></td>
    ...
    while ($produk1=mysql_fetch_assoc($produk)) {
      ...
      echo "<tr bgcolor=#FCC5C5>
		<td align=left><font size=1 face='Arial'><a href='' title='$produk1[lengkap] ($produk1[indonesia])'>$produk1[Nama]</a></font></td>
		<td align=right><font size=1 face='Arial'>$A</font></td>
		<td align=right><font size=1 face='Arial'>$B</font></td>
		<td align=right><font size=1 face='Arial'>$AB</font></td>
		<td align=right><font size=1 face='Arial'>$O</font></td>
	</tr>";}
	echo "<tr bgcolor=#ED6161>
		<td align=center><font size=1 color=#ffffff face='Arial'><b>JML</b></font></td>
		<td align=right><font size=1 color=#ffffff face='Arial'>$jum_a</font></td>
		<td align=right><font size=1 color=#ffffff face='Arial'>$jum_b</font></td>
		<td align=right><font size=1 color=#ffffff face='Arial'>$jum_ab</font></td>
		<td align=right><font size=1 color=#ffffff face='Arial'>$jum_o</font></td>
	</tr>";
	?>
  </table>
</div>
