...
$pdf->SetXY(4,20);
$pdf->SetFont('helvetica', 'b',  12);
$pdf->Cell(0, 14, 'Volume : '.$kantong1[volume]. ' cc', 0);
...
$pdf->SetXY(4,44);
$pdf->SetFont('helvetica', 10);
$pdf->Cell(0, 14, 'Lama Pengambilan : '.$kantong1[lama_pengambilan]. ' Menit', 0);



$pdf->SetXY(50,15); 
$pdf->SetFont('helvetica','bu', 12);
$pdf->Cell(0, 13, 'Gol Darah & Rhesus :', 0);
...
$pdf->SetXY(4,77);
$pdf->write1DBarcode(trim($_GET[noKantong]), 'C128', '', '', '55', 12, 0.65, $style, 'T');
$pdf->SetXY(3,65);
