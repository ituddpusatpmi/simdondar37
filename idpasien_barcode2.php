...
"FROM\n".
"htranspermintaan\n".
"INNER JOIN pasien ON htranspermintaan.no_rm = pasien.no_rm\n".
"INNER JOIN rmhsakit ON htranspermintaan.rs = rmhsakit.Kode\n".
