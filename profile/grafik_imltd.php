...
if (isset($_POST['submit'])) {
    ...
    switch ($model){
        case '1';
            $s1='selected';
            $title  = "GRAFIK PEMERIKSAAN UJI SARING IMLTD (".$tglawal.' - '.$tglakhir.')';
        ...
        <div class="col-lg-12">
            ...
            <div class="panel with-nav-tabs panel-primary" id="shadow1">
                <div class="panel-heading">
                    <h4>STATISTIK PEMERIKSAAN IMLTD</h4>
                </div>
                <form class="form-inline" method="POST" action="pmitatausaha.php?module=graphimltd">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            Jenis :
                            <select class="form-control" name="modelgraph">
                                <option value="1" <?=$s1?>>Trend Uji Saring IMLTD</option>
                                <option value="2" <?=$s2?>>Perbandingan Hasil Uji Saring IMLTD</option>
                            </select>
