    ...
    <div class="row">
        ...
        <div class="panel with-nav-tabs panel-primary" id="shadow1">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-lg-6">
                        <div><h4 style="text-transform: uppercase;">LAPORAN DONASI APHERESIS</h4></div>
                    </div>
                    <div class="col-lg-6">
                        <div class="panel-title pull-right">
                            <form class="form-inline"  method="POST" action="pmitatausaha.php?module=lap_donasi_aph">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-12">
                        <h4 class="text-center">LAPORAN DONASI DARAH APHERESIS</h4>
                    ...
                    <div class="col-lg-12">
                        ...
                        ?>
                        <h5>A.2.a. DONASI (Jumlah kantong darah yang didapatkan dari pendonor darah)</h5>
                    ...
                    <div class="col-lg-8">
                        ...
                        ?>
                        <h5>A.2.b. JUMLAH DONASI BERDASARKAN ALASAN PENDONOR DITOLAK</h5>
                        <table class="table table-bordered table-responsive table-condensed">
                            <thead class="pmi">
                                <tr>
                    ...
                    <div class="col-lg-6">
                        ...
                        ?>
                        <h5>A.2.c. TERIMA DONASI DARI UDD LAIN</h5>
                        <table class="table table-bordered table-responsive table-condensed">
                            <thead class="pmi">
                                <tr>
                                    <th class="text-center" style="vertical-align: middle">No</th>
            ...
            <div class="panel-footer">
                ...
                <a href="pmitatausaha.php?module=rpt_donasi_aph&thn=<?php echo $v_tahun;?>&bln=<?php echo $v_bulan;?>" class="btn btn-default" id="shadow2"><i class="fa fa-print" aria-hidden="true" title="Cetak Laporan"></i>&nbsp;&nbsp;Cetak Laporan</a>
