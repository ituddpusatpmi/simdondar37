        ...
        <br>
            <div class="panel with-nav-tabs panel-primary" id="shadow1">
                <div class="panel-heading">
                    <div class="row">
                        <div class="col-lg-6">
                            <div><h4 style="text-transform: uppercase;">IMUNOHEMATOLOGI</h4></div>
                        </div>
                        <div class="col-lg-6">
                            <div class="panel-title pull-right">
                                <form class="form-inline"  method="POST" action="pmitatausaha.php?module=lap_immunohematologi">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="text-center"><h4>LAPORAN PEMERIKSAAN IMUNOHEMATOLOGI</h4></div>
                        ...
                        <div class="col-lg-12">
                            <h4>E. PEMERIKSAAN IMUNOHEMATOLOGI</h4>
                            <table class="table table-hover table-bordered">
                                ...
                                <tbody>
                                <tr>
                                    <td class="text-center">1.</td><td>Konfirmasi Golongan Darah</td>
                                    <td class="text-center"><?php if ($qlap['u_periksa_kgd']=='1'){echo 'Dilakukan';}else{echo 'Tidak Dilakukan';}?></td>
                                    <td class="text-center"><?php echo $qlap['u_kgd_auto']; ?></td>
                                    <td class="text-center"><?php echo $qlap['u_kgd_semi']; ?></td>
                                    <td class="text-center"><?php echo $qlap['u_kgd_manual']; ?></td>
                                </tr>
                                <tr>
                                    <td class="text-center">2.</td><td>Skrining Antibodi</td>
                                    <td class="text-center"><?php if ($qlap['u_periksa_abs']=='1'){echo 'Dilakukan';}else{echo 'Tidak Dilakukan';}?></td>
                                    <td class="text-center"><?php echo $qlap['u_abs_auto']; ?></td>
                                    <td class="text-center"><?php echo $qlap['u_abs_semi']; ?></td>
                                    <td class="text-center"><?php echo $qlap['u_abs_manual']; ?></td>
                                </tr>
                                <tr>
                                    <td class="text-center">3</td><td>Identifikasi Antibodi</td>
                                    <td class="text-center"><?php if ($qlap['u_periksa_iab']=='1'){echo 'Dilakukan';}else{echo 'Tidak Dilakukan';}?></td>
                                    <td class="text-center"><?php echo $qlap['u_iab_auto']; ?></td>
                                    <td class="text-center"><?php echo $qlap['u_iab_semi']; ?></td>
                                    <td class="text-center"><?php echo $qlap['u_iab_manual']; ?></td>
                                </tr>
                                <tr>
                                    <td class="text-center">4.</td><td>Uji Silang Serasi</td>
                                    <td class="text-center"><?php if ($qlap['u_periksa_cross']=='1'){echo 'Dilakukan';}else{echo 'Tidak Dilakukan';}?></td>
                                    <td class="text-center"><?php echo $qlap['u_cross_auto']; ?></td>
                                    <td class="text-center"><?php echo $qlap['u_cross_semi']; ?></td>
                                    <td class="text-center"><?php echo $qlap['u_cross_manual']; ?></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
                ...
                <div class="panel-footer">
                    ...
                    <a href="pmitatausaha.php?module=rpt_immunohematologi&thn=<?php echo $v_tahun;?>" class="btn btn-default" id="shadow2"><i class="fa fa-print" aria-hidden="true" title="Cetak Laporan"></i>&nbsp;&nbsp;Cetak Laporan</a>
