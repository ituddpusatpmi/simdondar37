    ...
    <div class="row">
        ...
        <div class="panel with-nav-tabs panel-primary" id="shadow1">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="panel-title pull-right">
                            <form class="form-inline"  method="POST" action="pmitatausaha.php?module=imltd_donasi">
            ...
            <div class="panel-footer">
                ...
                <a href="pmitatausaha.php?module=rpt_imltd_donasi&thn=<?php echo $v_tahun;?>&bln=<?php echo $v_bulan;?>" class="btn btn-default" id="shadow2"><i class="fa fa-print" aria-hidden="true" title="Cetak Laporan"></i>&nbsp;&nbsp;Cetak Laporan</a>
