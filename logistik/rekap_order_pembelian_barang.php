...
<table class="list" cellpadding=5 cellspacing=1>
	...
	<tr class="record">
		...
		<td align="center"><a href=pmilogistik.php?module=rincian_order_beli&notrans=<?=$data1[notrans]?>><?=$data1[notrans]?></a></td>
