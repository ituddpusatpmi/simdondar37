    ...
    $.ajax({
        ...
        success:function(msg){
            ...
            <script>
                ...
                $(function(){
                    ...
                    $("#kode").load("transaksi_jual_proses.php","op=ambilbarang");
                    $("#kodesup").load("transaksi_jual_proses.php","op=ambilkodesupplier");
                    
                    //meload isi tabel
                    $("#barang").load("transaksi_jual_proses.php","op=barang");
                    ...
                    $("#tambah").click(function(){
                        ...
                        //else if(qtytransaksi > stoktotal){
                        ...
                        $.ajax({
                            ...
                            success:function(msg){
                               ...
                               $("#search-box").focus();
                                ...
                                //$("#hitungtotal").load("transaksi_jual_proses.php","op=hitungtotal&potongan="+potongan+"&ppn="+ppn+"&total="+total);
                                //$("#potongan").val(data[0]);
                                //$("#ppn").val(data[1]);
                                //$("#total").val(data[2]);
                            }
                    ...
                    $("#batal").click(function(){
                        $.ajax({
                            url:"transaksi_order_jual_proses.php",
                            data:"op=hapustemp",
                            cache:false,
                            success:function(msg){
                                if(msg=="sukses"){
                    ...
                    $("#proses").click(function(){
                        ...
                        if(kodesup=="Supplier"){
                            alert("Customer/pembeli harus diisi");
                            exit();
                        }
                        $.ajax({
                            url:"transaksi_jual_proses.php",
                            data:"op=proses&notrans="+notrans+"&tanggal="+tanggal+"&kodesup="+kodesup+"&prefix="+prefix+"&ppn="+ppn+"&potongan="+potongan+"&biayalain="+biayalain+"&hutang="+hutang+"&tgljtempo="+tgljtempo+"&nonota="+nonota,
                            cache:false,
                            success:function(msg){
                                if(msg=='sukses'){
                                    $("#status").html('Transaksi Penjualan/Pengeluaran barang berhasil diproses');
                                    alert('Transaksi Penjualan/Pengeluaran barang berhasil diproses');
                                    window.location='../pmilogistik.php?module=rincian_transaksi_jual&notrans='+notrans;
                                    exit();
                                }else{
        ...
        <body>
            <div class="container">
                ...
                echo "<div class='navbar-form pull-right'><br>
                                ...
                                Jatuh Tempo :<input type='date' class='input-medium' id='tgljtempo' value='$jtempo'>
                      </div>";
                echo'<br><legend>Transaksi Penjualan Barang</legend>
                     <label>Pembeli/Customer</label>
                     <select class="selectpicker" data-style="btn-primary" id="kodesup"></select>
                     <input type="text" class="input-xlarge" id="namasup" placeholder="Nama pembeli" readonly>
                     ...
                     <input type="text" class="input-medium" id="nonota" placeholder="Catatan">
                     
                     <label>Kode</label>
    <input type="text" id="search-box" placeholder="Ketik Nama Barang" />
    <div id="suggesstion-box"></div>
     <input type="hidden" id="kode">';?>
     <? echo '<input type="text" class="input-xlarge" id="namabrg" placeholder="Nama Barang" readonly>
                     <input type="text" class="input-mini" id="stoktotal" placeholder="stok" class="span1">
                     <input type="text" class="input-mini" id="harga" placeholder="Harga" class="span3">
                     ...
                     <input type="date" class="input-small" id="kadaluwarsa" placeholder="ED" class="span1">
                    ...
                    echo"
                     <div id='hitungtotal' class='navbar-form pull-right'>
                                ...
                                Biaya lain : <input type='text'  class='input-mini' id='biayalain'>
                                Total : <input type='text'  class='input-small' id='total' readonly>
                      </div>
                     ";
                     echo '
                     <div id="note" class="navbar-form pull-right">
                        <input type="text" class="input-xxlarge" id="catatanfooter" placeholder="Potongan, PPN, Biaya tidak boleh kosong. Bila tdk ada, ketik 0" readonly>
                     </div>
                     ';
                echo '
