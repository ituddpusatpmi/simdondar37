		...
		var beli;
                ...
                $(function(){
                    ...
                    $("#tambah").click(function(){
                        ...
                        $.ajax({
                            url:"transaksi_beli_proses.php",
                            data:"op=tambah&kode="+kode+"&namabrg="+namabrg+"&harga="+harga+"&qtytransaksi="+qtytransaksi+"&diskonpersen="+diskonpersen+"&nolot="+nolot+"&kadaluwarsa="+kadaluwarsa+"&po="+po,
                            cache:false,
                            success:function(msg){
                                if(msg=="sukses"){
                                    $("#status").html("Ok");
			...
			beli	    =$("#beli").val();
                        ...
                        if(kodesup=="Supplier"){
                            alert("Pengirim/Suplier harus diisi");
                            exit();
                        }
                        if(po==""){
                            alert("Nomor PO (Order Pembelian) harus diisi");
                            exit();
                        }
                        if(nonota==""){
                            alert("Nomor referensi (No. Faktur pembelian dari supplier) harus diisi");
                            exit();
                        }
                        $.ajax({
                            url:"transaksi_beli_proses.php",
                            data:"op=proses&notrans="+notrans+"&tanggal="+tanggal+"&kodesup="+kodesup+"&prefix="+prefix+"&ppn="+ppn+"&potongan="+potongan+"&biayalain="+biayalain+"&hutang="+hutang+"&tgljtempo="+tgljtempo+"&nonota="+nonota+"&po="+po+"&beli="+beli,
                            cache:false,
                            success:function(msg){
                                if(msg=='sukses'){
                                    $("#status").html('Transaksi Pembelian/Penerimaan barang berhasil diproses');
                                    alert('Transaksi Pembelian/Penerimaan barang berhasil diproses');
                                    window.location='../pmilogistik.php?module=rincian_transaksi_beli&notrans='+notrans;
                                    exit();
                                }else{
            ...
            <div class="container">
                ...
                echo "<div class='navbar-form pull-right'>
                        <br>
                            ...
                            No. PO : <input type='text' class='input-small' id='po' placeholder='No. PO'>
			    <select name='beli' id='beli' style='width:80px'>
				<option value=0>Tempo</option>
				<option value=1>Lunas</option>
			</select>
                      </div>";
                echo'<br><legend>Transaksi Pembelian Barang</legend>
                     ...
                     <input type="text" class="input-medium" id="nonota" placeholder="No. Nota">
                ...
                echo '
                     <div class="form-actions">
                        <button class="btn-primary btn-large" id="proses">Proses Transaksi</button>
