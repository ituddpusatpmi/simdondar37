  ...
  <form name="transaksi" method="post" action="<?= $PHPSELF ?>">
    <table class="record" border="0" cellspacing="1" cellpadding="2" width=750 style="border-collapse:collapse">
      ...
      <table class="record" border="1" cellspacing="0" cellpadding="0" width=750 style="border-collapse:collapse">
        ...
        <td align=center>" . $dtrans['kode'] . "</td> 
        ...
        <tr class="record">
          <td colspan=7 align="right">Potongan</td>
        ...
        <tr class="record">
          <td colspan=7 align="right">Biaya</td>
    ...
    <table class="list" border="0" cellspacing="1" cellpadding="2" width=750 style="border-collapse:collapse">
      ...
      <tr>
        <td align="center" valign="top"><br><br><br><br><br><br><br></td>
        <td align="center" valign="top"></td>
        <td align="center" valign="top">Kepala Unit Donor Darah<br>PALANG MERAH INDONESIA<br>Provinsi DKI Jakarta</td>
      </tr>
      <tr>
        <td align="center" class="input"></td>
        <td align="center" class="input"></td>
        <td align="center" class="input">dr. Ni Ken Ritchie, M. Biomed</td>
      </tr>
    </table>
  </form>
</body>
<tfoot>
  <table width=750px style="margin-top: 100px;">
    <tr>
      <?
      $waktu = date('Y-m-d H:i:s'); ?>
      <td align=center><a href="javascript:window.print()">Waktu cetak <?= $waktu ?></a></td>
      <td align=center></td>
    </tr>
  </table>
</tfoot>