...
<h2 class="list">REKAP KOREKSI/PENYESUAIAN STOK BARANG</h2>
...
<?
    $data=mysql_query("select
		      ...
		      hstok_transaksi_detail.kode, hstok_transaksi_detail.qtykeluar, hstok_transaksi_detail.qtymasuk,
		      hstok.namabrg, hstok.satuan
...
<table class="list" cellpadding=5 cellspacing=1>
	...
	$masuk=number_format($data1['qtymasuk'],0,',','.');
	?>
	
	<tr class="record">
		<td align="right"><?=$no?>.</td>
		<td align="center"><?=$data1[tanggal]?></td>
		<td align="center"><a href=pmilogistik.php?module=rincian_transaksi&notrans=<?=$data1[notrans]?>><?=$data1[notrans]?></a></td>
