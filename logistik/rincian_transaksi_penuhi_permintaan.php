...
?>
<!--img src="img/permintaanbarang.jpg" width="100%"><br-->
<h2>RINCIAN TRANSAKSI PENGELUARAN PERMINTAAN BARANG</h2>
<body>
<form name="transaksi"  method="post" action="<?=$PHPSELF?>">
  <table class="record" border="0" cellspacing="1" cellpadding="2" width="100%">
    <tr>
	<td width=120>Bagian</td><td class="input" >: <?=$h[supplier]?></td>
	<td width=130>Nomor Transaksi</td><td width=150 class="input">: <a href="javascript:window.print()"><?=$h[notrans]?></a></td>
    </tr>
    <tr>
	...
	<td>No. Permintaan</td><td class="input">: <?=$h[noreferensi]?></td>
    </tr>
    <table class="record" border="1" cellspacing="0" cellpadding="4" width="100%">
      <tr class="field">
	<td align="center">No</td>
	<td align="center">Kode</td>
	<td align="center">Nama Barang</td>
    <td align="center">Nomor Lot</td>
    <td align="center">Expired</td>
	<td align="center">Jumlah<br>Minta</td>
	<td align="center">Jumlah<br>diberi</td>
	<td align="center">Total<br>Terpenuhi</td>
    ...
    while ($dtrans = mysql_fetch_assoc($detail)){
	  ...
	  $permintaan=mysql_fetch_assoc(mysql_query("select qtyorder,qtyterpenuhi from hstok_order_detail
						    where notrans='$h[noreferensi]' and kode='$dtrans[kode]'"));
	  ...
	  echo "<tr class=\"record\">
		...
		<td align=center>".$qtykeluar."</td>
		<td align=center>".$permintaan['qtyterpenuhi']."</td>
		<td align=left>".$dtrans['satuan']."</td>";
?>
		<td align=right><?=format_ribuan($dtrans['harga'])?></td>
		<td align=right><?=format_ribuan($dtrans['harga'] * $permintaan['qtyterpenuhi'])?></td>
<?	echo"
		</tr>";
  }
  if ($no<10){
