...
$("#suggesstion-box").hide();
    ...
    $.ajax({
        ...
        success:function(msg){
            ...
            <script>
                ...
                $(function(){
                    ...
                    $("#kode").load("transaksi_keluar_proses.php","op=ambilbarang");
                    $("#kodesup").load("transaksi_keluar_proses.php","op=ambilkodesupplier");
                    
                    //meload isi tabel
                    $("#barang").load("transaksi_keluar_proses.php","op=barang");
                    ...
                    $("#kode").change(function(){
                        ...
                        //lakukan pengiriman data
                        $.ajax({
                            url:"transaksi_keluar_proses.php",
                            data:"op=ambildata&kode="+kode,
                            cache:false,
                            success:function(msg){
                                data=msg.split("|");
                    ...
                    $("#proses").click(function(){
                        ...
                        if(kodesup=="Bagian"){
                            alert("Bagian yang menerima barang harus diisi");
                            exit();
                        }else if(nonota==""){
                            alert("Catatan pengeluaran barang harus diisi");
                            exit();
                        }
                        $.ajax({
                            url:"transaksi_keluar_proses.php",
                            ...
                            success:function(msg){
                                if(msg=='sukses'){
                                    $("#status").html('Transaksi Pengeluaran barang berhasil diproses');
                                    alert('Transaksi Pengeluaran barang berhasil diproses');
                                    window.location='../pmilogistik.php?module=rincian_transaksi_keluar&notrans='+notrans;
                                    exit();
                                }else{
        ...
        <body>
            <div class="container">
                ...
                echo'<legend>Transaksi Pengeluaran Barang ke Bagian di UDD</legend>
                     <label>Bagian</label>
                     ...
                     <input type="text" class="input-xlarge" id="nonota" placeholder="Catatan">
    ...
    <div id="suggesstion-box"></div>
     <input type="hidden" id="kode">
                     ...
                     <input type="date" class="input-large" id="kadaluwarsa" placeholder="ED" class="span2">
