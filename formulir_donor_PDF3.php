...
$notrans0=mysql_query("select * from antrian where transaksi='$_GET[trans]'");
$htrans0=mysql_query("select donorke from htransaksi where notrans='$_GET[trans]'");
...
$pdf->SetXY(10,18);
$pdf->Cell(0, 104, 'Donor yang ke :  '.$htrans[donorke].'          kali');
...
$pdf->SetFont('helvetica', 'B', 8);
$pdf->SetXY(128,64);
$pdf->Cell(10, 24,'  Jawaban  Diisi Petugas:',0, 10, 'L');
