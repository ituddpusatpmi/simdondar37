...
$pdf->SetXY(0,8);
$pdf->Cell(0, 13, 'Bukti Pengambilan Darah', 0,0,'C');

$kan=mysql_fetch_assoc(mysql_query("select * from dtranspermintaan where noform='$_GET[noform]'"));
$pdf->SetXY(0,14);
$pdf->SetFont('courier', '', 8);
//if ($_GET[yby]=='') $_GET[yby]=$bayar1[NamaOS];
$pdf->Cell(15, 12, 'Form',0,0,'L'); 
...
$pdf->SetXY(0,30);
$pdf->SetFont('courier', '', 8);
$pdf->Cell(15, 12, 'Bagian',0,0,'L'); 
$pdf->Cell(50, 12,': '.$bayar1[bagian], 0);

$pdf->SetXY(0,34);
$pdf->SetFont('courier', '', 8);
$pdf->Cell(15, 12, 'Komponen',0,0,'L'); 
$pdf->Cell(50, 12,': '.$_GET[jenisdarah].'('.$_GET[jmlkntng].')', 0);                                            

$jam=date("H:i:s");
$pdf->SetXY(0,42);
$pdf->SetFont('courier', '', 8);
$pdf->Cell(15, 12,'Sampel Diterima Pukul'. $jam,0,0,'L'); 
