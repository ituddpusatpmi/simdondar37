  ...
  <div class="row">
          ...
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              <div >
              <img src="../dist/img/monitor.png" width="75">
              </div><p>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              <div >
              <img src="../dist/img/web.png" width="75">
              </div><p>
        ...
        <div class="col-lg-4 mb-4">
          <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
              <div >
              <img src="../dist/img/volume.png" width="75">
              </div><p>
              ...
              <br>      
              <a href="panggilantrian_dokter.php"><button  class="btn btn-dark rounded-pill px-4 py-2"  >Antri Dokter</button>
              <a href="panggilantrian.php"><button  class="btn btn-warning rounded-pill px-4 py-2"  >Antri HB/Golda</button>
              </a>
            </div>
          </div>
        </div>
