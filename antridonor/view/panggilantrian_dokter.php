...
<?php
  ...
  //ANTRIAN PEMERIKSAAN
  $antri = mysqli_fetch_assoc(mysqli_query($con,"select * from v_panggilantri_dokter"));
  $daftar = mysqli_query($con,"select * from antrian where date(tgl) = curdate() AND dokter='0' limit 10");

  //UPDATE ANTRIAN
  if(isset($_POST['lanjutPA'])){
    $nomorPA = $_POST['nomorPA'];
    $updatepanggil = mysqli_query($con,"UPDATE antrian set  dokter='1'  where nomor='$nomorPA' AND tgl=curdate()");
    ?>
    <META http-equiv="refresh" content="0; url=panggilantrian_dokter.php"><?php
  }
...
<!--voice-->
        ...
        <audio id="suarabelsuarabelloket" src="../dist/sound/ruangdokter.MP3"  ></audio>
...
<div class="preloader flex-column justify-content-center align-items-center">
  ...
  <div class="row">
        	<div class="col-lg-4">
          <center><strong style="font-size: 25px;">PEMERIKSAAN DOKTER</strong></center>
						<ol class="breadcrumb">
...
?>
  ...
  <div class="row">
      ...
      <div class="col-lg-4" align="center">
        ...
        <a href="panggilantrian_dokter.php"><button  class="btn btn-light btn-sm" style=";box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 4px 8px 0 rgba(0, 0, 0, 0.19); height:50px;width:100px" >RELOAD ANTRIAN</button>
...
function mulai(){
	...
	?>  
		...
		setTimeout(function() {
          ...
          <?php 
            //$updatepanggil = mysqli_query($con,"UPDATE antrian set  dokter='1'  where nomor='$tcounter' AND tgl=curdate()");
          ?>
}
</script>
  </body>
