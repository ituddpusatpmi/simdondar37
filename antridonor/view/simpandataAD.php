...
$sql_upd = "INSERT INTO `pendonor` (`Kode`,`NoKTP`, `Nama`, `Alamat`, `Jk`, `Pekerjaan`, `TempatLhr`, `TglLhr`,
						 `Status`, `GolDarah`, `Rhesus`,`kelurahan`, `kecamatan`, `wilayah`,`telp2`, `umur`,`pencatat`,`tglkembali`,`jumDonor`)
						VALUES ('$kodep', '$ktp','$namap','$alamat','$jk','$pekerjaan','$tmp_lhr','$tgl_lhr',
						 '$nikah','$gol','$rh','$kel','$kec','$wil','$telp','$umur','$iduser','$tglkembali','$jmldnr')";
//echo $sql_upd;
...
?>
  ...
  <META http-equiv="refresh" content="0; url=form_donor.php?id=<?php echo $id_transaksi_baru; ?>">
<?php
}
mysqli_close()
?>
