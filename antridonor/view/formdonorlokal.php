...
<?php
  ...
  $kodep = $_GET['id'];
  $data =  mysqli_fetch_assoc(mysqli_query($con,"select * from pendonor where Kode='$kodep'"));
  //echo var_dump($data);
  ...
  <div class="row" align="center">
    ...
    <!--form input-->
      ...
      <div class="card card-primary card-tabs">
        ...
        <div class="card-body">
        <form action="simpandatalokal.php" method="post">
          <!--************************************TAB PAGE-->
          <div class="tab-content" id="custom-tabs-one-tabContent">
            ...
            <div class="col-lg-6">
              <div class="table-responsive">
                  <table width=100%>
                      <tr><td>Kode Pendonor</td>   <td class="warning"><input type="text" name="kodep" class="form-control" value=<?php echo $data['Kode'];?> readonly></td></tr>
                      <tr><td>No. KTP</td>         <td class="warning"><input type="text" name="ktp" class="form-control" value=<?php echo $data['NoKTP'];?>>
                      ...
                      <tr><td>Nama Pendonor</td>  <td class="warning text-danger"><strong><input type="text" name="namap" class="form-control" value="<?php echo $data['Nama'];?>"></strong></td></tr>
                      ...
                      <tr><td>Alamat</td>         <td class="warning"><input type="text" name="alamat" class="form-control" value="<?php echo $data['Alamat'];?>"></td></tr>
                      <tr><td>Keluarahan</td>     <td class="warning"><input type="text" name="kel" class="form-control" value="<?php echo $data['kelurahan'];?>"></td></tr>
                      <tr><td>Kecamatan</td>      <td class="warning"><input type="text" name="kec" class="form-control" value="<?php echo $data['kecamatan'];?>"></td></tr>
                      <tr><td>Wilayah</td>        <td class="warning"><input type="text" name="wil" class="form-control" value="<?php echo $data['wilayah'];?>"></td></tr>
            ...
            <div class="col-lg-6">
              <div class="table-responsive">
                <table width=100%>
                  <tr><td>No. Handphone</td>           <td class="warning"><input type="text" name="telp" class="form-control" value="<?php echo $data['telp2'];?>"></td></tr>   
                  <tr><td>Tempat Lahir</td>      <td class="warning"><input type="text" name="tmp_lhr" class="form-control" value="<?php echo $data['TempatLhr'];?>"></td></tr>     
                  <tr><td>Tanggal Lahir</td>      <td class="warning"><input type="text" name="tgl_lhr" id="datepicker" style="width:4cm;height:0.75cm" class="form-control" value="<?php echo $data['TglLhr'];?>"></td></tr>     
            ...
            <div class="tab-pane fade" id="ic" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
             ...
             <div class="row">
                            <div class="col-lg-6">
                                <div class="table-responsive" id="shadow1">
                                    <table class="diva">
                                        ...
                                        <tr><td width="30px">1</td><td>Merasa sehat pada hari ini? (tidak sedang flu/batuk/demam/pusing)</td>
                                        ...
                                        <tr><td colspan=3 style="color:blue"><b>Dalam 48 jam</b></td></tr> 
                                        ...
                                        <tr><td colspan=3 style="color:blue"><b>(Untuk Wanita) Dalam 6 minggu terakhir</b></td></tr> 
                                        <tr><td width="30px">6</td><td>Apakah saat ini Anda sedang Hamil?</td>
                                        <td><div class="onoffswitch">
                            ...
                            <div class="col-lg-6">
                                <div class="table-responsive" id="shadow1">
                                    <table class="diva">
                                    <tr><td colspan=3 style="color:blue"><b>Dalam 8 minggu terakhir</b></td></tr> 
                                        ...
                                        <tr><td width="30px">8</td><td>Apakah anda menerima vaksinasi atau suntikan lainnya?</td>
                                        <td><div class="onoffswitch">
                                        ...
                                        <tr><td width="30px">9</td><td>Apakah anda pernah kontak dengan orang yang pernah menerima vaksinasi smallpox?</td>
                                        <td><div class="onoffswitch">
                                        ...
                                        <tr><td colspan=3 style="color:blue"><b>Dalam 16 minggu terakhir</b></td></tr> 
                                        ...
                                        <tr><td colspan=3 style="color:blue"><b>Dalam 6 bulan terakhir</b></td></tr>  
                                        ...
                                        <tr><td colspan=3 style="color:blue"><b>Dalam 12 bulan terakhir</b></td></tr> 
              ...
              <!--************************************Kuesioner2-->   
                ...
                <div class="row">
                            <div class="col-lg-6">
                                <div class="table-responsive" id="shadow1">
                                    ...
                                    <tr><td colspan=3 style="color:blue"><b>Dalam 12 bulan terakhir</b></td></tr> 
                                        ...
                                        <tr><td width="30px">16</td><td>Apakah anda pernah berhubungan seksual dengan orang dengan HIV/AIDS ?</td>
                                        <td><div class="onoffswitch">
                            ...
                            <div class="col-lg-6">
                                <div class="table-responsive" id="shadow1">
                                    <table class="diva">
                                    <tr><td colspan=3 style="color:blue"><b>Dalam 1 tahun terakhir</b></td></tr> 
                                        ...
                                        <tr><td width="30px">20</td><td><b>Donor Wanita</b>, Apakah anda pernah berhububgan seks dengan laki-laki biseksual?</td>
                                        <td><div class="onoffswitch">
                            ...
                            <div class="col-lg-6">
                                <div class="table-responsive" id="shadow1">
                                    ...
                                    <tr><td width="30px">25</td><td>Apakah anda sedang atau pernah mendapatkan pengobatan Sifilis atau GO (Kencing Nanah)?</td>
                                        ...
                                        <tr><td colspan=3 style="color:blue"><b>Dalam 3 tahun terakhir</b></td></tr> 
                                        ...
                                        <tr><td colspan=3 style="color:blue"><b>Tahun 1980 hingga sekarang</b></td></tr>
                                        <tr width="30px"><td width="30px">29</td><td>Apakah anda tinggal selama 5 tahun atau lebih di Eropa?</td>
                                        <td><div class="onoffswitch">
                                        ...
                                        <tr width="30px"><td>30</td><td>Apakah anda pernah menerima transfusi darah di Inggris?</td>
                                        <td><div class="onoffswitch">
                            ...
                            <div class="col-lg-6">
                                <div class="table-responsive" id="shadow1">
                                    ...
                                    <tr><td colspan=3 style="color:blue"><b>Dari tahun 1980 sampai dengan 1996</b></td></tr> 
                                        ...
                                        <tr><td width="30px">32</td><td>Apakah Anda pernah menerima uang, obat, atau pembayaran lainnya untuk seks?</td>
                                        <td><div class="onoffswitch">
                                        ...
                                        <tr><td width="30px">33</td><td><b>Laki-laki : </b>Apakah Anda pernah berhubungan seksual<br>dengan laki-laki, walaupun sekali?</td>
                                        <td><div class="onoffswitch">
                                        ...
                                        <tr><td width="30px">34</td><td>Apakah anda pernah mendapat hasil Positif untuk test HIV/AIDS?</td>
                                        <td><div class="onoffswitch">
                                        ...
                                        <tr width="30px"><td>36</td><td>Menggunakan jarum suntik untuk obat-obatan, Steroid yang tidak diresepkan dokter?</td>
                                        <td><div class="onoffswitch">
                ...
                <div class="row">
                            <div class="col-lg-6">
                                <div class="table-responsive" id="shadow1">
                                    <table class="diva">
                                    <tr><td width="30px">37</td><td>Menggunakan konsentrat faktor pembekuan?</td>
                                        <td><div class="onoffswitch">
                                        ...
                                        <td><div class="onoffswitch">
                                            ...
                                            <tr><td width="30px">41</td><td>Apakah anda Bermasalah dengan jantung dan paru-paru ?</td>
                                        <td><div class="onoffswitch">
                                        ...
                                        <tr><td width="30px">42</td><td>Apakah anda Menderita pendarahan atau penyakit berhubungan dengan darah ?</td>
                                        <td><div class="onoffswitch">
                                        ...
                                        <tr><td width="30px">43</td><td>Berhubungan seksual dengan orang yang tinggal di Afrika?</td>
                                        <td><div class="onoffswitch">
                                            ...
                                            <tr><td width="30px">44</td><td>Pernah tinggal di Afrika?</td>
                                        <td><div class="onoffswitch">
                                                    <input type="hidden" name="no44" value="TIDAK">
                                                    <input type="checkbox" name="no44" class="onoffswitch-checkbox" id="no44" tabindex="1" value="YA" >
