...
$sql="update laporan set tgl_form='$tgl_form',formulir='$formulir',kembali_a='$kembali_a',kembali_b='$kembali_b',kembali_ab='$kembali_ab',kembali_o='$kembali_o',
keluar_a='$keluar_a',keluar_b='$keluar_b',keluar_ab='$keluar_ab',keluar_o='$keluar_o',kembali_a2='$kembali_a2',kembali_b2='$kembali_b2',kembali_ab2='$kembali_ab2',
kembali_o2='$kembali_o2',keluar_a2='$keluar_a2',keluar_b2='$keluar_b2',keluar_ab2='$keluar_ab2',keluar_o2='$keluar_o2',kembali_a3='$kembali_a3',
kembali_b3='$kembali_b3',kembali_ab3='$kembali_ab3',kembali_o3='$kembali_o3',keluar_a3='$keluar_a3',keluar_b3='$keluar_b3',keluar_ab3='$keluar_ab3',
keluar_o3='$keluar_o3',kembali_a4='$kembali_a4',kembali_b4='$kembali_b4',kembali_ab4='$kembali_ab4',kembali_o4='$kembali_o4',keluar_a4='$keluar_a4',
keluar_b4='$keluar_b4',keluar_ab4='$keluar_ab4',keluar_o4='$keluar_o4',kembali_a5='$kembali_a5',kembali_b5='$kembali_b5',kembali_ab5='$kembali_ab5',
kembali_o5='$kembali_o5',keluar_a5='$keluar_a5',keluar_b5='$keluar_b5',keluar_ab5='$keluar_ab5',keluar_o5='$keluar_o5',kembali_a6='$kembali_a6',
kembali_b6='$kembali_b6',kembali_ab6='$kembali_ab6',kembali_o6='$kembali_o6',keluar_a6='$keluar_a6',keluar_b6='$keluar_b6',keluar_ab6='$keluar_ab6',
keluar_o6='$keluar_o6',kembali_a7='$kembali_a7',kembali_b7='$kembali_b7',kembali_ab7='$kembali_ab7',kembali_o7='$kembali_o7',keluar_a7='$keluar_a7',
keluar_b7='$keluar_b7',keluar_ab7='$keluar_ab7',keluar_o7='$keluar_o7',petugas='$petugas',keterangan='$keterangan' where id='$id'";
