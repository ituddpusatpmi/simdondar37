...
<form name="cari" method="POST" action="<?echo $PHPSELF?>">
    ...
    <table id="serahterima"  style="border-collapse: collapse;border: 2px solid #808080;box-shadow: 1px 2px 2px #000000;">
        <tr style="font-size: 12px">
            ...
            <th style="height: 40px;text-align: center;font-weight: bold">Waktu</th>
            <th style="height: 40px;text-align: center;font-weight: bold">Asal</th>
            <th style="height: 40px;text-align: center;font-weight: bold">Petugas</th>
            <th style="height: 40px;text-align: center;font-weight: bold">Kode Alat</th>
            <th style="height: 40px;text-align: center;font-weight: bold">Suhu</th>
            <th style="height: 40px;text-align: center;font-weight: bold">Keadaan<br>umum</th>
            <th style="height: 40px;text-align: center;font-weight: bold">Jumlah</th>
            <th style="height: 40px;text-align: center;font-weight: bold">Cetak Formulir<br>Serah Terima</th>
	    <th style="height: 40px;text-align: center;font-weight: bold">Lihat</th>	
        </tr>
        <?php
        $no=0;
	...
	$jmltotal=0;
        while ($tmp=mysql_fetch_assoc($sql)){
            ...
            <tr style="font-size: 12px;height: 30px;">
                ...
                <td><a href="pmiaftap.php?module=sr_rpt_ktg&no=<?=$tmp['hst_notrans']?>">Kantong</a> |
                    <a href="pmiaftap.php?module=sr_rpt_imltd&no=<?=$tmp['hst_notrans']?>">IMLTD</a> |
                    <a href="pmiaftap.php?module=sr_rpt_kgd&no=<?=$tmp['hst_notrans']?>">KGD</a> |
                    <a href="pmiaftap.php?module=sr_rpt_nat&no=<?=$tmp['hst_notrans']?>">NAT</a>
                </td>
		<td><a href="pmiaftap.php?module=sr_rpt_view&no=<?=$tmp['hst_notrans']?>">Lihat</a></td>
            </tr>
            <?php
