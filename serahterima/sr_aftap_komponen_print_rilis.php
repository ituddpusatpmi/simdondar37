...
<table class="list" border="0" cellpadding="2" cellspacing="2" width="100%" style="border-collapse:collapse">
    ...
    <tr style="font-family: 'trebuchet ms', Impact, Arial, Helvetica, sans-serif;font-size: 11px;">
        <td style="text-align: left">Formulir Serah Terima Kantong Darah</td>
...
<table class="list" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
    <tr>
        <td style="height: 40px;font-size: 16px;font-weight: bold; text-align: center; font-family: 'trebuchet ms', Impact, Arial, Helvetica, sans-serif;" colspan="2">SERAH TERIMA KANTONG DARAH</td>
    </tr>
    <tr style="font-size:12px; color:#000000; font-family:'trebuchet ms', Impact, Arial, Helvetica, sans-serif;">
        <td style="vertical-align: top; width=50%;">
            <table class="list" border=1 cellpadding="2" cellspacing="2" width="100%" style="border-collapse:collapse">
                ...
                <tr><td style="text-align: left">Bagian yang menerima</td>       <td><?php echo $sql_h1['hst_bagpenerima']; ?></td></tr>
          </table>
        </td>
        <td style="vertical-align: top;width=50%">
            <table class="list" border=1 cellpadding="2" cellspacing="2" width="100%" style="border-collapse:collapse">
...
<?
$sql_d="SELECT `dst_iddetail`, `dst_no_aftap`, `dst_tglaftap`, `dst_notrans`, `dst_nokantong`,`dst_produk`,
        CASE
        ...
        `dst_umur`, `dst_lama_aftap`, `dst_statuspengambilan`, `dst_ptgaftap`, `dst_volambil`
	,hpengolahan.`user`,hpengolahan.RC FROM `serahterima_detail` 
	INNER JOIN hpengolahan ON serahterima_detail.dst_nokantong = hpengolahan.noKantong
        WHERE `dst_notrans`='$notransaksi' ORDER BY `dst_produk` ASC";
//echo "$sql_d<br>";
...
$sq_k="SELECT  `dst_produk`,
    ...
    FROM `serahterima_detail` WHERE `dst_notrans`='$notransaksi' group by `dst_produk`";
...
while ($sq_k1=mysql_fetch_assoc($sqk)){
    ...
    switch ($sq_k1['dst_produk']){
        case 'WB':$jenis='WB';break;
        case 'PRC':$jenis='PRC';break;
        case 'LP':$jenis='LP';break;
        case 'TC':$jenis='TC';break;
        case 'FFP':$jenis='FFP';break;
	case 'BC':$jenis='BC';break;
        case 'WE':$jenis='WE';break;
        case 'AHF':$jenis='AHF';break;
        default:$jenis="--";
    }?>
    <tr style="font-size:12px; color:#000000; font-family:'trebuchet ms', Impact, Arial, Helvetica, sans-serif;">
        <td style="text-align: right;"> <?php echo $no.'.';?> </td>
...
$usr        = mysql_fetch_assoc(mysql_query("select `nama_lengkap` from `user` where `id_user`='$sql_h1[hst_penerima]'"));
    ...
    <tr style="font-size:14px; color:#000000; font-family:'trebuchet ms', Impact, Arial, Helvetica, sans-serif;">
        ...
        <td rowspan="3" style="vertical-align:top;">
            <ol style="font-size:10px; color:#000000; font-family:'trebuchet ms', Impact, Arial, Helvetica, sans-serif;">
                <li>Jenis Kantong Darah = BS : Kantong Single; DB : Kantong Double; TR: Kantong Triple, QD:Kantong Quadruple; PB: Kantong Pediatrik</li>
...
<? switch ($_SESSION[leveluser]){
				case "aftap":
					...
					break;
				case "komponen":
					echo "<meta http-equiv='refresh' content='2;url=pmikomponen.php?module=sr_aftap_list'";
					break;
				case "qa":
					echo "<meta http-equiv='refresh' content='2;url=pmiqa.php?module=sr_aftap_list'";
					break;
				default:
					echo "<meta http-equiv='refresh' content='2;url=pmilaboratorium.php?module=sr_aftap_list'";
				}?>
</body>
