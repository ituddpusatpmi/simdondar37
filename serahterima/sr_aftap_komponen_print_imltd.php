...
<table class="list" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-collapse:collapse">
    <tr>
        <td style="height: 40px;font-size: 16px;font-weight: bold; text-align: center; font-family: 'trebuchet ms', Impact, Arial, Helvetica, sans-serif;" colspan="2">SERAH TERIMA SAMPEL DARAH IMLTD</td>
    </tr>
    <tr style="font-size:12px; color:#000000; font-family:'trebuchet ms', Impact, Arial, Helvetica, sans-serif;">
        <td style="vertical-align: top; width=50%;">
            <table class="list" border=1 cellpadding="2" cellspacing="2" width="100%" style="border-collapse:collapse">
                ...
                <tr><td style="text-align: left">Bagian yang menerima</td>       <td> UJI SARING IMLTD</td></tr>
          </table>
        </td>
        <td style="vertical-align: top;width=50%">
            <table class="list" border=1 cellpadding="2" cellspacing="2" width="100%" style="border-collapse:collapse">
...
$sql_d="SELECT `dst_iddetail`, `dst_no_aftap`, `dst_tglaftap`, `dst_notrans`, `dst_nokantong`,
        ...
        `dst_umur`, `dst_lama_aftap`, `dst_statuspengambilan`, `dst_ptgaftap`, `dst_volambil`,simltd,skgd,snat,packing,label,splasma,sserum,swb,volket,lisis,dokumen,infoklinis FROM `serahterima_detail`
...
<table class="list" border=1 cellpadding="2" cellspacing="2" width="100%" style="border-collapse:collapse">
    ...
    <tr style="background-color: #DCDCDC;font-wight:bold; font-size:14px; color:#000000; font-family:'trebuchet ms', Impact, Arial, Helvetica, sans-serif;">
        <th style="text-align: center; height: 40px" rowspan=2>No</th>
        <th style="text-align: center; height: 40px" rowspan=2>Nomor<br>Sample</th>
	<th style="text-align: center; height: 40px" rowspan=2>Gol</th>
        <th style="text-align: center; height: 40px" rowspan=2>Rh</th>
	<th style="text-align: center; height: 40px" rowspan=2>Sample<br>IMLTD</th>
	<th style="text-align: center; height: 40px" rowspan=2>Sample<br>KGD/ABS</th>
        <th style="text-align: center; height: 40px" rowspan=2>Sample<br>NAT</th>
	<th style="text-align: center; height: 40px" rowspan=2>Pengepakan</th>
	<th style="text-align: center; height: 40px" rowspan=2>Label</th>
        <th style="text-align: center; height: 40px" colspan=3>Jenis Sample</th>
        <th style="text-align: center; height: 40px" rowspan=2>Volume<br>Sample</th>
        <th style="text-align: center; height: 40px" rowspan=2>Kondisi<br>Sample</th>
	<th style="text-align: center; height: 40px" rowspan=2>Dokumen<br>Sample</th>
	<th style="text-align: center; height: 40px" rowspan=2>Info<br>Klinis</th>
	<th style="text-align: center; height: 40px" rowspan=2>Hasil</th>
    </tr>
	<tr>
	<th style="text-align: center; height: 40px">Plasma</th>
	<th style="text-align: center; height: 40px">Serum</th>
	<th style="text-align: center; height: 40px">WB</th>
    </thead>
    <tbody>
    <?
    $no=0;
    while ($sgd=mysql_fetch_assoc($sql_d1)){
		...
		<?if ($sgd['simltd']=='1'){?><td align="center">&radic;</td><?}else{?><td align="center" bgcolor="red"><font color="white">X</font></td><?}?>
		<?if ($sgd['skgd']=='1'){?><td align="center">&radic;</td><?}else{?><td align="center" bgcolor="red"><font color="white">X</font></td><?}?>
		<?if ($sgd['snat']=='1'){?><td align="center">&radic;</td><?}else{?><td align="center" bgcolor="red"><font color="white">X</font></td><?}?>
		<?if ($sgd['packing']=='1'){?><td align="center">Baik</td><?}else{?><td align="center" bgcolor="red"><font color="white">Rusak</font></td><?}?>
		<?if ($sgd['label']=='1'){?><td align="center">Sesuai</td><?}else{?><td align="center" bgcolor="red"><font color="white">Tdk Sesuai</font></td><?}?>
		<?if ($sgd['splasma']=='1'){?><td align="center">&radic;</td><?}else{?><td align="center" >-</td><?}?>
		<?if ($sgd['sserum']=='1'){?><td align="center">&radic;</td><?}else{?><td align="center" >-</td><?}?>
		<?if ($sgd['swb']=='1'){?><td align="center">&radic;</td><?}else{?><td align="center" >-</td><?}?>
		<?if ($sgd['volket']=='1'){?><td align="center">Cukup</td><?}else{?><td align="center" bgcolor="red"><font color="white">Kurang</font></td><?}?>
		<?if ($sgd['lisis']=='1'){?><td align="center">Baik</td><?}else{?><td align="center" bgcolor="red"><font color="white">Lisis</font></td><?}?>
		<?if ($sgd['dokumen']=='1'){?><td align="center">Ada</td><?}else{?><td align="center" bgcolor="red"><font color="white">Tdk Ada</font></td><?}?>
		<?if ($sgd['infoklinis']=='1'){?><td align="center">Ada</td><?}else{?><td align="center">Tdk ada</td><?}?>	
...
while ($sq_k1=mysql_fetch_assoc($sqk)){
    ...
    switch ($sq_k1['dst_lamabaru']){
        case 0:$jenis1='Donor Baru';break;
        case 1:$jenis1='Donor Ulang';break;
    }?>
    <tr style="font-size:12px; color:#000000; font-family:'trebuchet ms', Impact, Arial, Helvetica, sans-serif;">
        <td style="text-align: right;"> <?php echo $no.'.';?> </td>
...
if($lvl0=='aftap'){
 ...
 echo "<meta http-equiv='refresh' content='2;url=pmi$lvl0.php?module=sr_list'";
}
?>
</body>
