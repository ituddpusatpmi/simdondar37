...
<h1 class="table">FORM REGISTRASI PENDONOR ||
<input type="button" value="SEARCH PENDONOR" onClick="document.location.href='pmip2d2s.php?module=search_pendonor';"></h1>
...
<h1 class="table">FORM REGISTRASI PENDONOR ||
<input type="button" value="SEARCH PENDONOR" onClick="document.location.href='pmilaboratorium.php?module=search_pendonor';"></h1>
<? } else { ?>
<h1 class="table">FORM REGISTRASI PENDONOR ||
