...
var valid_kantong0;
		function addRow(tableID) {
			...
			element5.innerHTML = jenis_kantong0; 
...
*/
			...
			var element55 = document.createElement("option");
			element55.value = "Leucodepleted";
			element55.innerHTML = "Leucodepleted";
			element5.appendChild(element55);
			...
			var element542 = document.createElement("option");
			element542.value = "AHF";
			element542.innerHTML = "AHF";
			element5.appendChild(element541);
			...
			var element542 = document.createElement("option");
			element542.value = "BC";
			element542.innerHTML = "BUFFYCOAT";
			element5.appendChild(element542);
