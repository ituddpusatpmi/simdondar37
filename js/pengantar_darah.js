...
function cari_form(){
    ...
    $.ajax({
        url: "json_pengantar.php?no_form="+no_form,
        async: false,
        dataType: 'json',
	...
	if (no_form1==''){
        alert("Formulir tidak ditemukan , Silahkan cek kembali nomor formulir");
...
function cari_kantong(tableID){
    ...
    $.ajax({
        url: "cek_kantong_pengantar.php?no_label="+no_label+"&noform="+noform,
        async: false,
        dataType: 'json',
        success: function(json) {
			...
			metodecross = json.kantong.metodecross;
			tglcross = json.kantong.tgl_cross;
			statuscross = json.kantong.statuscross;
			ketcross = json.nokantong.ketcross;
	    ...
	    createCookie('metode',metodecross,7);
            createCookie('tgl_cross',tglcross,7);
            createCookie('status_cross',statuscross,7);
	    createCookie('ket_cross',ketcross,7);
		}
    });
	if (no_label1!=''){
	    var i;
...
function addRow(tableID) {
	...
	var cell4 = row.insertCell(5);
        ...
        var metode = readCookie('metode');
		element4.type = "text";
		element4.size = "8";
		element4.name = "metode[]";
        element4.value = metode;
	...
	var cell6 = row.insertCell(7);
		...
		/*var element8 = document.createElement("option");
            element8.value = "Autocontrol Positif";
            element8.innerHTML = "Autocontrol Positif";
