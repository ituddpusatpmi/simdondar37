...
$count=mysqli_fetch_array(mysqli_query($dbi,"select count(*) as total from v_mu"));
$jmldata = $count['total'];
$qm="select * from v_mu limit ".$awal.", ".$mu_max_row;
...
$display .='
    <table style="width:100%;border-collapse: collapse;">
          <tr style="height:'.$mu_thead_padding.'px;font-size:'.$mu_thead_fontsize.'px;">
            ...
            <th style="border:0.5px solid '.$mu_thead_fontcolor.';background-color:'.$mu_thead_backcolor.';color :'.$mu_thead_fontcolor.';width:60px;">TGL</th>
...
if ($end_row<$mu_max_row){
    ...
    $qm2="select * from v_mu limit 0 ,".$end_row;
        ...
        if ($datenow==$mu2['TglPenjadwalan']){
            ...
            '
                <tr style="height:'.$mu_row_height.'px;background-color:'.$mu_row_backhightlight.';font-size:'.$mu_row_fontsize.'px;color:'.$mu_row_fonthightlight.';">
                    ...
                    <td style="border:0.5px solid '.$mu_row_linecolor.';text-align:center;white-space: nowrap;padding:'.$mu_row_padding.';px">'.$mu2['tanggal'].'</td>
