...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['hapus_id'])) {
	$id = intval($_POST['hapus_id']); // hindari SQL Injection
	$query = "DELETE FROM master_kantong WHERE id = $id";
    ...
    <div class="container-fluid">
        <div class="table-container mt-4">
            ...
            <div class="table-responsive">
                <div class="d-flex justify-content-between mb-3">
                    <div>
                        <button type="button" class="btn btn-tambah" data-bs-toggle="modal"
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <form method="post" onsubmit="return confirm('Yakin ingin menghapus data ini?')">
                                    <input type="hidden" name="hapus_id" value="<?php echo $tmp['id']; ?>">
        ...
        <div class="modal fade" id="detailModal" tabindex="-1" aria-labelledby="detailModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div
                        class="modal-header bg-modal-detail text-white d-flex justify-content-between align-items-start">
                        <div>
        ...
        <div class="modal fade" id="tambahModal" tabindex="-1" aria-labelledby="tambahModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div
                        class="modal-header bg-modal-tambah text-white d-flex justify-content-between align-items-start">
                        <div>
                        ...
                        <form id="tambahForm">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-2">
                                    ...
                                    <select class="form-select" id="anticoagulant_name" name="anticoagulant_name"
                                        required>
                                ...
                                <div class="col-md">
                                    ...
                                    <input type="text" class="form-control" id="licenseby" name="licenseby"
                                        maxlength="100">
                                </div>
                            </div>
                            <div class="row mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-2">
                                    ...
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="pr_utama"
                                        name="pr_utama" oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-2">
                                    <label for="pr_s1" class="form-label">Satelit 1</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="pr_s1"
                                        name="pr_s1" oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="pr_s2" class="form-label">Satelit 2</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="pr_s2"
                                        name="pr_s2" oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="pr_s3" class="form-label">Satelit 3</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="pr_s3"
                                        name="pr_s3" oninput="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <label for="pr_s4" class="form-label">Satelit 4</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="pr_s4"
                                        name="pr_s4" oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="pr_s5" class="form-label">Satelit 5</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="pr_s5"
                                        name="pr_s5" oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="pr_s6" class="form-label">Satelit 6</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="pr_s6"
                                        name="pr_s6" oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="pr_s7" class="form-label">Satelit 7</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="pr_s7"
                                        name="pr_s7" oninput="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
						...
						<div class="mb-3">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md">
                                    ...
                                    <input type="text" class="form-control" id="editAntikoagulant"
                                        name="editAntikoagulant" pattern="[0-9]+(\.[0-9]+)?" required>
                                </div>
                            </div>
                            <div class="row mb-3">
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-2">
                                    ...
                                    <input type="date" class="form-control" id="editEvUtdptanggal"
                                        name="editEvUtdptanggal">
                                </div>
                                <div class="col-md-2">
                            ...
                            <div class="row">
                                <div class="col-md-3 mb-2">
                                    ...
                                    <input type="text" class="form-control produk-tagify text-uppercase"
                                        id="edit_pr_utama" name="edit_pr_utama"
                                        oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-2">
                                    <label for="edit_pr_s1" class="form-label">Satelit 1</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="edit_pr_s1"
                                        name="edit_pr_s1" oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="edit_pr_s2" class="form-label">Satelit 2</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="edit_pr_s2"
                                        name="edit_pr_s2" oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="edit_pr_s3" class="form-label">Satelit 3</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="edit_pr_s3"
                                        name="edit_pr_s3" oninput="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3 mb-3">
                                    <label for="edit_pr_s4" class="form-label">Satelit 4</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="edit_pr_s4"
                                        name="edit_pr_s4" oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="edit_pr_s5" class="form-label">Satelit 5</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="edit_pr_s5"
                                        name="edit_pr_s5" oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="edit_pr_s6" class="form-label">Satelit 6</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="edit_pr_s6"
                                        name="edit_pr_s6" oninput="this.value = this.value.toUpperCase();">
                                </div>
                                <div class="col-md-3 mb-3">
                                    <label for="edit_pr_s7" class="form-label">Satelit 7</label>
                                    <input type="text" class="form-control produk-tagify text-uppercase" id="edit_pr_s7"
                                        name="edit_pr_s7" oninput="this.value = this.value.toUpperCase();">
                                </div>
                            </div>
            ...
            document.querySelectorAll(".klik-merk").forEach(el => {
                el.addEventListener("click", function() {
                    ...
                    document.getElementById('isiDetail').innerHTML =
                        "Memuat data detail merk: <b>" + merk + "</b>...";
                    modal.show();
                    ...
                    fetch(`release/ambilBeratKantong.php?id=${id}`)
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                document.getElementById("editJenis").value = data.data
                                    .jenis;
                                document.getElementById("editJenisHidden").value = data.data
                                    .jenis;
                                ...
                                document.getElementById("editMerkHidden").value = data.data
                                    .merk;
                                document.getElementById("editLamaBuka").value = data.data
                                    .lama_buka;
                                document.getElementById("editVolume").value = data.data.vol;
                                document.getElementById("editBeratKU").value = data.data
                                    .berat_ku;
                                document.getElementById("editAntikoagulant").value = data
                                    .data.antikoagulant;
                                document.getElementById("editNamaKantong").value = data.data
                                    .namakantong;
                                document.getElementById("editCompany").value = data.data
                                    .company;
                                document.getElementById("editComposition").value = data.data
                                    .composition;
                                document.getElementById("editTexture").value = data.data
                                    .texture;
                                document.getElementById("editAnticoagulantName").value =
                                    data.data.anticoagulant_name;
                                document.getElementById("editStandardBag").value = data.data
                                    .standard_bag;
                                document.getElementById("editStandardAcd").value = data.data
                                    .standard_acd;
                                document.getElementById("editLicense").value = data.data
                                    .license;
                                document.getElementById("editLicenseby").value = data.data
                                    .licenseby;
                                document.getElementById("editDimensiTinggi").value = data
                                    .data.dimensi_tinggi;
                                document.getElementById("editDimensiLebar").value = data
                                    .data.dimensi_lebar;
                                document.getElementById("editPanjangSelang").value = data
                                    .data.panjang_selang;
                                document.getElementById("editBeratKeseluruhan").value = data
                                    .data.berat_keseluruhan;
                                document.getElementById("editEvUtdptanggal").value = data
                                    .data.ev_utdptanggal;
                                document.getElementById("editEvUtdpnomor").value = data.data
                                    .ev_utdpnomor;
                                document.getElementById("editExpired").value = data.data
                                    .expired;

                                // Berat satelit
                                document.getElementById("edit_berat_s1").value = data.data
                                    .berat_s1;
                                document.getElementById("edit_berat_s2").value = data.data
                                    .berat_s2;
                                document.getElementById("edit_berat_s3").value = data.data
                                    .berat_s3;
                                document.getElementById("edit_berat_s4").value = data.data
                                    .berat_s4;
                                document.getElementById("edit_berat_s5").value = data.data
                                    .berat_s5;
                                document.getElementById("edit_berat_s6").value = data.data
                                    .berat_s6;
                                document.getElementById("edit_berat_s7").value = data.data
                                    .berat_s7;

                                // Produk satelit
                                document.getElementById("edit_pr_utama").value = data.data
                                    .pr_utama;
                                document.getElementById("edit_pr_s1").value = data.data
                                    .pr_s1;
                                document.getElementById("edit_pr_s2").value = data.data
                                    .pr_s2;
                                document.getElementById("edit_pr_s3").value = data.data
                                    .pr_s3;
                                document.getElementById("edit_pr_s4").value = data.data
                                    .pr_s4;
                                document.getElementById("edit_pr_s5").value = data.data
                                    .pr_s5;
                                document.getElementById("edit_pr_s6").value = data.data
                                    .pr_s6;
                                document.getElementById("edit_pr_s7").value = data.data
                                    .pr_s7;
                            } else {
                ...
                tagify.on("input", e => {
                    ...
                    fetch(`release/mProduk.php?term=${encodeURIComponent(value)}`)
                        ...
                        .then(suggestions => {
                            ...
                            const currentValues = tagify.value.map(item => item.value
                                .toUpperCase());

                            // Filter agar yang sudah dipilih tidak muncul lagi
                            const filtered = suggestions
                                .map(item => item.Nama)
                                .filter(nama => !currentValues.includes(nama
                                    .toUpperCase()));
