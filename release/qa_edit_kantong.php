...
if ((isset($_POST['submit'])) and ($_POST['berat_ku'] !== "")) {
    ...
    $sql1 = mysqli_query($dbi, $sql);
    $sq10 = mysqli_fetch_assoc($sql1);
    ?>
    ...
    <form name="setting" method="post" action="">
        <table class="form" cellspacing="1" cellpadding="0" border="1">
            <tr>
                ...
                <td style="font-size: 15px"><?php echo $sq10['merk'] ?></td>
                <input type="hidden" name="merk" value="<?php echo $sq10['merk'] ?>">
            </tr>
            <tr>
                <td style="font-size: 15px">Lama Buka Kantong</td>
                <td class="input"><input name="lama_buka" type="text" size="5" value="<?php echo $sq10['lama_buka'] ?>"> Hari</td>
            </tr>
            <tr>
                <td style="font-size: 15px">JENIS KANTONG</td>
                <td style="font-size: 15px"><?php echo $sq10['jeniskantong'] ?></td>
                <input type="hidden" name="jenis" value="<?php echo $sq10['jeniskantong'] ?>">
            </tr>
            <tr>
                <td style="font-size: 15px">Volume</td>
                <td class="input"><input name="vol" type="text" size="15" value="<?php echo $sq10['vol'] ?>"></td>
            </tr>
            <tr>
                <td style="font-size: 15px">Antikoagulant</td>
                <td class="input"><input name="acd" type="text" size="15" value="<?php echo $sq10['antikoagulant'] ?>"></td>
            </tr>
            <tr>
                <td style="font-size: 15px">Barat Kantong Utama</td>
                <td class="input"><input name="berat_ku" type="text" size="10" value="<?php echo $sq10['berat_ku'] ?>"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="input"><input name="berat_s1" type="text" size="10" value="<?php echo $sq10['berat_s1'] ?>"></td>
            </tr>
            <tr>
                <td style="font-size: 15px">Satelite 2</td>
                <td class="input"><input name="berat_s2" type="text" size="10" value="<?php echo $sq10['berat_s2'] ?>"></td>
            </tr>
            <tr>
                <td style="font-size: 15px">Satelite 3</td>
                <td class="input"><input name="berat_s3" type="text" size="10" value="<?php echo $sq10['berat_s3'] ?>"></td>
            </tr>
            <tr>
                <td style="font-size: 15px">Satelite 4</td>
                <td class="input"><input name="berat_s4" type="text" size="10" value="<?php echo $sq10['berat_s4'] ?>"></td>
            </tr>
            <tr>
                <td style="font-size: 15px">Satelite 5</td>
                <td class="input"><input name="berat_s5" type="text" size="10" value="<?php echo $sq10['berat_s5'] ?>"></td>
            </tr>
            <tr>
                <td style="font-size: 15px">Satelite 6</td>
                <td class="input"><input name="berat_s6" type="text" size="10" value="<?php echo $sq10['berat_s6'] ?>"></td>
            </tr>
            <tr>
                <td style="font-size: 15px">Satelite 7</td>
                <td class="input"><input name="berat_s7" type="text" size="10" value="<?php echo $sq10['berat_s7'] ?>"></td>
            </tr>

        </table>
        <p>Gunakan . (titik) untuk desimal</p>
        <button type="submit" value="Simpan" name="submit" class="swn_button_blue">Simpan</button>
        <a href="pmi<?php echo $lvl0 ?>.php?module=kantong_kosong" class="swn_button_blue">Kembali</a>
    </form>
