...
<table cellpadding=3 cellspacing=3 width="100%">
    ...
    <?
    $no = "0";
    while ($imltd = mysql_fetch_assoc($sq_elisa)) {
        $no++;
    ...
    ?>
        <tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight';" onMouseOut="this.className='normal';">
            ...
            <? if ($imltd[Hasil] == "Non Reaktif") { ?><td align="left">
                    <font color="black"><?= $imltd[Hasil] ?></font>
                </td><? } else { ?><td align="left">
                    <font color="red"><?= $imltd[Hasil] ?></font>
                </td><? } ?>
...
<table class="list" border=1 cellpadding="2" cellspacing="2" width="100%" style="border-collapse:collapse">
    ...
    <?
    $no = "0";
    while ($imltd_r = mysql_fetch_assoc($sq_rapid)) {
        $no++;
    ...
    ?>
        <tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight';" onMouseOut="this.className='normal';">
            ...
            <? if ($imltd_r[Hasil] == "Non Reaktif") { ?><td align="left">
                    <font color="black"><?= $imltd_r[Hasil] ?></font>
                </td><? } else { ?><td align="left">
                    <font color="red"><?= $imltd_r[Hasil] ?></font>
                </td><? } ?>
            <td class=input><?= $sq_reagen[Nama] ?></td>
            <td class=input><?= $sq_reagen[noLot] ?></td>
            <td class=input><?= $sq_reagen[tglKad] ?></td>
...
<table cellpadding=3 cellspacing=3 width="100%">
    ...
    <?
    $no = "0";
    while ($imltdn = mysql_fetch_assoc($sq_nat)) {
        $no++;
    ...
    ?>
        <tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight';" onMouseOut="this.className='normal';">
            ...
            <? if ($imltdn[Hasil] == "Non Reaktif") { ?><td align="left">
                    <font color="black"><?= $imltdn[Hasil] ?></font>
                </td><? } else { ?><td align="left">
                    <font color="red"><?= $imltdn[Hasil] ?></font>
                </td><? } ?>
...
<table class="list" border=1 cellpadding="2" cellspacing="2" width="100%" style="border-collapse:collapse">
    ...
    while ($b_dtransaksipermintaan = mysql_fetch_assoc($b)) {
        if (($b_dtransaksipermintaan[abs_result] == 'Neg')) {
            $var_kgd = '1';
        }
    ?>
        <tr style="font-size:12px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
