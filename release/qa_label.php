...
<body OnLoad="document.label_lab.nokantong.focus();">
    ...
    <tr>
        <td>No Kantong </td>
        <td><?= $kantong1[rnokantong] ?></td>
    </tr>
    <tr>
        <td>Produk</td>
        <td><?= $kantong1[rproduk] ?></td>
    </tr>
    <tr>
        <td>Gol Darah</td>
        <td><?= $kantong1[rgolda] ?></td>
    </tr>
    <tr>
        <td>Hasil Release</td>
        <td><?= $kantong1[rsatus_ket] ?></td>
    </tr>
    <?
				} else {
					?>
    ...
    <tr>
        <td>Produk Tidak dapat dicetak label ulang</td>
        <td><?= $kantong1[rproduk] ?></td>
    </tr>
    <tr>
        <td>Silahkan Cek Status Kantong</td>
    </tr>
    <?
				}
			}
	...
	<input name=cetak type=button value="Label Kecil" class="swn_button_blue" onclick="$.fn.colorbox({href:'qa_label_73.php?noKantong=<?= $kantong1[rnokantong] ?>', iframe:true, innerWidth:500, innerHeight:250},function(){ $().bind('cbox_closed', function(){window.location ='pmiqa.php?module=cetak_release'})});"-->
            ...
            <input name=cetak type=button value="Cetak" class="swn_button_blue"
                onclick="$.fn.colorbox({href:'qa_label_cetak.php?noKantong=<?= $kantong1[rnokantong] ?>', iframe:true, innerWidth:500, innerHeight:250},function(){ $().bind('cbox_closed', function(){window.location ='pmiqa.php?module=cetak_release'})});">
