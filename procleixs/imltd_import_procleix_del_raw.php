...
<?php
$run_number=$_GET['no'];
$sql=mysql_query("DELETE FROM `imltd_nat_panther_raw` WHERE `run_number`='$run_number'");
...
?><META http-equiv="refresh" content="3; url=../pmiimltd.php?module=import_nat_panther_rawlist">
