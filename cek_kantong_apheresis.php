...
if($op=='cek'){
     ...
     //cek_kantong_apheresis.php?op=simpan&nokantong="+nkt+"&tgl="+tgl+"&merk="+merk+"&vol="+vol+"&jns="+jns,
     $jenis         = $_GET['jns'];
     for ($i=0; $i<$jenis; $i++) {
          ...
          $tambah=mysql_query("insert into
               			stokkantong (noKantong,jenis,Status,tglTerima,volume,merk,volumeasal,StatTempat) 
                              values ('$nkt','$jenis','$status','$tanggal','$volume','$merk','$volume','1')");
          if ($lbl=="A"){
	...
	//=======Audit Trial====================================================================================
	$log_mdl ='LOGISTIK';
	$log_aksi='Barcode kantong Apheresis: '.$nkt;
