...
//-------------------- add a page ------------------------
$hasil=mysql_query("select * from dtransaksipermintaan where NoKantong='$_GET[noform]' and status >'0'");
...
$lab=mysql_query("select * from htranspermintaan where noform='$hasil1[NoForm]'");
...
$pdf->SetXY(6,22);
$pdf->write1DBarcode($hasil1[NoKantong], 'C128A', '', '', '', 5, 0.32, $style, 'N');
$pdf->SetXY(5,24);
...
$pdf->Cell(0, 12, 'Produk : '.$kantong1[produk], 0);

$pdf->SetXY(4,30);
$pdf->SetFont('helvetica', 'b', 9);
$pdf->Cell(0, 12, 'Isi : '.$kantong1[volume].' cc', 0);
...
$pdf->SetXY(40,40.5); 
$pdf->SetFont('helvetica','b', 9);
$pdf->Cell(0, 12,'  Diterima : '.$tglf.' ' .$blnf1. ' ' .$thnf. '   Jam : ' .$jamf, 0);
...
$pdf->SetXY(4,50);
$pdf->SetFont('helvetica', 'b', 9);
$pdf->Cell(0, 12,'Umur :'.$lab1[umur].' th', 0);
...
$pdf->SetXY(4,56); 
$pdf->SetFont('helvetica','b', 9);
$pdf->Cell(0, 12, 'Diagnosa : '.$darah1[Dignosa], 0);
...
$pdf->SetXY(55,53); 
$pdf->SetFont('helvetica','b', 9);
$pdf->Cell(0, 12,'Layanan : '.$lab1[jenis], 0);
...
$pdf->SetXY(4,63);
$pdf->SetFont('helvetica', 'b', 9);
$pdf->Cell(0, 12, 'CROSSMATCH DIKERJAKAN : '.$tglc.' ' .$blnc1. ' ' .$thnc. '   Jam :  ' .$jamc, 0);
