...
{
    $.fn
       .colorbox({href:'sysmex/imltd_rpt_konfirm1.php?notrans='+nomortransaksi,
...
$Sq=mysql_query("SELECT `id`, `no_trans`, `instr`, `trans_time`, `user`,
		 ...
		 `konfirmer`, `koonfirm_time`, `disahkan`, `status_kantong`, `konfirm_action` FROM `imltd_hiscl_konfirm` WHERE no_trans='$notrans'");
//$row = mysql_fetch_assoc($Sq);
?>
<a name="atas" id="atas"></a>
<table border=0 cellpadding="5" cellspacing="5" width="100%">
   <tr>
		<td align="left" style="background-color: #ffffff"><font size=5 color="blue"><b>DATA KONFIRMASI HASIL PEMERIKSAAN HISCL 800</b></font></td>
...
<table class="list" border=1 cellpadding="5" cellspacing="1" width="100%" style="border-collapse:collapse">
    ...
    <a href="sysmex/imltd_rpt_konfirm1.php?notrans=<?=$notrans?>"class="swn_button_blue">Cetak</a>
	<a href="pmiimltd.php?module=sysmexlistkonfirmasi1" class="swn_button_blue">Kembali ke list data</a>
