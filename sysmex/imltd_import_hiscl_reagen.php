...
<body>
	...
	?>
	<font size="4" color=00008B>DATA PENGGUNAAN REAGEN HISCL 800</b></font><br><br>
    ...
    $sqlsmp="SELECT date(`run_time`) as tgl,
            ...
            from lis_pmi.hiscl800 WHERE date(`run_time`)>='$tglawal' AND date(`run_time`)<='$hariini'
	...
	if ($no==0){?>
        <tr style="font-size:13px; color:#000000; font-family:Verdana;" onMouseOver="this.className='highlight'" onMouseOut="this.className='normal'">
			<td colspan=14 align="center">Tidak ada data Reagen  HISCL <i>800</i></td>
	<?}?>
	</table><br>
