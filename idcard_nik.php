...
$sql=mysql_fetch_assoc(mysql_query("select * from pegawai where Kode='$idpendonor'"));
$udd=mysql_fetch_assoc(mysql_query("select nama,alamat from utd where down='1' and aktif='1'"));
$pdf->SetFont('helvetica', 'b', 9);
$pdf->SetXY(0,4);
	$pdf->Cell(0, 10,'KARTU KARYAWAN',0, 1, 'C');
